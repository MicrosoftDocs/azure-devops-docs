...
> Learn how to [manage users and access levels here](../accounts/team-services/add-account-users-assign-access-levels-team-services.md). 
...
[add your new users, and assign them Basic access](../accounts/team-services/add-account-users-assign-access-levels-team-services.md). 
