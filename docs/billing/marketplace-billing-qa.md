...
description: Frequently asked questions for purchasing, billing, and extensions
ms.prod: vs-devops-alm
ms.technology: vs-devops-marketplace
ms.assetid: 6afd5482-11dc-44b8-8f61-1115a7882847
ms.manager: douge
ms.author: estfan
ms.date: 04/28/2017
---
...
Here you will find answers to many common questions around VSTS and Azure billing:

*	[Azure billing](#billing)

*	[Billing support](#marketplace-support)  
