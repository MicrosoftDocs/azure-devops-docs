...
> [add members to your account instead](../accounts/team-services/add-account-users-assign-access-levels-team-services.md). 
...
[add these users, and assign them Basic access](../accounts/team-services/add-account-users-assign-access-levels-team-services.md). 
...
A:	This might happen for [different reasons](../accounts/team-services/add-account-users-assign-access-levels-team-services.md#stopped-features).  
...
A:	Learn [how to delete users](../accounts/team-services/add-account-users-assign-access-levels-team-services.md#delete-user) 
