...
1. Select the package you want to delete, then select **Unlist** to hide it from search results in Azure Artifacts feeds and on *NuGet.org*, or **Delete** to move it to the recycle bin.
    ...
    :::image type="content" source="../media/delete/unlist-delete-nuget-package-newnav.png" alt-text="Screenshot showing how to delete or unlist a NuGet package in Azure Artifacts.":::
...
1. Select the package you want to delete, then select **Deprecate** or **Delete**.
    ...
    :::image type="content" source="../media/npm-deprecate-delete.png" alt-text="Screenshot showing how to deprecate or delete an npm package in Azure Artifacts.":::
...
1. Select the package you want to delete, and then select **Delete**.
    ...
    :::image type="content" source="../media/python-delete-package.png"  alt-text="Screenshot showing how to delete a Python package in Azure Artifacts." lightbox="../media/python-delete-package.png":::
...
1. Select **Delete** again to confirm your choice. 
    ...
    :::image type="content" source="../media/maven-delete-package.png" alt-text="Screenshot showing how to delete a Maven package in Azure Artifacts.":::
...
1. Select the package you want to delete, and then select **Delete**.
    ...
    :::image type="content" source="../media/universal-package-delete-package.png" alt-text="Screenshot showing how to delete a Universal Package in Azure Artifacts.":::
...
1. Select the package you wish to delete, and then select **Yank** to mark it as deprecated or **Delete** to move it to the recycle bin.
    ...
    :::image type="content" source="../media/delete-cargo-package.png" alt-text="Screenshot showing how to delete or yank a Cargo package.":::
...
1. Select the package you want to remove, and then select **Permanently Delete**.
    ...
    :::image type="content" source="../media/delete/delete-package-permanently.png" alt-text="Screenshot showing how to permanently delete a package in Azure Artifacts.":::

1. Select **Permanently Delete** again to confirm your decision.

     :::image type="content" source="../media/delete/delete-package-permanently-confirmation.png" alt-text="Screenshot showing a confirmation message before you delete a package permanently.":::
...
1. Select **Save** when you're done.
    ...
    :::image type="content" source="../media/retention-policy-settings.png" alt-text="Screenshot showing how to set up retention policies for your feed.":::
...
1. Select **Restore** again to confirm your decision.
    ...
    :::image type="content" source="../media/restore-package.png" alt-text="Screenshot showing how to restore deleted packages.":::
...
:::image type="content" source="../media/delete-all-versions.png" alt-text="Screenshot showing how to delete all versions from a feed.":::
