...
> [!NOTE]
> The following information remains available for all existing Azure DevOps OAuth apps. We recommend new app developers look into the [Microsoft Identity Platform](./oauth?#azure-ad-oauth) when integrating with Azure DevOps.
