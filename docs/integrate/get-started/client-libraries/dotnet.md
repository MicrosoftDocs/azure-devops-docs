...
For .NET developers building Windows apps and services that integrate with VSTS, client libraries are available for integrating with work item tracking, version control, build, and other services are now available. These packages replace the traditional TFS Client OM installer and make it easy to acquire and redistribute the libraries needed by your app or service.
...
To learn more about extending and integrating with  VSTS and Team Foundation Server using the client libraries, see [Extending Team Foundation](https://msdn.microsoft.com/en-us/library/bb130146.aspx)
...
Review the [contracts index](https://visualstudio.com/api/contracts-page.md) to learn more about the .Net client libraries contracts.
