...
you can [set one up for free](/vsts/setup-admin/team-services/sign-up-for-visual-studio-team-services). 
...
like [Git blobs](/vsts/integrate/previous-apis/git/blobs).

Now you should be able to look around the specific
[API areas](/vsts/integrate/previous-apis/git/overview) like [work item tracking](/vsts/integrate/previous-apis/wit/overview)
or [Git](/vsts/integrate/previous-apis/git/overview) and get to the resources that you need.
...
For example, you may want to [update a work item](/vsts/integrate/previous-apis/wit/work-items#updateworkitems) (`PATCH _apis/wit/workitems/3`), but you may have to go through a proxy that only allows GET or POST.
