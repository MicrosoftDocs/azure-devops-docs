...
title: Team Rooms | REST API Reference for Azure DevOps Server
description: Work with team rooms programmatically using the REST APIs for Azure DevOps Server.
