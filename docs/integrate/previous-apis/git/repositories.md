...
title: Git Repositories | REST API Reference for Azure DevOps Server
description: Work with Git repositories programmatically using the REST APIs for Azure DevOps Server.
