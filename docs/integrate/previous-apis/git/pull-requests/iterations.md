...
title: Git Pull Request Iterations | REST API Reference for Azure DevOps Server
description: Work with Git pull request iterations programmatically using the REST APIs for Azure DevOps Server.
