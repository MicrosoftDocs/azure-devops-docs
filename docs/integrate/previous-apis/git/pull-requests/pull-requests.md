...
title: Git Pull Requests | REST API Reference for Azure DevOps Server
description: Work with Git pull requests programmatically using the REST APIs for Azure DevOps Server.
