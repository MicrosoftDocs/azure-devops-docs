...
title: Git Commits | REST API Reference for Azure DevOps Server
description: Work with Git commits programmatically using the REST APIs for Azure DevOps Server.
