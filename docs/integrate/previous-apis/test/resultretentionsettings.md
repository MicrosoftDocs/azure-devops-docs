...
[!INCLUDE [GET_STARTED](../_data/get-started.md)] Look [here](/vsts/test/manual-exploratory-testing/getting-started/how-long-to-keep-test-results) to know more about result retention settings.
