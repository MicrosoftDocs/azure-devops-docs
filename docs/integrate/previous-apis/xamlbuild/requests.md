...
|:----------------|:-------|:---------|:------------
| URL
| instance        | string | yes      | [VS Team Services account](/integrate/get-started/rest/basics.md) ({account}.visualstudio.com) or [TFS server](/integrate/get-started/rest/basics.md) ({server:port}).
