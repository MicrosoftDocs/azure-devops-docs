...
//PreReq: There must be an area path called Root\Website
//PreReq: There must be a user called Johnnie McCloud (if not change line 271)
...
exports.submitRequests = function() {
        ...
        function(context, result) {
            return [
                    ...
                    },
                    {
                        ...
                        "value": context.projectName + "\\Website"
                    },
                    {
                        "op": "add",
                        "path": "/fields/System.History",
    ...
    // Delete all new work items 
    apiwriter.deleteJson('/wit/workitems?ids={taskId},{task2Id},{task3Id}');
    apiwriter.deleteJson('/wit/workitems/{PBIId}',
      function (context, result) {
            context.recycleId = result.responseHeader.Location;
        });
    
    // permanently delete
    apiwriter.deleteJson('/wit/recyclebin/{PBIId}');
    
    // empty recycle bin
    apiwriter.deleteJson('/wit/recyclebin');
