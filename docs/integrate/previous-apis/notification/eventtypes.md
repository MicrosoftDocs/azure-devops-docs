...
title: Notification event types | REST API Reference for Azure DevOps Server
description: Learn how to get notification event types by using the REST APIs for Azure DevOps Server.
