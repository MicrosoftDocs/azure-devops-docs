...
From the **Build>Definitions>Mine** page, you can quickly view all builds you've selected as a favorite, have been set as a team favorite, or builds of code that you've checked in. To learn more, see  [2016 Team Foundation Build release notes](../build-release/archive/news/2016.md#august-19).
