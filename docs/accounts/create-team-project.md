...
[Sign up for Visual Studio Team Services and create a team project](create-account-with-work-school.md). This topic applies to creating a team project when you have an on-premises Team Foundation Server (TFS) deployed.
