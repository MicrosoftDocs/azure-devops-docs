...
>[!NOTE]  
>There are no UI permissions associated with [managing tags](../work/track/add-tags-to-work-items.md). Instead, you can manage them using the [TFSSecurity command line tool](../setup-admin/tfs/command-line/tfssecurity-cmd.md#collection-level-permissions).   
...
>[!NOTE]  
>There are no UI permissions associated with managing notifications. Instead, you can manage them using the [TFSSecurity command line tool](../setup-admin/tfs/command-line/tfssecurity-cmd.md#collection-level-permissions).
...
You set [dashboard permissions at the team level](../report/dashboard-permissions.md#set-permissions) from the team dashboard page. 
