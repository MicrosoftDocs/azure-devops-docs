...
<td>
Adds the Shared Parameter WIT and category to the team project. You use Shared Parameter work items to [run tests with different data](../../test/manual-exploratory-testing/repeat-test-with-different-data.md).<br/> 
To manually add them to a team project, see [Add features manually](add-features-manually.md). 
</td>
<td>
TFS 2013.2
...
<td>
Adds the Test Plan and Test Suite WITs and categories to the team project. These items support managing and customizing test plans and test suites similar to other WITs. See also [Create a test plan](../../test/manual-exploratory-testing/getting-started/create-a-test-plan.md). <br/>
...
<p>The enhancements support:</p>
  ...
  <p>To learn about changes introduced to Test Manager and the web portal, see [Create a test plan](../../test/manual-exploratory-testing/getting-started/create-a-test-plan.md).</p>
