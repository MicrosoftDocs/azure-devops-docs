...
When you delete a WIT that belongs to a category, you must update the categories definition for the project to reflect the new name. In particular, the [Agile planning tools](../../../backlogs/overview.md) will not work until you update the categories definition.  
