...
|Your user account doesn't have sufficient permissions to connect.|Check with your VSTS organization owner or TFS administrator or that you have the necessary permissions to connect. For VSTS, you must have an active, valid license. See [Assign licenses to users of VSTS](../../../../organizations/accounts/add-organization-users-from-user-hub.md) for details.|  
  
## Related articles 
- [Add users to projects](../../../../organizations/security/add-users-team-project.md)   
- [Assign licenses to users of VSTS](../../../../organizations/accounts/add-organization-users-from-user-hub.md)
