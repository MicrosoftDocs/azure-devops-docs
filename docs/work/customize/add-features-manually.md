...
>[!IMPORTANT]  
>This topic applies only to team projects defined on an on-premises Team Foundation Server (TFS). Team projects hosted on Team Services [update automatically with each service upgrade](https://www.visualstudio.com/articles/news/features-timeline). 
>
...
<li>[Verify that you can add a shared parameter set or convert to shared parameters](../../test/manual-exploratory-testing/repeat-test-with-different-data.md). </li>
</ol>
</td>
</tr>
<tr>
