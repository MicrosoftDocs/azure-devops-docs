...
>[!IMPORTANT]  
>This topic applies only to team projects defined on an on-premises Team Foundation Server (TFS). Team projects hosted on Team Services [update automatically with each service upgrade](https://www.visualstudio.com/articles/news/features-timeline). To update a team project that uses the Hosted XML process, see [Import process](../import-process/import-process.md).
...
1. [Upload the process template](../guidance/manage-process-templates.md).
	...
	To verify your changes, create a test project. See [create a team project](../../setup-admin/create-team-project.md).
...
1.	Verify the features you want work as expected by exercising them as described in the following topics: 
	...
	<td>
	You use Shared Parameter work items to [run tests with different data](../../test/manual-exploratory-testing/repeat-test-with-different-data.md).   
	</td>
	</tr>
	<tr>
	<td>
