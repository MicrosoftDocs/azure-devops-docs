...
0. To add a custom field, you must first [add it to the WIT definition](add-modify-field.md).  
...
> [!NOTE]   
> Card customization is a supported feature of TFS 2015 and later versions.  
