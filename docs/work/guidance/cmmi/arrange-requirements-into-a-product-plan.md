...
-   These requirement work items should be linked to system tests so that you can ensure that all the requirements are tested. See [Create a test plan](../../../test/manual-exploratory-testing/getting-started/create-a-test-plan.md).  
