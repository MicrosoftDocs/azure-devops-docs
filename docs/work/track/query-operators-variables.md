...
<p style="font-weight:bold;padding-bottom:0px;text-align:center;">Managed queries</p>
<ul style="padding-left:30px">
<li>[Adhoc versus managed queries](adhoc-vs-managed-queries.md)</li> 
<li>[Working with queries](using-queries.md)</li>
<li>[Filter queries using tags](add-tags-to-work-items.md)</li>
<li>[Share work items and queries](https://msdn.microsoft.com/library/bb822129.aspx)</li>
<li>[Set query permissions](set-query-permissions.md)</li>
<li>[Define a custom field](../customize/add-modify-field.md)</li> 
</ul>
</div>

<div style="float:left;width:230px;margin:3px;font-size:90%">
<p style="font-weight:bold;padding-bottom:0px;text-align:center;">[Query examples](example-queries.md)</p>
<ul style="padding-left:30px">

<li>[Query by titles, ID, or rich-text fields](titles-ids-descriptions.md)</li>
<li>[Query by workflow or Kanban board changes](query-by-workflow-changes.md)</li>
<li>[Query by date or current iteration](query-by-date-or-current-iteration.md) </li>
<li>[Query based on History field](history-and-auditing.md) </li>
<li>[Query by links or attachments](linking-attachments.md)</li>
<li>[Query a numeric field](query-numeric.md) </li>
</ul>
</div>

<div style="float:left;width:230px;margin:3px;font-size:90%">
<p style="font-weight:bold;padding-bottom:0px;text-align:center;">Query-based charts</p>
<ul style="padding-left:30px">
