...
## [Use work item templates](productivity/work-item-template.md)
...
## Query
### [Add & edit a query](track/using-queries.md) 
...
### [Agile work item types & workflow](guidance/agile-process-workflow.md)
### [Scrum process](guidance/scrum-process.md)
### [Scrum work item types & workflow](guidance/scrum-process-workflow.md)

### CMMI process guidance
#### [CMMI process](guidance/cmmi-process.md)
#### [CMMI work item types & workflow](guidance/cmmi-process-workflow.md)
#### [CMMI background](guidance/cmmi/guidance-background-to-cmmi.md)
...
### [Add or edit columns](kanban/add-columns.md)
...
### [Query by build & test integration fields](track/build-test-integration.md)  
...
### [Code review & feedback field reference](guidance/guidance-code-review-feedback-field-reference.md)
### [Bugs, issues, & risks  field reference](guidance/cmmi/guidance-bugs-issues-risks-field-reference-cmmi.md)
...
## [Rollup estimated & actual work using Project](office/rollup-estimated-and-actual-work-using-project.md)
## [Resolve conflicts & errors](office/resolve-problems-excel-workbooks-sharepoint.md)
