---
title: Kanban board filter options | Team Services & TFS
...
- [Add task checklists](add-task-checklists.md)
- [Kanban features and epics](kanban-epics-features-stories.md)  
