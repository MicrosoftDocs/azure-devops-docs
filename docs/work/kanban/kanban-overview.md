...
## Try this next  
Take these tools for a test run by [creating an organization on VSTS for free](../../organizations/accounts/create-organization-msa-or-work-student.md). From there, you're ready to add items to your Kanban board and customize it. 
