...
- Import Process (only supported for accounts that use the [Hosted XML process model](../customize/customize-work.md#hosted-xml-process-model)) 
...
[Processes](../../../integrate/api/tfs/processes.md).
