...
0. To view your Kanban board, open your (1) project from a web browser and choose (2) **Work**, (3) **Backlogs**, (4) **Stories**, and then (5) **Board**. 
	...
	![Open Portfolio Kanban board, Features](/vsts/work/kanban/_img/quickstart/open-kanban-board.png)
...
0. Your Kanban board displays. 
	::: moniker range=">= tfs-2017"   
	![Kanban board, Agile template](/vsts/work/kanban/_img/kanban-basics-intro.png)   
	::: moniker-end   
	::: moniker range=">= tfs-2013 <= tfs-2015"    
	> [!div class="mx-imgBorder"]  
	> ![TFS 2015, Kanban board, Agile template](/vsts/work/kanban/_img/overview/kanban-basics-intro-tfs.png)       
	::: moniker-end   
