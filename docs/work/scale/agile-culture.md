...
Before you can create or work with any of the Agile tools, you need a team project. If you don't have one yet, you can [create one in Visual Studio Team Services](../../connect/connect-team-projects.md)  or on an [on-premises TFS](../../accounts/create-team-project.md). 
