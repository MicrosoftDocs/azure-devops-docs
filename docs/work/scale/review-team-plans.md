...
- Be granted Basic access or greater in [Team Services](../../accounts/add-account-users-assign-access-levels-team-services.md) or [TFS](../../security/change-access-levels.md) (Users with Stakeholder access can't add or view plans)  
