 ...
 **Required Permissions**  
 ...
 To perform these procedures, you must be a member of the **Readers** group or your **View work items in this node** permission must be set to **Allow**. For more information, see [Permission reference](../../setup-admin/permissions.md).  
