...
|**Add or remove a work item type from participating in data synchronization**. You can define the types of work items when you associate a project plan to a team project, and you can later add or remove types. You can also list the types of work items that are mapped for a team project.|[Specify work item types](specify-wits-to-synchronize.md)|  
