...
||`tfsName`|Specifies the reference name of the field in Team Foundation to synchronize. You must specify a field that is defined in the project collection. You can list all fields in a collection by running the **witadmin listfields** command. For more information, see [Manage work item fields](../customize/reference/witadmin/manage-work-item-fields.md)
).|  
