...
1.  On the application-tier server, [Open the Team Foundation Administration Console](/tfs/server/ref/command-line/open-admin-console), and open **Group Membership**.  
