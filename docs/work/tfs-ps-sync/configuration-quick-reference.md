...
|Step|Task|Machine|Notes|  
|----------|----------|-------------|-----------|  
|![Step 1](_img/procguid_1.png "ProcGuid_1")|Install Visual Studio Team Foundation Server 2013.|Each application-tier server for Team Foundation Server that will participate in data synchronization with Project Server.|The software that supports data synchronization is automatically installed with Team Foundation Server. For more information, see [Install](../../tfs-server/install/get-started.md).|  
