...
|You want to log into VSTS forrom Visual Studio using a different account.|See [Connect to team projects, Change accounts when you connect to VSTS](../../../connect/connect-team-projects.md).|  
