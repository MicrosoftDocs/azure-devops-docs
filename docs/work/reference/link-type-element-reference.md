...
<img src="_img/linkscontrol-work-item-link-types.png" alt="Work item link types, conceptual mapping" style="border: 1px solid #CCCCCC;" />  
...
<td>Use to link Test Cases to Shared Parameters to support the ability to [repeat a test with different data](../../test/manual-exploratory-testing/repeat-test-with-different-data.md). In general, you wouldn't add this link type to a scoped links control.   
</td>
</tr>
...
<p>Topology type: Dependency<br/>
Link category: Process-defined</p></td>
<td>Use to link test cases with shared steps. You [share steps between test cases](../../test/manual-exploratory-testing/mtm/share-steps-between-test-cases.md) to avoid having to create multiple entries of the same sequence of steps. </td>
</tr>
...
<img src="_img/linkscontrol-test-related-links.png" alt="Test-related link types, conceptual mapping" style="border: 1px solid #CCCCCC;" /> 
...
<img src="_img/linkscontrol-external-link-types.png" alt="External link types, conceptual mapping" style="border: 1px solid #CCCCCC;" />  
