...
1.  If you're not a member of the TFS **Administrators** group, [get added as one](../../setup-admin/add-administrator-tfs.md).    
...
- [Requirements and compatibility, Supported web browsers](../../setup-admin/requirements.md#supported-browsers)
