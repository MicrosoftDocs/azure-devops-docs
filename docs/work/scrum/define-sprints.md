...
<p>After your team has worked several sprints, they can use the [velocity and forecast tools](velocity-and-forecasting.md) to estimate work that can be accomplished in future sprints.  </p>
