...
<ul class="panelContent cardsFTitle">
    <li>
        <a href="tutorial/pullrequest.md">
        <div class="cardSize">
...
<ul class="panelContent cardsFTitle">
    <li>
        <a href="concepts/pull-request-status.md">
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardImageOuter">
    ...
    <li>
        <a href="how-to/create-pr-status-server.md">
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardImageOuter">
    ...
    <li>
        <a href="how-to/create-pr-status-server-with-azure-functions.md">
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardImageOuter">
