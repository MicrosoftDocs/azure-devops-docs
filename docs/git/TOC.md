...
## [Version control and devops](vc-devops.md)

# Quickstarts
## [Create a repo from the web](create-new-repo.md)
## [Create a repo from the command line](share-your-code-in-git-cmdline.md)
## [Create a repo using an IDE](create-new-repo-client.md)
...
## [1 - Learn about Git](tutorial/gitworkflow.md)
## [2 - Create a new repo](tutorial/creatingrepo.md)
## [3 - Clone an existing repo](tutorial/clone.md)
## [4 - Save work with commits](tutorial/commits.md)
## [5 - Create work in branches](tutorial/branches.md)
## [6 - Share code with push](tutorial/pushing.md)
## [7 - Update code with fetch and pull](tutorial/pulling.md)
## [8 - Review code with pull requests](tutorial/pullrequest.md)
## [9 - Apply changes with rebase](tutorial/rebase.md)
## [10 - Copy changes with cherry-pick](tutorial/cherry-pick.md)
## [11 - Resolve merge conflicts](tutorial/merging.md)
## [12 - Undo changes](tutorial/undo.md)
## [13 - Ignore files](tutorial/ignore-files.md)
## [14 - Review history](tutorial/history.md)

# Samples
## [VSTS .Net samples](https://github.com/Microsoft/vsts-dotnet-samples)
