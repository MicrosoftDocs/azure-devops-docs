---
title: Squash merge your pull requests | Team Services & TFS
...
When you complete a [pull request](pull-requests.md) in Team Services, you merge the topic branch into your default branch, usually `master`. 
...
![Example of a regular merge from a pull request in Team Services](_img/regular_branch_merge.png)
...
![Squash Merging in pull requests in Team Services](_img/squash_merge.png)
...
You can choose to squash merge when completing a pull request in Team Services. 
Choose **Squash changes when merging** on the **Complete pull request** dialog to squash merge the topic branch.

 
![Closing a PR with a squash merge in Team Services](_img/squash_merge_in_pr.png)