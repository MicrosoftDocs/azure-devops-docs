---
title: Visual Studio Team Services Plugin for IntelliJ IDEA and Android Studio | VSTS & TFS
...
* A VSTS account. If you don’t have a VSTS account, you can [sign up](../accounts/create-account-with-work-school.md) for one for free. Each account includes free, unlimited private Git repositories.
