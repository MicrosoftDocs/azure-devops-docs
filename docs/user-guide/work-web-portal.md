...
Several features display information based on the logged-in user or the selected team context. First off, users can [set their preferences](../organizations/settings/user-preferences.md?toc=/vsts/user-guide/toc.json&bc=/vsts/user-guide/breadcrumb/toc.json) through their profile or organization menu:
