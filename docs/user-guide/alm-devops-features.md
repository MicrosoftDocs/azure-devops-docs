...
<p>Subscribe to email alerts to get notified about <a href="../repos/git/notifications.md" data-raw-source="[new pull requests, changes, approvals, and rejections](../repos/git/notifications.md)">new pull requests, changes, approvals, and rejections</a>.</p>
