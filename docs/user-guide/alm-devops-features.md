...
<p>With Azure Test Plans, you can <a href="https://docs.microsoft.com/previous-versions/azure/devops/test/mtm/record-play-back-manual-tests?view=azure-devops" data-raw-source="[record your keystrokes and gestures while you test an application](https://docs.microsoft.com/previous-versions/azure/devops/test/mtm/record-play-back-manual-tests?view=azure-devops)">record your keystrokes and gestures while you test an application</a>. The next time you run the test, you can play back your actions quickly and accurately.</p>
