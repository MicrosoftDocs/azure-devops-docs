...
- To get started with Visual Studio Team Services (VSTS) begin by [creating an organization](https://visualstudio.microsoft.com/team-services/). Step-by-step instructions are provided in [Sign up for VSTS](../organizations/accounts/create-organization-msa-or-work-student.md).  
