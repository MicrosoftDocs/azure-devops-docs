...
Sign up for a VSTS account to upload and share code in a free unlimited private 
...
0.	(Optional) Choose **Change details** to change default assignments. Otherwise, choose **Continue** to confirm to initiate your account creation.
