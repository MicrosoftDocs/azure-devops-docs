...
From the Code hub for Git you can perform the following tasks:
...
Specifically, from the **Work** you can perform the following tasks:
...
Azure provides a number of cloud-hosted services to support application development and deployment. You can make use of these services solely or in combination with Azure Codex.
...
For continuous delivery to Azure from Codex, see [Automatically build and deploy to Azure web apps or cloud services](https://azure.microsoft.com/documentation/articles/cloud-services-continuous-delivery-use-vso/). 
