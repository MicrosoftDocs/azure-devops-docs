---
title: Navigate using the organization hub pages 
titleSuffix: VSTS & TFS 
description: Quickly link to work items, pull requests, team projects, and more using your organization home page in Visual Studio Team Services & Team Foundation Server 
...
---
# Work effectively from your organization hub

**VSTS | TFS 2018 | TFS 2017.1**

From your organization, you gain access to a number of page views that are particularly helpful if you work in several team projects. These pages provide quick access and filter functions to support your work within a single team project or  work you're doing across several projects.  

For example, you can quickly access and navigate to work of interest from the following organization hubs:
...
<b>https://<i>https://<i>OrganizationName</i>.visualstudio.com/_projects</b>

You'll see something similar to the following welcome page.

::: moniker range="vsts"
> [!div class="mx-imgBorder"]  
![Organization home welcome page](_img/organization-home-welcome.png) 
::: moniker-end

::: moniker range=">= tfs-2017 <= tfs-2018"
> [!div class="mx-imgBorder"]  
> ![Oorganization home welcome page](_img/org-hub-tfs/organization-home-welcome.png)
::: moniker-end
...
::: moniker range="vsts"
> [!div class="mx-imgBorder"]  
> ![Organization home welcome page]((_img/organization-home-projects.png)
::: moniker-end

::: moniker range=">= tfs-2017 <= tfs-2018"
> [!div class="mx-imgBorder"]  
> ![Organization home welcome page](_img/org-hub-tfs/organization-home-projects.png)
::: moniker-end
...
![Organization home, Projects page, hover over a team project](_img/organization-home-projects-hover-links.png)
...
> [!div class="mx-imgBorder"]  
> ![Organization home, Projects page, filter on Fabrikam](_img/organization-home-search-projects-fabrikam.png)  


### Add a team project

If you're an organization administrator or are a member of the Project Collection Administrators group, the New Project button is shown. Choose **New Project** to [add a team project](../organizations/accounts/create-team-project.md).

::: moniker range="vsts"
![Organization home, Projects page, New team project](_img/organization-home-projects-new-project.png)
::: moniker-end

::: moniker range=">= tfs-2017 <= tfs-2018"
![Organization home welcome page](_img/org-hub-tfs/organization-home-projects-new-project.png)
::: moniker-end
...
> [!div class="mx-imgBorder"]  
> ![Organization home favorites page](_img/organization-home-favorites.png)
...
![Organization home favorites page](_img/organization-home-remove-from-favorites.png)
...
::: moniker range="vsts"
> [!div class="mx-imgBorder"]  
> ![Organization home, Work, Assigned to me page](_img/organization-home-work-assigned-to-me.png)  
::: moniker-end

::: moniker range=">= tfs-2017 <= tfs-2018"
![Organization home, Work, Assigned to me page](_img/org-hub-tfs/organization-home-work-assigned-to-me.png) 
::: moniker-end
...
::: moniker range="vsts"
> [!div class="mx-imgBorder"]  
> ![Organization home, Work, Following page](_img/organization-home-work-following.png)  
::: moniker-end

::: moniker range=">= tfs-2017 <= tfs-2018"
![Organization home, Work, Assigned to me page](_img/org-hub-tfs/organization-home-work-followed.png) 
::: moniker-end
...
> [!div class="mx-imgBorder"]  
> ![Organization home, Work items, My Activity page](_img/organization-work-my-activity.png) 
...
::: moniker range="vsts"
> [!div class="mx-imgBorder"]  
> ![Organization home, My Pull requests, Active](_img/organization-home-pull-requests.png)  
::: moniker-end

::: moniker range=">= tfs-2017 <= tfs-2018"
![Organization home, Pull requests, Active](_img/org-hub-tfs/organization-home-pull-requests.png) 
::: moniker-end
...
To open a team room, choose **Rooms**. You'll see all the team rooms defined for the organization. Choose the name of a team room which you have access. You only have access to those team rooms of which you are a team member.  

<img src="_img/organization-home-rooms.png" alt="Organization home, Rooms, selected team room" style="border: 1px solid #CCCCCC;" />   
