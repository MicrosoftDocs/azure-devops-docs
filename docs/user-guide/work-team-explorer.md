...
You use Team Explorer to manage work that is assigned to you, your team, or your team projects, and to coordinate your efforts with other team members to develop a project. Team Explorer is a plug-in that installs with Visual Studio or Eclipse. Working from different platforms, developers and stakeholders can effectively collaborate using Team Explorer connected to team projects hosted on Azure DevOps Services or on-premises Team Foundation Server (TFS). 
...
From the **Settings** page, you can configure administrative features for either a team project or project collection. Configuring features in these areas requires you to be a member of a an administrator group or have the required permissions.
