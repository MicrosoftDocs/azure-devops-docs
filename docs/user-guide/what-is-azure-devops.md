...
Azure DevOps supports adding extensions and integrating with other popular services, such as: Slack, Trello, UserVoice, and more, and developing your own custom extensions.  
