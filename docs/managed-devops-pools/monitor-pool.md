...
| `WorkerSetupFailed`, `UnableToDownloadWorkerCheckNetwork`, `UnableToDownloadWorkerCheckNetwork[<endpoint>]`  | [The Network infrastructure is blocking access to one of the prerequiste endpoints.](./configure-networking.md#restricting-outbound-connectivity) |
