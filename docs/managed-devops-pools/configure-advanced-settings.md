...
>
> If you specify a Linux style work folder for a Windows agent, like `/mnt/storage/sdc/custom-work-folder`, the Windows agent uses this folder on the default drive, like `D:\mnt\storage\sdc\custom-work-folder`.
