...
Unlike the previous warnings, this is an error that **WILL** block you from moving forward with your migration to VSTS. The volume of metadata in your collection is too large and needs to be [reduced](/tfs/server/upgrade/clean-up-data) below the mentioned limit to proceed with the import.   
