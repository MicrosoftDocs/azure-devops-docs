---
title: DevOps - Adding Continuous Security Validation to your CI/CD Pipeline
...
ms.prod: vs-security-validation-cicd-pipeline
...
> Authors: Mike Douglas | Find the origin of this article and connect with the ALM Rangers [here](https://github.com/ALM-Rangers/Guidance/blob/master/README.md)
