...
To invoke the **StampWorkitemCache** Web method, you must be a member of the **Administrators** security group on the application-tier server for Team Foundation. For more information, see [Pernission reference for Team Foundation Server](../../../../security/permissions.md) .
