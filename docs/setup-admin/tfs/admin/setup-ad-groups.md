...
**A:** Yes, you can. You can create specific groups for [restricting access to projects](../../restrict-access-tfs.md), for [managing access levels](../../../security/change-access-levels.md), and other purposes.
