...
You can define and manage your builds and releases from the web portal, Test hub.  For an overview of test features and functions, see [Test apps early and often](../manual-test/index.md).  
