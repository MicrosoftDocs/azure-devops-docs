...
If you prefer to use YAML to provide your release pipeline configuration, you can use the following example to understand how YAML can be used to install Azure CLI, add the Azure DevOps extension, and run some commands.

In this article, you learn how to add the Azure DevOps extension to Azure CLI and run the build and PR list commands.
