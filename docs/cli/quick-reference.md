...
Use this index to quickly access examples that showcase use of az devops CLI commands.  For a list of az devops commands, see [az devops](/cli/azure/devops).   


## Azure Artifacts

- [Bulk-download universal packages](../artifacts/quickstarts/universal-packages.md#bulkd-download-universal-packages)
...
- [Show details for a variable group](../pipelines/library/variable-groups.md#how-variable-group)
