...
<img alt="Change organization details" src="/azure/devops/_shared/media/change-details-standard1.png" style="border: 1px solid #CCCCCC">
...
<img alt="Rename project, change organization location, or select another process" src="/azure/devops/_shared/media/media/change-details-standard2.png" style="border: 1px solid #CCCCCC">
...
<img alt="Change your directory" src="/azure/devops/_shared/media/change-details-standard2-with-directory.png" style="border: 1px solid #CCCCCC">
