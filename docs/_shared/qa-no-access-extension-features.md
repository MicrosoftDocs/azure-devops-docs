...
*	If you're using a Team Services account, and you started a free extension trial, 
your trial might have expired. To check whether your trial expired:

	0.	On your Team Services account toolbar, go to **Users**.
...
*	If you're using a Team Services account, and you paid for this extension, 
