...
*	If you're using a Azure DevOps organization, and you started a free extension trial, 
...
*	If you're using a Azure DevOps organization, and you paid for this extension, 
