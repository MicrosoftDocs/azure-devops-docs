...
[Which versions of Visual Studio can I use with Visual Studio Team Services?](../setup-admin/team-services/connect-to-visual-studio-team-services.md#vs-versions)