...
- **SS**
  ...
  **SS** is default difference output format for Visual SourceSafe. For more information, see "Diff (Command Line)" at the Microsoft Web site (<https://docs.microsoft.com/previous-versions/9a7z21t6(v=vs.80)>).
