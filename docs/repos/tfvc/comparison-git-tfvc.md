...
:::row:::
   ...
   See [Use Git branches to switch contexts, suspend work, and isolate risk](../git/create-branch.md?amp;tabs=visual-studio&preserve-view=true&view=azure-devops#use-branches-to-manage-development).
   :::column-end:::
:::row-end:::
:::row:::
   :::column span="1":::
