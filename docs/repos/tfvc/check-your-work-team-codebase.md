...
![Checking in an update to fix a bug](media/check-your-work-team-codebase/IC593474.png)
...
1.  In Team Explorer, choose ![Home icon](media/check-your-work-team-codebase/IC547418.png) **Home**, and then choose **Pending Changes** (Keyboard: Ctrl + 0, P).
