...
:::image type="content" source="media/branch-policies/require-minimum-number-of-pr-reviews.png" alt-text="Enable the Require Code Reviews policy":::
...
:::image type="content" source="media/branch-policies/work-item-linking.png" alt-text="Require linked work items in your pull requests":::
...
:::image type="content" source="media/branch-policies/comment-resolution.png" alt-text="Check for comment resolution":::
...
:::image type="content" source="media/branch-policies/limit-merge-types.png" alt-text="Limit merge types":::
...
:::image type="content" source="media/branch-policies/add-build-policy.png" alt-text="Add build policy":::

Choose the **+** button next to **Build validation**.

:::image type="content" source="media/branch-policies/build-policy-settings.png" alt-text="Build policy settings":::
...
:::image type="content" source="media/branch-policies/require-approval-from-additional-services.png" alt-text="Require external services to approve":::
...
:::image type="content" source="media/branch-policies/require-specific-reviewers.png" alt-text="Enter the path and required reviewers":::
...
::: moniker range=">= azure-devops-2020"
:::image type="content" source="media/branch-policies/automatically-include-reviewers-for-pull-requests.png" alt-text="Add automatic reviewers":::
::: moniker-end
