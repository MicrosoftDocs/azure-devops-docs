...
>[!NOTE]
>Changing the default branch requires you to have **Edit policies** permissions. For more information, see [Set Git repository permissions](../set-git-repository-permissions.md).
