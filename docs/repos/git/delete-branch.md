...
This topic covers deleting a Git branch via the web in Azure DevOps Services and TFS. 

**Azure Repos | Azure DevOps Server 2020 | Azure DevOps Server 2019 | TFS 2018 | TFS 2017**

>[!IMPORTANT]
> If you need to delete a Git branch in your own repo from Visual Studio or the command line,
