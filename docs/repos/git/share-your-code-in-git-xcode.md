...
0. Browse to your Project in your Azure DevOps Services organization and select the drop-down ![Azure DevOps Services drop-down picker](_img/share-your-code-in-git-xcode/vsts_drop_down_arrow.png) next to the name of the current Git repo. Select **New Repository..**  
