...
[![Screenshot of closed code pull request annotation](./media/pull-request-annotation-code-scanning-dismissed.png)](./media/pull-request-annotation-code-scanning-closed.png#lightbox)
