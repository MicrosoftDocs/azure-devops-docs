...
To allow your users to debug your application, you need to [publish your symbol files](/vsts/pipelines/symbols/index) to a Symbol Server, like the one provided by Azure Artifacts in Azure DevOps Services. 
