...
description: Navigate to pages and artifacts using breadcrumbs or selectors in the web portal for Visual Studio Team Services and Team Foundation Server
