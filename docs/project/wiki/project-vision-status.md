...
0. Select **Check in** to complete the check in process of the README file.  

	> [!div class="mx-imgBorder"]  
	> ![Check-in README file dialog, new nav](_img/share-project/tfvc-readme-checkin.png) 

0. Select **Overview>Summary** to review your project summary page with the README file displayed.  
...
0. You can immediately edit the README file. When done, select **Check in**.
