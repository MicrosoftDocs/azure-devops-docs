...
description: Migrate wiki pages created with the Marketplace extension to your team project wiki in Azure DevOps.
...
Migrate pages created with the Wiki Marketplace extension to your team project wiki.
You can save any wiki pages created with the Wiki Marketplace extension to a Git repo in your team project.
...
1. Create, and then clone your Azure DevOps wiki.
1. Move and commit all Markdown pages to your Azure DevOps wiki.
1. Run the wiki migration tool, *MigrateToVSTSWiki.exe*.
1. When the wiki migration tool is complete, push the changes to the default main branch, `wikiMain`, of the Azure DevOps wiki repository.
...
6. Clone the wiki extension repo.
   The wiki is mapped to a folder given to you during the wiki creation.
   You can confirm by going to the **manage wiki** option in the existing wiki, as shown in the following example.
...
8. Open a command prompt as an administrator and run `MigrateToVSTSWiki.exe`.
   This tool copies the files from your existing wiki to the destination directory you provide.
   During copying, the tool converts the pages to be compliant with the Azure DevOps wiki.
