...
Stakeholders - semantic searches on work items, wiki, and packages, but not on code.
...
> [Search work items](........md)

## FAQs
### Q: When Code Search isn't installed, then what is behavior? 
A: The search box performs a work item query.  
## Related articles
