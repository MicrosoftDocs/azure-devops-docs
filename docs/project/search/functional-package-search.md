...
> [!NOTE]
> Searching for packages in upstreams with NuGet Package Explorer is not supported. See [Download NuGet packages](../../artifacts/get-started-nuget.mds#download-nuget-packages) for more details.
