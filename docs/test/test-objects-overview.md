...
:::row:::
   ...
   :::column span="3":::
      ...
      - [**Query-based suites**](reference-qa.yml#whats-the-difference-between-static-requirement-based-and-query-based-test-suites): Select one or more test cases which are then linked to the test suite.    
      > [!TIP]
