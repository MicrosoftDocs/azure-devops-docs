...
> [!IMPORTANT]
> The **Request feedback** shortcut menu is unavailable in [New Boards Hub](http://aka.ms/newboardshub). However, there are alternative ways to request feedback, such as through email and chat, in addition to utilizing the Test & Feedback extension. [Test & Feedback extension](./voluntary-stakeholder-feedback.md).
