...
We planned to pull out the old page by mid-June 2020. As the date approached, we started receiving consistent feedback (such as [this](https://developercommunity.visualstudio.com/idea/1060525/keep-the-old-test-plans-view.html) thread on community forum) regarding a feature. This feature allows the user to preview test runs, test case details and test suites for a test case in a side-by-side non-modal view. Thanks a lot for your feedback. We are currently evaluating it and have removed the deadline to switch to the new Test Plans page. We will update you with the plan as we get more clarity.
