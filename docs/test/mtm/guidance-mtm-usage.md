...
> [!NOTE]
> [!INCLUDE [mtm-deprecate-message](../includes/mtm-deprecate-message.md)] This topic will help you understand why [!INCLUDE [test-hub-include-nolink](../includes/test-hub-include-nolink.md)] is a more comprehensive solution for manual testing compared to Microsoft Test Manager.
