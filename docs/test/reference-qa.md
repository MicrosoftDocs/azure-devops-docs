...
[sharing test steps](https://docs.microsoft.com/previous-versions/azure/devops/docs/test/mtm/share-steps-between-test-cases).
...
[Go to related topic &gt;](https://docs.microsoft.com/previous-versions/azure/devops/docs/test/mtm/share-steps-between-test-cases)
