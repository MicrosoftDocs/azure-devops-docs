...
you must [configure the data collectors](https://docs.microsoft.com/previous-versions/azure/devops/docs/test/mtm/collect-more-diagnostic-data-in-manual-tests)
and other run settings in Microsoft Test Manager and run your 
tests using Microsoft Test Manager. For more details, see 
[Run manual tests with Microsoft Test Manager](https://docs.microsoft.com/previous-versions/azure/devops/docs/test/mtm/run-manual-tests-with-microsoft-test-manager).
<p />
...
> You must [configure the data collectors](https://docs.microsoft.com/previous-versions/azure/devops/docs/test/mtm/collect-more-diagnostic-data-in-manual-tests) and other run settings in Microsoft Test Manager and specify these as the default settings for the test plan.
> For more details, see [Run manual tests with Microsoft Test Manager](https://docs.microsoft.com/previous-versions/azure/devops/docs/test/mtm/run-manual-tests-with-microsoft-test-manager).
