...
* [Exploratory testing with Microsoft Test Manager](https://docs.microsoft.com/previous-versions/azure/devops/docs/test/mtm/exploratory-testing-using-microsoft-test-manager)
