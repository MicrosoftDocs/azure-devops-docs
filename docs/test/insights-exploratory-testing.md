...
## Open session insights

Open the session insights page by using either of the following methods:

- In the Test & Feedback extension, on the **Session timeline** page, select the **View** icon.
...
- In your Azure DevOps project, select **Test Plans** > **Exploratory sessions**.
...
- In your Azure DevOps project, select **Test Plans** > **Runs** > **Recent exploratory sessions**.

   ![Screenshot showing the Recent exploratory sessions option on the Runs page.](media/insights-exploratory-testing/insights-exploratory-testing-02.png)

::: moniker-end

The session insights page contains the following three main sections:
   ...
   ![Screenshot of the Summary view with work items explored, items filed, session owners, and total duration.](media/insights-exploratory-testing/insights-exploratory-testing-03.png)
 
   - **Pivot view** - shows a collapsible nested and sortable list of items grouped in different ways. 
 
   ![Screenshot of the Pivot view grouping exploratory sessions by work item with bug, task, and test case counts.](media/insights-exploratory-testing/insights-exploratory-testing-03a.png)
 
   - **Details view** - shows the work item selected in the Pivot view or a summary of information about a selection of items.
 
   ![Screenshot of the Details view with duration, session owner, and bug and task status charts.](media/insights-exploratory-testing/insights-exploratory-testing-03b.png)

## Get insights from your exploratory testing sessions

Use the session insights page to get insights about your
