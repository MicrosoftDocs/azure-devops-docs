...
[run the tests using Visual Studio](getting-started/record-and-replay-cloud-load-tests.md#exportvs).
...
* No apps are configured to push analytics data to Application Insights. See 
  ...
  ![Checking that the apps are listed in the Azure portal](getting-started/_img/get-performance-data-for-load-tests/get-load-test-insights-05.png)
