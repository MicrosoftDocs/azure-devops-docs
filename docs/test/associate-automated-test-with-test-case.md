...
* You created a manual test case that you later decide is a good test
  ...
  [run these automated tests by using Microsoft Test Manager](https://docs.microsoft.com/previous-versions/azure/devops/docs/test/mtm/run-automated-tests-with-microsoft-test-manager).
...
[Recording and Playing Back Manual Tests](https://docs.microsoft.com/previous-versions/azure/devops/docs/test/mtm/record-play-back-manual-tests)
...
* [Run automated tests with Microsoft Test Manager](https://docs.microsoft.com/previous-versions/azure/devops/docs/test/mtm/run-automated-tests-with-microsoft-test-manager)
