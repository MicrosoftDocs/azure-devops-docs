...
- Visual Studio 2017 Professional or earlier version. Access TCM from the command prompt and the following directories: 
...
- Valid project membership to one or more projects that you want to access and the required permissions based on the commands you run. For more information, see [Manual test access and permissions](../manual-test-permissions.md). 
- Same access levels for adding test plans and test suites to clone or import test objects.
