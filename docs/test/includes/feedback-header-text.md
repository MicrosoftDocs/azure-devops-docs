...
Stakeholders can respond to feedback requests for user stories and features in Azure DevOps by using the Test & Feedback extension ([Exploratory testing](../perform-exploratory-tests.md)).
