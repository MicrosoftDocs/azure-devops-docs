...
> [!TIP]
> The default _Outcome_ filter for _Automated_ test runs is set to _Failed or Aborted_ to accelerate the analysis. For _Manual_ test runs runs, which typically have lower volume, results remain unfiltered by default.
