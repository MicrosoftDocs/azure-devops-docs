...
1. In your build definition, provide the path to the test framework in the *Path to Custom Test Adapters** parameter:
   ...
   ![Build def, VSTest task, custom test framework](getting-started/_img/getting-started-with-continuous-testing/IC816555.png)
...
![Find test run](getting-started/_img/getting-started-with-continuous-testing/IC816778.png)
...
![Find specific test results](getting-started/_img/getting-started-with-continuous-testing/IC816776.png)
