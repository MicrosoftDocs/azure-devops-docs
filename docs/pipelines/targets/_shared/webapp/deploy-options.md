...
The preceding examples rely on the built-in [Azure App Service Deploy task](https://github.com/Microsoft/azure-pipelines-tasks/tree/master/Tasks/AzureRmWebAppDeployment),
