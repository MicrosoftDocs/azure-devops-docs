...
> In addition to supporting Azure AD, Azure DevOps Server 2019 can be used to deploy to Azure stack with [Active Directory Federation Services](/azure/azure-stack/azure-stack-create-service-principals#create-a-service-principal-that-uses-a-client-secret-credential) (AD FS) using a [service principal with certificate](/azure/devops/release-notes/2018/sprint-141-update#create-azure-service-connection-with-service-principal-that-authenticates-with-a-certificate).
...
* Use an Azure Stack integrated system or deploy the [Azure Stack Development Kit (ASDK)](/azure-stack/asdk/asdk-install)
...
* Create a [tenant subscription](/azure-stack/operator/azure-stack-subscribe-plan-provision-vm) in Azure Stack.
...
For more details, refer to [Tutorial: Deploy apps to Azure and Azure Stack](/azure-stack/user/azure-stack-solution-pipeline)
