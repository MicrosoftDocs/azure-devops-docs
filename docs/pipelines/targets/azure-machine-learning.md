...
A similar behavior to this task can be achieved by invoking the following [Azure ML CLI command](/cli/azure/ml(v1)/run?view=azure-cli-latest&preserve-view=true#az_ml_v1__run_submit_pipeline).
