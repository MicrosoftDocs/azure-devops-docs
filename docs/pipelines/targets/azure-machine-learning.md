...
A similar behavior to this task can be achieved by invoking the following [Azure ML CLI command](https://docs.microsoft.com/cli/azure/ml(v1)/run?view=azure-cli-latest#az-ml-v1--run-submit-pipeline).
