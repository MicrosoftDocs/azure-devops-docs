...
Deploying your function code in a custom Linux container requires [Premium plan](/azure/azure-functions/functions-premium-plan) or a [Dedicated (App Service) plan hosting](/azure/azure-functions/dedicated-plan). See [Functions Operating system/runtime](/en-us/azure/azure-functions/functions-scale#operating-systemruntimel) for details.
