...
1.  You will implement a branch policy to protect the master branch.  Select the **ellipsis** to the right of your branch name and select **Lock branch**. For more information, see [Branch policies](/azure/devops/repos/git/branch-policies-overview).
