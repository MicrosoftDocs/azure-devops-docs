...
| Build.Repository.ID | The unique identifier of the [repository](../../repos/index.md). | Yes |
...
| Build.Repository.Uri | The URL for the triggering repository. For example:<ul><li>Git: [https://fabrikamfiber@dev.azure.com/fabrikamfiber/_git/Scripts](https://fabrikamfiber@dev.azure.com/fabrikamfiber/_git/Scripts)<li>TFVC: [https://dev.azure.com/fabrikamfiber/](https://dev.azure.com/fabrikamfiber/)</ul>This variable can't be used as part of the build number or as a version control tag. | Yes |
