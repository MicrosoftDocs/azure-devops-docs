...
1. You'll be prompted for the passphrase. Give the value and click ok.

   ![Passphrase](_img/helm-provenance/passphrase.png)

1. After creating the key, you can see the list of keys which contains both private and public using the following command.
...
1. Store the private and public keys in 2 different files with the extension **gpg** as shown below.
