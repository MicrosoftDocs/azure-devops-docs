...
You're now ready to collaborate with a team on your app with a CI/CD process that automatically deploys your latest work to your web site.  Each change to the GitHub repo initiates a build in VSTS, and a VSTS Release Management pipeline executes a deployment to Azure.
...
When you configured your CI/CD process in this tutorial, a build and release pipeline were automatically created in your VSTS project. You can modify these build and release pipelines to meet the needs of your team. You learned how to:
