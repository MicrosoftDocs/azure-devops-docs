...
> [!TIP]
> To save the cost of running the tool installer, you can set up a [self-hosted agent](../agents/agents.md#install). See [Linux](../agents/v2-linux.md), [macOS](../agents/v2-osx.md), or [Windows](../agents/windows-agent.md). 
