...
- An Azure DevOps personal access token (PAT) to use with your GitHub Aactions. [Create a PAT](../../organizations/accounts/use-personal-access-tokens-to-authenticate.md).
