...
ms.custom: seodec18, devx-track-python, devx-track-azurecli, py-fresh-zinc
...
![Cancel pipeline run](get-started/media/cancel-pipeline-run.png)
...
![Pipeline run summary more actions menu](get-started/media/pipeline-run-summary-context-menu.png)
