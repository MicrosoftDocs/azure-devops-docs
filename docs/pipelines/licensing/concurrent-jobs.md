...
For information on how to apply for the grant of free parallel jobs, see [How much do parallel jobs cost (Microsoft-hosted)?](concurrent-jobs.md?view=azure-devops&tabs=ms-hosted#how-much-do-parallel-jobs-cost)
