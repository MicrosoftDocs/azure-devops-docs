...
- **Add additional security for forks**: When you work with public repositories from GitHub, carefully consider your approach to fork builds. Forks originating from outside your organization pose particular risks.    
    ...
    - **Consider manually triggering fork builds**: [Turn off automatic fork builds](../repos/github.md#contributions-from-forks) and use pull request comments to manually build these contributions. This setting gives you an opportunity to review the code before triggering a build.
...
- **Use Microsoft-hosted instead of self-hosted pools**: Microsoft-hosted pools offer isolation and a clean virtual machine for each run of a pipeline. Use Microsoft-hosted pools instead of self-hosted pools.
