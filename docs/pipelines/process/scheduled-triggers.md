...
Azure Pipelines cron schedules are defined in UTC, so schedules like **Build every Monday, Wednesday, and Friday at 6:00 PM** must be described in cron syntax, and converted from your local time zone to UTC. 
