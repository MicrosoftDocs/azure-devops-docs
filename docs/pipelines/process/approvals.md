...
> [!NOTE]
> Please prefer the predefined "$(system.AccessToken)" over custom access tokens if you plan to send requests to ADO from your Azure Function. The token belongs to Build Service Identity. This Identity never gets throttled by ADO.
