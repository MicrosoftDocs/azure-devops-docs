...
Use demands to make sure that the [capabilities](../agents/agents?view=azure-devops&tabs=browser#capabilities) your pipeline needs are present on the agents that run it. Demands are asserted automatically by tasks or manually by you.
