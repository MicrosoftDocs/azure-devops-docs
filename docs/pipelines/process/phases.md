...
> [!NOTE]
> The maximum job length for Microsoft hosted agents is 360 minutes (60 minutes for free pipelines), so setting `timeoutInMinutes` or `cancelTimeoutInMinutes` higher than the Microsoft hosted maximum job length has no effect.
