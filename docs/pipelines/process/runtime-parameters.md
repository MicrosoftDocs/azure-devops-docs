...
Use [templateContext](templates.md#use-templatecontext-to-pass-properties-to-templates) to pass additional properties to stages, steps, and jobs that are used as parameters in a template. 
