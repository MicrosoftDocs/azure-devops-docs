...
You can choose to download the artifacts in build jobs or to override the download behavior in deployment jobs with `download`. For more information, see [steps.download](/azure/devops/pipelines/yaml-schema/steps-download).
