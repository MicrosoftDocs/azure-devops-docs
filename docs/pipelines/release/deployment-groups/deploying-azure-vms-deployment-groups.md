...
> [!NOTE]
> Deployment groups are a concept used in Classic pipelines. If you are using YAML pipelines, see [Environments](/azure/devops/pipelines/process/environments?view=azure-devops&preserve-view=true).
