...
> To work around this issue, create a new custom view and [promote](../../artifacts/feeds/views.md) packages to that view. Then, in the release pipeline, specify the view in the Azure Artifacts source.
