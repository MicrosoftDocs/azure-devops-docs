...
| **Artifacts**      | Download and publish your binaries and various types of packages to different destinations.          |  :::image type="icon" source="../../media/icons/link.png" border="false" link="../artifacts/pipeline-artifacts.md?&tabs=yaml-task":::  |       :::image type="icon" source="../../media/icons/link.png" border="false" link="../artifacts/pipeline-artifacts.md?&tabs=yaml-task":::       |        :::image type="icon" source="../../media/icons/link.png" border="false" link="../release/deploy-multiple-branches.md#set-up-a-release-pipeline":::          |
| **Caching**                     | Reduce build time by caching and reusing dependencies from previous runs. |  :::image type="icon" source="../../media/icons/link.png" border="false" link="../release/caching.md":::   |       :::image type="icon" source="../../media/icons/checkmark.png" border="false":::       |        :::image type="icon" source="../../media/icons/delete-icon.png" border="false":::         | 
| **Conditions**               | Specify conditions under which a step, job, or stage should run.                                         |  :::image type="icon" source="../../media/icons/link.png" border="false" link="../process/conditions.md?tabs=yaml":::    |       :::image type="icon" source="../../media/icons/link.png" border="false" link="../process/conditions.md?tabs=classic":::       |        :::image type="icon" source="../../media/icons/link.png" border="false" link="../process/conditions.md?tabs=classic":::        |
| **Container jobs**      | Specify jobs to run in a container.                                                          |  :::image type="icon" source="../../media/icons/link.png" border="false" link="../process/container-phases.md":::  |       :::image type="icon" source="../../media/icons/delete-icon.png" border="false":::       |        :::image type="icon" source="../../media/icons/delete-icon.png" border="false":::        |
| **Demands** | Ensure that the capabilities your pipeline needs are present on the running agent.  |  :::image type="icon" source="../../media/icons/link.png" border="false" link="../agents/agents.md#configure-demands":::  |       :::image type="icon" source="../../media/icons/link.png" border="false" link="../agents/agents.md?tabs=classic#configure-demands":::       |        :::image type="icon" source="../../media/icons/link.png" border="false" link="../agents/agents.md?tabs=classic#configure-demands":::        |
| **Dependencies**                  | Specify a requirement that must be met in order to run the next stage.                |  :::image type="icon" source="../../media/icons/link.png" border="false" link="../process/stages.md?tabs=yaml#specify-dependencies":::  |       :::image type="icon" source="../../media/icons/delete-icon.png" border="false":::       |        :::image type="icon" source="../../media/icons/link.png" border="false" link="../process/stages.md?tabs=classic#specify-dependencies":::        |
| **Deployment groups** | Define a set of target machines each equipped with a deployment agent. Use in conjunction with [Deployment group jobs](../process/deployment-group-phases.md) to execute tasks on some or all of your designated target machines.                                         |  :::image type="icon" source="../../media/icons/delete-icon.png" border="false":::   |       :::image type="icon" source="../../media/icons/delete-icon.png" border="false":::        |        :::image type="icon" source="../../media/icons/link.png" border="false" link="../release/deployment-groups/index.md#create-a-deployment-group":::        |  
...
| **Environment**            | A collection of resources targeted for deployment. |  :::image type="icon" source="../../media/icons/link.png" border="false" link="../process/environments.md":::   |       :::image type="icon" source="../../media/icons/delete-icon.png" border="false":::       |        :::image type="icon" source="../../media/icons/delete-icon.png" border="false":::        |
...
| **Tasks**                         | The building blocks that define the steps that make up a pipeline job.                                           |  :::image type="icon" source="../../media/icons/link.png" border="false" link="../process/tasks.md?tabs=yaml":::   |       :::image type="icon" source="../../media/icons/link.png" border="false" link="../process/tasks.md?tabs=classic":::       |        :::image type="icon" source="../../media/icons/link.png" border="false" link="../process/tasks.md?tabs=classic":::          |
| **Templates**                 | Define reusable content, logic, and parameters.                                               |  :::image type="icon" source="../../media/icons/link.png" border="false" link="../process/templates.md":::   |       :::image type="icon" source="../../media/icons/delete-icon.png" border="false":::        |        :::image type="icon" source="../../media/icons/delete-icon.png" border="false":::         |
| **Triggers**                      | Define the event that causes a pipeline to run.                                               |  :::image type="icon" source="../../media/icons/link.png" border="false" link="../process/pipeline-triggers.md":::  |       :::image type="icon" source="../../media/icons/link.png" border="false" link="../process/pipeline-triggers-classic.md":::       |        :::image type="icon" source="../../media/icons/link.png" border="false" link="../release/triggers.md":::        |
| **Variables**                  | A placeholder for values that can be used throughout your pipeline's execution.                            |  :::image type="icon" source="../../media/icons/link.png" border="false" link="../process/variables.md?tabs=yaml#set-variables-in-pipeline":::  |       :::image type="icon" source="../../media/icons/link.png" border="false" link="../process/variables.md?tabs=classic#set-variables-in-pipeline":::       |        :::image type="icon" source="../../media/icons/link.png" border="false" link="../process/variables.md?tabs=classic#set-variables-in-pipeline":::        |
| **Variable groups**      | Use to store values and secrets that you want to manage and share across multiple pipelines.     |  :::image type="icon" source="../../media/icons/link.png" border="false" link="../library/variable-groups.md?tabs=yaml#use-a-variable-group":::  |       :::image type="icon" source="../../media/icons/link.png" border="false" link="../library/variable-groups.md?tabs=classic#use-a-variable-group":::       |        :::image type="icon" source="../../media/icons/link.png" border="false" link="../library/variable-groups.md?tabs=classic#use-a-variable-group":::        | 
