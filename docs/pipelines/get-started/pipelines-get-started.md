...
| **Approvals**            | Control your deployment workflow by requiring designated approvers to approve before deploying to a stage.                  |  :::image type="icon" source="../../media/icons/checkmark.png" border="false":::  |       :::image type="icon" source="../../media/icons/delete-icon.png" border="false":::       |        [Link](../release/approvals/approvals.md#predeployment-approvals)        |
| **Artifacts**      | Download and publish your binaries and various types of packages to different destinations.          |  [Link](../artifacts/pipeline-artifacts.md?&tabs=yaml-task)  |       [Link](../artifacts/pipeline-artifacts.md?&tabs=yaml-task)       |        [Link](../release/deploy-multiple-branches.md#set-up-a-release-pipeline)          |
| **Caching**                     | Reduce build time by caching and reusing dependencies from previous runs. |  [Link](../release/caching.md)   |       :::image type="icon" source="../../media/icons/checkmark.png" border="false":::       |        :::image type="icon" source="../../media/icons/delete-icon.png" border="false":::         | 
| **Conditions**               | Specify conditions under which a step, job, or stage should run.                                         |  [Link](../process/conditions.md?tabs=yaml)    |       [Link](../process/conditions.md?tabs=classic)       |        [Link](../process/conditions.md?tabs=classic)        |
| **Container jobs**      | Specify jobs to run in a container.                                                          |  [Link](../process/container-phases.md)  |       :::image type="icon" source="../../media/icons/delete-icon.png" border="false":::       |        :::image type="icon" source="../../media/icons/delete-icon.png" border="false":::        |
| **Demands** | Ensure that the capabilities your pipeline needs are present on the running agent.  |  [Link](../agents/agents.md#configure-demands)  |       [Link](../agents/agents.md?tabs=classic#configure-demands)       |        [Link](../agents/agents.md?tabs=classic#configure-demands)        |
| **Dependencies**                  | Specify a requirement that must be met in order to run the next stage.                |  [Link](../process/stages.md?tabs=yaml#specify-dependencies)  |       :::image type="icon" source="../../media/icons/delete-icon.png" border="false":::       |        [Link](../process/stages.md?tabs=classic#specify-dependencies)        |
| **Deployment groups** | Define a set of target machines each equipped with a deployment agent. Use in conjunction with [Deployment group jobs](../process/deployment-group-phases.md) to execute tasks on some or all of your designated target machines.                                         |  :::image type="icon" source="../../media/icons/delete-icon.png" border="false":::   |       :::image type="icon" source="../../media/icons/delete-icon.png" border="false":::        |        [Link](../release/deployment-groups/index.md#create-a-deployment-group)        |  
| **Deployment jobs**      | A collection of deployment steps that are run sequentially against the environment.                                                                  |  [Link](../process/deployment-jobs.md)  |       :::image type="icon" source="../../media/icons/delete-icon.png" border="false":::       |        :::image type="icon" source="../../media/icons/delete-icon.png" border="false":::        |
| **Environment**            | A collection of resources targeted for deployment. |  [Link](../process/environments.md)   |       :::image type="icon" source="../../media/icons/delete-icon.png" border="false":::       |        :::image type="icon" source="../../media/icons/delete-icon.png" border="false":::        |
| **Gates**               |  Automate release controls by evaluating health signals from external services before completing a deployment. |  :::image type="icon" source="../../media/icons/delete-icon.png" border="false":::   |       :::image type="icon" source="../../media/icons/delete-icon.png" border="false":::        |        [Link](../release/deploy-using-approvals.md#set-up-gates)        |
| **Jobs**                    | A series of sequential steps that form the smallest unit of work that can be scheduled to run.                                            |  [Link](../process/phases.md?tabs=yaml)  |       [Link](../process/phases.md?tabs=classi)        |        [Link](../process/phases.md?tabs=classic)         |
...
| **Service containers** | Enable you to manage the lifecycle of a containerized service. most commonly used with container jobs.                                |  [Link](../process/service-containers.md)  |       :::image type="icon" source="../../media/icons/delete-icon.png" border="false":::       |        :::image type="icon" source="../../media/icons/delete-icon.png" border="false":::        |
| **Stages**                  | Organize jobs within a pipeline.                                                              |  [Link](../process/stages.md?tabs=yaml#specify-stages)  |       :::image type="icon" source="../../media/icons/delete-icon.png" border="false":::        |        [Link](../process/stages.md?tabs=classic#specify-stages)        |
| **Task groups**              | Encapsulate a sequence of tasks into a single reusable task.    |  :::image type="icon" source="../../media/icons/delete-icon.png" border="false":::  |       [Link](../library/task-groups.md)       |        [Link](../library/task-groups.md)        | 
| **Tasks**                         | The building blocks that define the steps that make up a pipeline job.                                           |  [Link](../process/tasks.md?tabs=yaml)   |       [Link](../process/tasks.md?tabs=classic)       |        [Link](../process/tasks.md?tabs=classic)          |
| **Templates**                 | Define reusable content, logic, and parameters.                                               |  [Link](../process/templates.md)   |       :::image type="icon" source="../../media/icons/delete-icon.png" border="false":::        |        :::image type="icon" source="../../media/icons/delete-icon.png" border="false":::         |
| **Triggers**                      | Define the event that causes a pipeline to run.                                               |  [Link](../process/pipeline-triggers.md)  |       [Link](../process/pipeline-triggers-classic.md)       |        [Link](../release/triggers.md)        |
| **Variables**                  | A placeholder for values that can be used throughout your pipeline's execution.                            |  [Link](../process/variables.md?tabs=yaml#set-variables-in-pipeline)  |       [Link](../process/variables.md?tabs=classic#set-variables-in-pipeline)       |        [Link](../process/variables.md?tabs=classic#set-variables-in-pipeline)        |
| **Variable groups**      | Use to store values and secrets that you want to manage and share across multiple pipelines.     |  [Link](../library/variable-groups.md?tabs=yaml#use-a-variable-group)  |       [Link](../library/variable-groups.md?tabs=classic#use-a-variable-group)       |        [Link](../library/variable-groups.md?tabs=classic#use-a-variable-group)        | 
