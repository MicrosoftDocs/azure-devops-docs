...
<ol>
- Select <b>Web App</b> and choose <b>Next</b>.</br>
- Select <b>Empty Site</b> and choose <b>Create</b> (we use an empty site because you already have the necessary application code in your Visual Studio project).</br>
-  Enter your Microsoft account credentials when requested.</br>
</ol>
