...
- Click New service connection, and then click Azure.</br>

- <p>On the Add Azure Subscription dialog box:</p><ol>- Select Certificate.</br>- Click the link to download your publishsettings xml file and then open the file.</br>- Copy the ID and certificate values from the file and paste them into the Add Azure Subscription dialog box.</br></ol></br>
