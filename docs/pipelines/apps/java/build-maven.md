...
description: Define a continuous integration (CI) build pipeline for your Java app with Maven in Azure Pipelines or Team Foundation Server
ms.prod: devops
 ...
 * **TFS:** Select a pool that includes an agent with the Java Development Kit (JDK) and Maven installed.
