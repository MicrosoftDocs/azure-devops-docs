...
description: Define a continuous integration (CI) build process for your Java app with Gradle in Azure Pipelines or Team Foundation Server
ms.prod: devops
...
Azure Pipelines and Team Foundation Server (TFS) provide a highly customizable continuous integration (CI) process to automatically build your Java application whenever your team pushes or checks in code. In this quickstart you learn how to define your CI process.
