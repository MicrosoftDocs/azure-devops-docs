...
> [!NOTE]
> Classic NuGet restore uses the [NuGetCommand@2](/azure/devops/pipelines/tasks/reference/nu-get-command-v2) task. By default, this version uses NuGet 4.1.0. Use the [NuGet Tool Installer task](/azure/devops/pipelines/tasks/reference/nuget-tool-installer-v1) if you want to use a different NuGet version.
