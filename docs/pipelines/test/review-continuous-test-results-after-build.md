...
* **API(s)**. Test results published directly by using the [Test Management API(s)](https://docs.microsoft.com/rest/api/vsts/test/results).
...
* **Rerun failed tests**: The ability to rerun failed tests is available in the latest version of the [Visual Studio Test](../tasks/test/vstest.md) task.
  ...
  Additionally the [Test Management API(s)](https://docs.microsoft.com/rest/api/vsts/test/results)
...
> [Test Management API(s)](https://docs.microsoft.com/rest/api/vsts/test/results). 
> It will be available for Single Agent jobs in a future release.
