...
Troubleshooting assistance is available using the **Error analysis** page.

:::moniker-end

:::moniker range="azure-devops"

:::image type="content" source="pipeline-error-analysis-icon.png" alt-text="Screenshot of view analysis icon.":::

:::moniker-end

:::moniker range="azure-devops"

:::image type="content" source="pipeline-error-analysis-icon-server.png" alt-text="Screenshot of view analysis icon for Azure DevOps Server.":::
...
* Choose the name of the task below **Run-time details** to view information about the task.
   :::image type="content" source="task-details.png" alt-text="Screenshot of task details.":::
