...
* To make it easier, we're moving the default queue to the **Tasks** tab, in the **Process** section.
  ...
  ![default build queue on tasks tab](media/2017/06/default-build-queue-on-tasks-tab-required.png)
...
![pick a build definition from the build summary](media/2017/06/pick-a-build-definition-from-the-build-summary.png)
...
![Generic HTTP REST API task](media/2017/07/generic-http-task.png)
...
![Azure Key Vault integration](media/2017/07/azure-key-vault.png)
...
[Xamarin](../../ecosystems/xamarin.md) Removed variables that are no longer needed.
...
![visual studio enterprise subscriber pipelines](media/2017/06/visual-studio-enterprise-subscriber-pipelines.png)
...
![Screenshot showing the Secure Files library.](media/2017/06/secure-files-library.png)
...
![Specifying a Git continuous deployment trigger](media/2017/06/git-trigger.png)
...
![Specifying an environment deployment trigger for an artifact branch](media/2017/06/deploy-branch-filter.png)
...
![Deployment not started information pop-up](media/2017/06/deploy-not-started.png)
...
![Defining variables in instructions parameter](media/2017/06/maninter-use-variables.png)

![Result of using variables in instructions parameter](media/2017/06/maninter-instructions.png)
...
![deprecated task](media/2017/06/deprecated-task.png)
...
![deprecated task description](media/2017/06/deprecated-task-description.png)
...
![Screenshot showing task group references.](media/2017/06/task-group-references.png)
...
![Deployment groups](media/2017/05/05_10_22.png)
...
![Configure deployment groups](media/2017/05/05_10_23.png)

When the deployment runs, the logs show the progression across the entire
group of machines you are targeting.

![Deployment groups progress](media/2017/05/05_10_24.png)
...
[Troubleshooting build](../../troubleshooting/troubleshooting.md)
...
![NodeVersionSpec process variable](media/2017/04/NodeVersionSpec-process-variable.png)
...
![build definition options tab](media/2017/04/build-definition-options-tab.png)

![build definition options tab multi configuration enabled](media/2017/04/build-definition-options-tab-multi-configuration-enabled.png)

And last, add the Node.js tool installer task.

![build definition tasks tab](media/2017/04/build-definition-tasks-tab.png)

Save and queue the build, to see your app validated with multiple versions of Node.js.

![multiple builds of node js running in parallel](media/2017/04/multiple-builds-of-node-js-running-in-parallel.png)
...
* [Build artifacts](../../artifacts/artifacts-overview.md) Examples and tips on publishing and using build artifacts.
...
[Environments](../../process/stages.md)

[Generated by Azure](/azure/app-service/app-service-continuous-deployment)

### New build editor

Our thanks to those of you who tried the early previews of our new build editor and gave us feedback. We're getting ready to retire the old build editor. So if you haven't yet gotten familiar with the new build editor, we encourage you to do so now. [Learn more](../../process/parameters.md).
...
![run this task menu](media/2017/03/run-this-task-menu.png)
...
[Earlier this year](#january-25) we announced a preview of the new build editor. Thank you to all who have been trying it and giving us feedback! If you haven't done so already, please try the [new editor](../../process/parameters.md) and let us know what you think. Soon we'll be switching your account to make it the default editor.
...
![Azure RD parameters](media/2017/03/03_29_10.png)
...
![parallel deployments](media/2017/03/03_29_11.png)

### Unified Build and Release docs

<img style="float:left;margin-right:10px;width:250px;" alt="CI and CD development and release cycle" src="media/2017/03/ci-01.png"/>

You might have noticed that the build and release docs have been coming closer together over the past couple of months. Today it's official. Just as Build and Release is joined in Azure Pipelines, and they're now also [joined in our docs](../../get-started/what-is-azure-pipelines.md).
...
![hosted agent minute usage](media/2017/03/hosted-agent-minute-usage.png) 
...
[Pipelines in Azure Pipelines](../../licensing/concurrent-jobs.md) Added clarification to FAQ about control of pipeline allocation.
...
![agent phases](media/2017/02/02_15_18.png)

For more information, see [this post](https://devblogs.microsoft.com/devops/vstest-task-dons-a-new-avatar-testing-with-unified-agents-and-phases/).
...
![agent maintenance](media/2017/02/02_15_03.png)
...
![resource limits](media/2017/02/02_15_06.png)
...
![release in progress](media/2017/02/02_15_07.png)
...
![new build editor switch](media/2017/01/new-build-editor-switch.png)
...
![new build definition](media/2017/01/new-build-definition.png)
...
![add task](media/2017/01/add-task.png)
...
![process parameters](media/2017/01/process-parameters.png)
...
The new editor includes a few other enhancements, such as giving you quicker access to your sources settings. For more details, see [Preview of our new build editor](../../process/parameters.md).
...
![release action in build summary](media/2017/01/release-action-in-build-summary.png)

### Role-based security for variable groups

You now manage security for variable groups using roles.

![assign security roles for library](media/2017/01/assign-security-roles-for-library.png)
...
[Release Management queuing policies](../../process/stages.md#queuing-policies)
