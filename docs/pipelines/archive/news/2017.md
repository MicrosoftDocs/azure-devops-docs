...
> [!NOTE]
> This topic is archived. For the latest news on Build and Release, see the [News about VSTS](https://visualstudio.microsoft.com/team-services/updates/).
...
__NuGet Restore__ is now optimized for the most common scenario of restoring packages before a Visual Studio Build task. It also has better support for small projects that share a single NuGet feed: you can now pick a VSTS feed and have it added to an auto-generated NuGet.Config.
