...
![Screenshot of the Configure Continuous Delivery command.](media/2016/11/visual-studio-configure-continuous-delivery-command.png)

![Screenshot of the Configure Continuous Delivery dialog box.](media/2016/11/visual-studio-configure-continuous-delivery-dialog-box.png)
...
To bypass synchronizing source files, select one of the Git options as your [repository type](../../repos/index.md), and then select **Don't sync sources.** This can be useful if you want to handle Git version control operations yourself, or if you just want to run automation without version control dependencies.
...
[Specify the repository](../../repos/index.md)
...
You no longer need a Xamarin license to [build your Xamarin app](../../ecosystems/xamarin.md). We're deprecating the [Utility: Xamarin license](../../tasks/utility/xamarin-license.md) task. We recommend that you remove this task from your build to avoid disruption when we remove the task from the product.
...
> ![Give permissions to the folders.](media/2016/08/folder-permissions.png)
...
[Home page](../../get-started/what-is-azure-pipelines.md) - broadened coverage and implemented responsive design
...
[Build your Xamarin app](../../ecosystems/xamarin.md) now with enhanced templates.
...
[Specify the repository](../../repos/index.md) (FAQ: What kinds of submodules can I check out?)
...
:::image type="icon" source="../../tasks/utility/media/delete-files.png" border="false"::: [Delete Files](../../tasks/utility/delete-files.md)
