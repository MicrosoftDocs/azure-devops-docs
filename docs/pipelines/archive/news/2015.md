...
Scripts can now use the build process OAuth token to access the Azure Pipelines REST API. See [Use a script to customize your build process](../../scripts/powershell.md).
