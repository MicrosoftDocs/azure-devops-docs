...
description: This article explains how to use the Azure Function App task to deploy Azure Function apps to Azure.
ms.topic: reference
...
<tr><td><code>appType</code><br/>App type</td><td>(Required) Function app type. Options: <code>functionAppLinux</code>, <code>functionApp</code> (default).</td>
<tr><td><code>appName</code><br/>App name</td><td>(Required) Name of an existing Azure Function App.</td>
...
<tr><td><code>resourceGroupName</code><br/>Resource group</td><td>(Required if deployToSlotOrASE = true) Name of the resource group.</td>
<tr><td><code>slotName</code><br/>(Slot)</td><td>(Required if deployToSlotOrASE = true) Name of the slot.<br/><br/>Default value: production</td>
<tr><td><code>package</code><br/>(Package or folder)</td><td>(Required) File path to the package or a folder containing app service contents generated by MSBuild or a compressed zip or war file. <br/><br/>Variables (<a href="/vsts/pipelines/build/variables" data-raw-source="[Build](/vsts/pipelines/build/variables)">Build</a> | <a href="/vsts/pipelines/release/variables#default-variables" data-raw-source="[Release](/vsts/pipelines/release/variables#default-variables)">Release</a>) and wildcards are supported. Example: $(System.DefaultWorkingDirectory)/*.zip.</td>
...
<tr><td><code>startUpCommand</code><br/>Startup command</td><td>(Optional). Startup command to be run after deployment. Used when appType = functionAppLinux. </td>
...
<tr><td><code>appSettings</code><br/>App settings</td><td>(Optional) Edit web app application settings following the syntax -key value. Value containing spaces should be enclosed in double quotes. <br/>Example: -Port 5000 -RequestTimeout 5000 -WEBSITE_TIME_ZONE "Eastern Standard Time"</td>
<tr><td><code>configurationStrings</code><br/>Configuration settings</td><td>(Optional) Edit web app application settings following the syntax -key value. Value containing spaces should be enclosed in double quotes.<br/>Example: -phpVersion 5.6 -linuxFxVersion: node|6.11</td>
<tr><td><code>deploymentMethod</code><br/>Deployment method</td><td>(Required) Choose the<a href="#deployment-methods" data-raw-source="[Deployment method](#deployment-methods)">Deployment method</a> for the app.<br/><br/>Options: auto, zipDeploy, runFromPackage. Default value: auto.</td>
</table>
