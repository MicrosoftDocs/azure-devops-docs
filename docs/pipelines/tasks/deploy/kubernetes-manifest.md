...
- **Bake manifest**: The **bake** action of the task allows for baking templates into Kubernetes manifest files. The action uses tools such as Helm, Compose, or kustomize. With baking, these Kubernetes manifest files are usable for deployments to the cluster.
...
<table>
  ...
  <tr>
    ...
    <td><blockquote>Required if <b>strategy</b> is set to <b>canary</b>; optional otherwise</blockquote>
...
The following YAML code is an example of deploying to a Kubernetes namespace by use of manifest files:
...
> 1. A promote action that is run if a Manual Intervention task is resumed and a reject action that is run if a Manual Intervention task is rejected.
...
<table>
  ...
  <tr>
    ...
    <td><blockquote>Required if the <b>action</b> value is <b>secret</b>; optional otherwise</blockquote>
  ...
  <tr>
    ...
    <td><blockquote>Required if <b>action</b> is set to <b>createSecret</b> and <b>secretType</b> is set to <b>dockerRegistry</b>; optional otherwise</blockquote>
  ...
  <tr>
    ...
    <td><blockquote>Required if <b>action</b> is set to <b>createSecret</b> and <b>secretType</b> is set is to <b>generic</b>; optional otherwise</blockquote>
    Multiline input that accepts keys and literal values to be used for creation and updating of secrets. For example:<br/>
    <b>--from-literal=key1=value1</b> <b>--from-literal=key2=&quot;top secret&quot;</b>
    </td>
  </tr>
  <tr>
    <td><b>kubernetesServiceConnection</b><br/>Kubernetes service connection</td>
    <td><blockquote>Required</blockquote>The name of the <a href="../../library/service-endpoints.md#sep-kuber" data-raw-source="[Kubernetes service connection](../../library/service-endpoints.md#sep-kuber)">Kubernetes service connection</a>.</td>
  </tr>
  <tr>
    <td><b>namespace</b><br/>Namespace</td>
    <td><blockquote>Required</blockquote>
...
<table>
  ...
  <tr>
    ...
    <td><blockquote>Required if <b>action</b> is set to <b>bake</b>; optional otherwise</blockquote>
  ...
  <tr>
    ...
    <td><blockquote>Required if <b>action</b> is set to <b>bake</b> and <b>renderType</b> is set to <b>helm2</b>; optional otherwise</blockquote>
    The path to the Helm chart used for bake.</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    Additional override values that are used via the command-line switch <b>--set</b> when baking manifest files using Helm.<br/>
    <br/>
  ...
  <tr>
    <td><b>dockerComposeFile</b><br/>Path to docker composes file</td>
...
The following YAML code is an example of baking manifest files from Helm charts. Note the usage of name input in the first task. This input is later referenced from the deploy step for specifying the path to the manifests that were produced by the bake step.
...
<table>
  ...
  <tr>
    ...
    <ul>
      <li>A manifest file is used to identify the objects to be patched.</li>
      <li>An individual object is identified by kind and name as the target for the patch.</li>
    </ul><br/>
    Acceptable values are <b>file</b> and <b>name</b>. The default value is <b>file</b>.</td>
  </tr>
  <tr>
    <td><b>resourceFiletoPatch</b><br/>File path</td>
    <td><blockquote>Required if <b>action</b> is set to <b> patch</b> and <b>resourceToPatch</b> is set to <b>file</b>; optional otherwise</blockquote>
    The path to the file used for patch.</td>
  </tr>
  <tr>
    <td><b>kind</b><br/>Kind</td>
    <td><blockquote>Required if <b>action</b> is set to <b>patch</b> and <b>resourceToPatch</b> is set to <b>name</b>; optional otherwise</blockquote>
    The kind of the Kubernetes object like ReplicaSet or StatefulSet.</td>
  </tr>
  <tr>
    <td><b>name</b><br/>Name</td>
    <td><blockquote>Required if <b>action</b> is set to <b>patch</b> and <b>resourceToPatch</b>  is set to <b>name</b>; optional otherwise</blockquote>
...
<table>
  ...
  <tr>
    ...
    <td><blockquote>Required</blockquote>
    Arguments to be passed onto kubectl for deleting the necessary objects. An example is:<br/>
