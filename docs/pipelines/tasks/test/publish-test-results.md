...
|  | Dura
 | /TestRun/Results/UnitTestResult.Attributes["**duration**"].Value Or /TestRun/Results/WebTestResult.Attributes["**duration**"].Value Or /TestRun/Results/TestResultAggregation.Attributes["**duration**"].Value |
...
|  | Duration> [!NOTE] | /testsuites/testsuite/testcase/.Attributes["**time**"].Value |
...
|  | Duration> [!NOTE] | /test-results/results/test-case.Attributes["**time**"].Value |
...
|  | Duration> [!NOTE] | /test-suite[@type='Assembly']/test-case.Attributes["**duration**"].Value |
|  | Owner | build or release requested for user |
...
|  | Duration> [!NOTE] | /assemblies/assembly/collection/test.Attributes["**time**"].Value |
...
|  | Duration> [!NOTE] | /Site/Testing/Test/Results/**NamedMeasurement[@name= 'Execution Time']/Value.InnerText** |
|  | Owner | Build or release requested for user |
...
>
> The fully Qualified name for **testName** is format is **Namespace.Testclass.Methodname** with a character limit of 512. If the test is data driven and has parameters, the character limit will include the parameters.
