...
> [!TIP]
> See [organization-scoped feeds vs project-scoped feeds](../../../artifacts/feeds/project-scoped-feeds.md?view=azure-devops#understanding-the-difference-between-an-organization-scoped-feed-and-a-project-scoped-feed&preserve-view=true) to understand the difference between the two types and learn how to check if your feed is project-scoped or organization-scoped.
