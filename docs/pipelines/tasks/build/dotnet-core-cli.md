...
<tr><td><code>projects</code><br/>Path to project(s)</td><td>The path to the csproj file(s) to use. You can use wildcards (e.g. <code>&ast;&ast;/&ast;.csproj</code> for all .csproj files in all subfolders), see <a href="https://docs.microsoft.com/azure/devops/pipelines/tasks/file-matching-patterns">file matching patterns</a>.</td></tr>
