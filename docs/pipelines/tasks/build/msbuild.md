...
<p>If you want to build multiple projects, specify search criteria. You can use a single-folder wildcard (<code><em>*</em></code>) and recursive wildcards (<code></em>**<em></code>). For example, <code></em><em>*.</em>proj</code> searches for all MSBuild project (.&#42;proj) files in all subdirectories.</p>
