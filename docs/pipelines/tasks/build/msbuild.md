...
This section aims to to provide few troubleshooting tips for some of the common issues that a user may face when using the MSBuild task.
...
If you are using a hosted build agent, you may want to try to reproduce the error locally. This will help you to narrow down whether the failure is the result of the build agent or the build task.
