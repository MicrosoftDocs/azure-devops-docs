...
> [!NOTE]
> This task is deprecated. If you're using Team Foundation Server 2017 or newer, we recommend that you use the [Pipeline Artifacts](../../artifacts/pipeline-artifacts.md) task instead.  It [scales better, allows parallel uploads, and is faster.](https://docs.microsoft.com/en-us/azure/devops/release-notes/2021/sprint-190-update)
