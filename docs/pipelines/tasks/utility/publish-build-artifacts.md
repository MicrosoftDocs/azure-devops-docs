...
| `ArtifactName`<br/>Artifact name<br/>*required* | Specify the name of the artifact that you want to create. The following special characters are not allowed: `+`, `%`, `{`, `}`.<br/>Default value: `drop` |
