...
| `ArtifactName`<br/>Artifact name<br/>*required* | Specify the name of the artifact that you want to create. It can be almost anything, but it can't contain the special characters `+`, `%`, `{`, or `}`.<br/>Default value: `drop` |
