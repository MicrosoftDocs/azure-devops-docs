...
|`TargetFolder`<br/>Target Folder|(Required) Target folder or UNC path files will copy to. You can use [variables](http://go.microsoft.com/fwlink/?LinkID=550988). <br/>Example: **$(build.artifactstagingdirectory)**|
