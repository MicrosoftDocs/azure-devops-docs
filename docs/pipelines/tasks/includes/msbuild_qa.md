...
No. MSBuild doesn't support the building of SSIS, SSRS and SSAS projects out of the box. However, (devenv.exe) performs the same function as the Build Solution menu command within the integrated development environment (IDE). As a workaround, you could use Devenv Command to build your SSIS solution.
