...
1. The commit that will create your new pipeline appears. You can see the generated files mentioned above. Select **Save and run**.

1. If you want, change the **Commit message** to something like _Add continuous deployment to our repo_. When you're ready, select **Save and run** to commit the new pipeline into your repo, and then begin the first run of your new pipeline!
