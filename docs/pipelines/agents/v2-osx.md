...
> Before you begin:
> * If your build and release definitions are in [VSTS](https://www.visualstudio.com/products/visual-studio-team-services-vs) and a [hosted agent](hosted.md) meets your needs, you can skip setting up a private macOS agent.
