...
> Before you begin:
> * If your code is in [VSTS](https://www.visualstudio.com/products/visual-studio-team-services-vs) and a [hosted agent](hosted.md) meets your needs, you can skip setting up a private Windows agent.
