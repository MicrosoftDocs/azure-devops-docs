...
| Ubuntu 22.04 Preview | *ubuntu-22.04* | `ubuntu-latest` OR `ubuntu-22.04` | [Link](https://github.com/actions/virtual-environments/blob/main/images/linux/Ubuntu2204-Readme.md)
