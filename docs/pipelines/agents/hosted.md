...
> [!IMPORTANT]
> The macOS 15 Sequoia ARM64 Limited Public Preview has been discontinued. Any Azure DevOps organization currently using it can continue to do so. Look out for this section for further updates on macOS ARM64 image availability.
