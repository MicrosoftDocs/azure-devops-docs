...
> [!NOTE]
> The Windows ARM64 agent is now available in **public preview** for Windows 11 (26H1, 25H2, 24H2). For more information, see the [v4 agent supported operating systems](v4-agent.md#upgrade-to-4x-agent-on-supported-operating-systems).
