...
If your pipelines are in Azure Pipelines, then you can conveniently run your jobs by using a *Microsoft-hosted agent*. With Microsoft-hosted agents, maintenance and upgrades happen automatically.
