...
<img src="/azure/devops/pipelines/_shared/media/browse-to-team-project.png" alt="Browse to project"/>
...
<img src="/azure/devops/pipelines/_shared/media/create-new-build-definition.png" alt="Build tab"/>
<p></p>
</div>
</li>
