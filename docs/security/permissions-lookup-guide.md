...
The **Edit collection level information** permission is set through the Security admin page for a team project. It includes the ability to perform the following tasks 
for all team projects defined in the account or collection:
