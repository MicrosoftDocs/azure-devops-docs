---
title: Visual Studio Team Services (VSTS) - Data Protection
description: Learn how Microsoft protects your Visual Studio Team Services (VSTS) projects and data. Microsoft is committed to making sure that your Visual Studio Team Services projects stay safe and secure, without exception. 
ms.prod: vs-devops-alm
ms.technology: vs-devops-articles
ms.assetid: 06ca2750-ac37-41a2-b17a-cfca3e6ce882
ms.manager: douge
ms.date: 2/6/2017
ms.author: mlearned
author: jeffbe
...
# Visual Studio Team Services (VSTS) Data Protection Overview
...
![Visual Studio Team Services (VSTS) high-level architecture diagram ](./_img/team-services-security-whitepaper/Figure1_VSOArchitecture.png)
...
Visual Studio VSTS leverages many of the Microsoft Azure storage
...
![Visual Studio VSTS live-site management process](./_img/team-services-security-whitepaper/Figure2_VSOSiteManagementProcess.png)
...
[Visual Studio VSTS SLAs](https://azure.microsoft.com/en-us/support/legal/sla/visual-studio-team-services/v1_2/).
...
To ensure data is not intercepted or modified while in transit between you
and VSTS, we encrypt via HTTPS / SSL. In addition, Azure encrypts 
all connections to Azure Storage and SQL databases to protect the integrity of 
the data. VSTS also encrypts your data at rest to protect against the 
threat of malicious activity by performing real-time encryption:  Storage 
Service Encryption (SSE) on Azure blob storage and Transparent Data Encryption 
(TDE) on SQL Databases, associated backups, and transaction log files.
...
[configure this support for your VSTS account](https://www.visualstudio.com/docs/setup-admin/team-services/manage-organization-access-for-your-account-vs).
...
-   [Visual Studio Team Services status](https://blogs.msdn.com/b/vsoservice/)
