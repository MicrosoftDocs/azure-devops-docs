...
<td>You can use all [TFBuild](../build/overview.md) capabilities to build any combination of content you want within the team project collection.</td>
...
<tr><td>Files</td>
<td><p>Each team project contains all files under a single root path (for example: **$/FabrikamTFVC**). You can [apply permissions](../setup-admin/permissions.md) at the file level. You can [lock files](lock-unlock-folders-files.md).</p>
