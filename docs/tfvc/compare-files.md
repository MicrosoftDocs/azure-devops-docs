...
1.  If you are not already connected to the team project that you want to work in, then [connect to the team project](../accounts/connect-to-visual-studio-team-services.md).
