...
-   If you build your changes in your automated build system (for example with a [CI Build](../build/define/triggers.md) or a [Gated Check-in Build](../build/define/repository.md) your team members can see in which completed build the task was completed or the bug was fixed.
