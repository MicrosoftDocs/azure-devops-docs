...
To perform the following procedure, your **Manage branch** permission must be set to **Allow**. For more information, see [Permission reference for Team Foundation Server](../setup-admin/permissions.md).
...
**Required Permissions**  
To perform this procedure, your **Check out** permission and your **Merge** permission for the target path must be set to **Allow**. For more information, see [Permission reference for Team Foundation Server](../setup-admin/permissions.md).
