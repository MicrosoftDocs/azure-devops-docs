...
After you have [connected to the team project](../accounts/connect-to-vsts.md#TEEConnect) (Keyboard: Ctrl + 0, C), you can manage your workspaces from the Team Explorer home page (Keyboard: Ctrl + 0, H)
...
1.  [Connect to the team project](../accounts/connect-to-vsts.md#TEEConnect) (Keyboard: Ctrl + 0, C).
