...
* [Build: Visual Studio Build task](../steps/build-release/visual-studio-build.md): For **Visual Studio Version** select _Visual Studio "15" (preview)_.

* [Build: MSBuild task](../steps/build-release/msbuild.md): For **MSBuild Version** select _MSBuild 15.0 (preview)_.
...
[Build: Xcode Build](../steps/build-release/xcode-build.md) Added Xcode 8 automatic signing. Added options to support creating app packages.
...
We've added an option that enables you to use [xcpretty](https://github.com/supermarin/xcpretty/blob/master/README.md) to format your xcodebuild output and publish JUnit test results. See [Xcode Build](../steps/build-release/xcode-build.md).

### Publish Jenkins test and code coverage results

You can now use the **Jenkins Queue Job** build and release task to retrieve test and code coverage results from a Jenkins job or pipeline. See [Jenkins Queue Job](../steps/build-release/jenkins-queue-job.md).

### Build summary for Maven and Gradle tasks

When you enable the **Run SonarQube Analysis** option in the [Maven](../steps/build-release/maven.md) or [Gradle](../steps/build-release/gradle.md) build tasks, you get a link on the SonarQube project. You can request a full analysis to see the quality gates details, and choose to break the build if they are not met.

![maven and gradle](_img/2016/09/9_21_06.png)

### FindBugs and CheckStyle in Maven build

You can now request FindBugs and CheckStyle standalone static analysis in the [Maven](../steps/build-release/maven.md) build task (in addition to the PMD analysis). The results of the static analysis appear in the build summary, and resulting files are available from the Artifact tab of the build result.
...
We expect this migration to be a non-event for the vast majority of users. However, we have seen a few cases where custom build tasks are not compatible due to reflection across internal APIs or reliance to specific agent folder layout. If you run into any issues [please let us know](../../provide-feedback.md).
...
[Build: Jenkins Queue Job](../steps/build-release/jenkins-queue-job.md) Added arguments.
...
[Build: Jenkins Queue Job](../steps/build-release/jenkins-queue-job.md)
...
* Symbols that you've published using the [Index Sources & Publish Symbols](../steps/build-release/index-sources-publish-symbols.md) build step.
...
[Build: Xcode Build](../steps/build-release/xcode-build.md)

[Build: Xcode Package iOS](../steps/build-release/xcode-package-ios.md)
...
[Build: CMake](../steps/build-release/cmake.md)


### Updated documentation

[Build: Gulp](../steps/build-release/gulp.md)
...
[Build: Xamarin.Android](../steps/build-release/xamarin-android.md) now supports Mac and Linux.

[Build: Xamarin.iOS](../steps/build-release/xamarin-ios.md) now supports signing and packaging.
...
[Build: Ant](../steps/build-release/ant.md)
...
See [Triggers: Gated check-in](../define/triggers.md#gated).
...
[Build: Android build](../steps/build-release/android-build.md)

[Build: Android signing](../steps/build-release/android-signing.md)
