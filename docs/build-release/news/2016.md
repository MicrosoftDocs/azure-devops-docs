...
[Build](../steps/index.md) Added version qualifiers.
...
[Deploy build steps](../steps/index.md#deploy)

[Test build steps](../steps/index.md#test)
...
[Build: Xamarin.iOS](../steps/build/xamarin-ios.md) now supports signing and packaging.
...
See [Triggers: Gated check-in](../concepts/definitions/build/triggers.md#gated).
