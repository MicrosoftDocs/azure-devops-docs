...
description: New things you can do with Team Foundation Build (TFBuild) and Release Management.
...
* The [Visual Studio Build](../steps/build-release/visual-studio-build.md) and [MSBuild](../steps/build-release/msbuild.md) tasks now default to the **Latest** setting for the version argument.
...
* [Utility: Install Apple Certificate](../steps/utility/install-apple-certificate.md)

* [Utility: Install Apple Provisioning Profile](../steps/utility/install-apple-provisioning-profile.md)
...
* [Build and deploy your ASP.NET Core app to Azure](../apps/aspnet/aspnetcore-to-azure.md), [Build your ASP.NET Core app](../apps/aspnet/ci/build-aspnet-core.md) Added ASP.NET Core (PREVIEW) template.

* [Build variables](../define/variables.md) Added AGENT_JOBSTATUS variable
...
The [Visual Studio Build](../steps/build-release/visual-studio-build.md) and [MSBuild](../steps/build-release/msbuild.md) tasks enable you to select a specific version of Visual Studio. Until now, if the **Visual Studio 2017** version was not available, these tasks would automatically pick the next available version.
...
[Deploy: IIS Web App Deploy](../steps/deploy/iis-deploy.md)

[Deploy: IIS Web App Manage](../steps/deploy/iis-manage.md)

[Test: Publish Code Coverage Results](../steps/test/publish-code-coverage-results.md)

[Test: Publish Test Results](../steps/test/publish-test-results.md)

### Updated content

[Build variables](../define/variables.md) Added section on setting variables from scripts.
...
[File matching patterns reference](../steps/file-matching-patterns.md) Added exclude pattern examples
...
* [CI/CD for newbies](../get-started/ci-cd-part-1.md) What is continuous integration (CI)? What is continuous deployment (CD)? Why should I care? How do I get started?

* [Build artifacts](../concepts/definitions/build-release/artifacts.md) Examples and tips on publishing and using build artifacts.
...
[Generated by Azure](../get-started/aspnet-4-ci-cd-azure-automatic.md)
...
In support of conditional tasks, we're offering a new build variable: `Build.Reason`. You can use this variable to check for CI, scheduled, and other triggers. See [variables](../define/variables.md).
...
[Build and deploy your ASP.NET Core app to Azure](../apps/aspnet/ci/build-aspnet-core.md) includes the ability to use hosted agents to build ASP.NET Core apps.
...
We're now advising you to use [File matching patterns](../steps/file-matching-patterns.md) from these tasks: [Copy Files](../steps/utility/copy-files.md), 
[Extract Files](../steps/utility/extract-files.md), and [FTP Upload](../steps/utility/ftp-upload.md).

### Other updated content

[Node.js](../apps/node/nodejs-to-azure.md) Moved deployment step out of CI build and into Release Management. Gave web deployment artifact a useful file name.
...
See [Reference for creating custom build tasks within extensions](../../integrate/extensions/develop/build-task-schema.md)
...
For more details, see [Set up environments to run continuous test tasks with your build tasks](../../test/continuous-testing/set-up-continuous-test-environments-builds.md).
...
[CI/CD ASP.NET 4 generated by Azure](../get-started/aspnet-4-ci-cd-azure-automatic.md)

[CI/CD ASP.NET 4 Generated by Visual Studio](../get-started/aspnet-4-ci-cd-vs-automatic.md)

[CI/CD ASP.NET 4 do it yourself](../apps/aspnet/aspnet4-to-azure.md)

[CI/CD ASP.NET Core with Docker, generated by Visual Studio](../apps/aspnet/aspnetcore-docker-to-azure.md)

[CI/CD ASP.NET Core do it yourself](../apps/aspnet/aspnetcore-to-azure.md)
...
[Build options](../define/options.md) and related topics
...
> [!NOTE]
> We recommend that you avoid using hard coded paths to resources on the hosted agent. Instead, you should always use [variables](../define/variables.md) to construct any references that you need to make to resources used by your build.
