...
* The [Visual Studio Build](../steps/build/visual-studio-build.md) and [MSBuild](../steps/build/msbuild.md) tasks now default to the **Latest** setting for the version argument.
...
The [Visual Studio Build](../steps/build/visual-studio-build.md) and [MSBuild](../steps/build/msbuild.md) tasks enable you to select a specific version of Visual Studio. Until now, if the **Visual Studio 2017** version was not available, these tasks would automatically pick the next available version.
