...
> **Tip**: When building on a Mac, you should either set up the [agent](../../concepts/agents/agents.md) as a launchd service (./svc.sh install) or run it as an interactive process (./run.sh).
