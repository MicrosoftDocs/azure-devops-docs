...
You need to have worked through the quickstart [Build and Deploy to an Azure Web App](aspnet-core-to-azure-webapp.md)
...
In this section, you will explore the release definition that was created by the [Build and Deploy to an Azure Web App](aspnet-core-to-azure-webapp.md) quickstart.
