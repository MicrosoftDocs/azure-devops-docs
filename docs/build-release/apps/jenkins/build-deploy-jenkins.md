---
title: Deploy your app to Linux VMs using Jenkins
description: Implement continuous deployment of your app to Linux VMs using Jenkins and Team Services
ms.prod: vs-devops-alm
ms.technology: vs-devops-build
ms.assetid: DA1C1446-3F65-4949-81AB-E8721DB9A791
ms.manager: douge
ms.author: ahomer
ms.date: 08/22/2016
---
...
Services release definition](https://www.visualstudio.com/docs/build-release/actions/work-with-release-definitions).
...
1. In the **Source Code Management** tab, select **Git** and enter the details
   ...
   ![Add a repo to your build](_img/tutorial-build-deploy-jenkins/jenkins-git.png)
...
1. For **Trigger release in TFS/Team Services**, enter the full URL of your account
   ...
   ![Configuring Jenkins Post-build Actions](_img/tutorial-build-deploy-jenkins/trigger-release-from-jenkins.png)
...
You need a [deployment group](https://www.visualstudio.com/docs/build-release/concepts/definitions/release/deployment-groups/) to contain the virtual machines.
...
1. Choose the drop down arrow next to the **+ Add tasks** link and add a deployment group phase to the definition.
   ...
   ![Adding a deployment group phase](_img/tutorial-build-deploy-jenkins/deployment-group-phase-in-release-definition.png) 
...
* **Location**: Select a region for the deployment.
  ...
  ![Create a new resource group](_img/tutorial-build-deploy-jenkins/provision-web-server.png)
