...
If necessary, you can write your own [custom extensions](../../integrate/index.md) to [custom tasks](../../integrate/extensions/develop/add-build-task.md) for your builds and releases.
