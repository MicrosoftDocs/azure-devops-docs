---
title: Copy Files
description: How to copy files between folders with match patterns when building code in Visual Studio Team Services VSTS and Team Foundation Server TFS
