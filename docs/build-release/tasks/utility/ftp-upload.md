---
title: FTP Upload
description: Upload files to a remote machine using the File Transfer Protocol (FTP), or securely with FTPS on Visual Studio Team Services VSTS and Team Foundation Server TFS
