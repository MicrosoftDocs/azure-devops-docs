...
We've been allowing [version 1 agents](../../actions/agents/v1-windows.md) to connect to VSTS. These agents are supported only for Team Foundation Server 2015. On August 1 we'll block these agents from connecting to VSTS. If you've been using a version 1 agent, please take action now and set up a version 2 agent:

* [Windows](../../actions/agents/v2-windows.md)

* [macOS](../../actions/agents/v2-osx.md)
...
* [Azure Government Cloud](../../concepts/library/government-cloud.md) VSTS is not available in Azure Government Clouds, so there are some special considerations when you
want to deploy apps to Government Clouds.


### Updated build content

How do I configure the agent to bypass a web proxy and connect to VSTS on a  [Windows](../../actions/agents/v2-windows.md), [macOS](../../actions/agents/v2-osx.md), or [Linux](../../actions/agents/v2-linux.md) agent?
...
You might have noticed that the build and release docs have been coming closer together over the past couple of months. Today it's official. Just as Build and Release is joined in VSTS, and they're now also [joined in our docs](../../overview.md).
...
Updated: [Build and release agents](../../concepts/agents/agents.md), [Windows](../../actions/agents/v2-windows.md), [Windows (TFS 2015)](../../actions/agents/v1-windows.md), [macOS](../../actions/agents/v2-osx.md), and [Linux](../../actions/agents/v2-linux.md)
...
[Pipelines in VSTS](../../concepts/licensing/concurrent-pipelines-ts.md) Added clarification to Q&A about control of pipeline allocation.
...
[Concurrent pipelines in VSTS](../../concepts/licensing/concurrent-pipelines-ts.md) We've begun charging for concurrent pipelines.
...
[Deploy a macOS agent](../../actions/agents/v2-osx.md)
...
[Pipelines in VSTS](../../concepts/licensing/concurrent-pipelines-ts.md)
