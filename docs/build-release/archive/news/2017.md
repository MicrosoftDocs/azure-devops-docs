...
* [Build and deploy your ASP.NET Core app to Azure](../../apps/aspnet/aspnetcore-to-azure.md), [Build your ASP.NET Core app](../../apps/aspnet/build-aspnet-core.md) Added ASP.NET Core (PREVIEW) template.
...
[Azure cloud service](../../apps/aspnet/deploy-cloudservice-cloudservice.md)
