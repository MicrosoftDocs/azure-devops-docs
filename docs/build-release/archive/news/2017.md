...
How do I configure the agent to bypass a web proxy and connect to VSTS on a  [Windows](../../actions/agents/v2-windows.md), [OSX](../../actions/agents/v2-osx.md), or [Linux](../../actions/agents/v2-linux.md) agent?
