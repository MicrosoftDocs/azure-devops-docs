...
of Team Services and Team Foundation Server (TFS) in the new 
...
### November 23, 2016 Update (Team Services)
...
* One free Private Pipeline: With this free private pipeline, run
  ...
  at a time in Team Services on agent software from Microsoft.
...
[Concurrent build and release pipelines in Team Services](../../concepts/licensing/concurrent-pipelines-ts.md)
...
* Released [Visual Studio 2017 RC](https://www.visualstudio.com/vs/visual-studio-2017-rc/)
  and included [new continuous delivery tools](../aspnet/aspnetcore-docker-to-azure.md)
...
### November 16, 2016 Update (Team Services, TFS 2017)

Today we're announcing TFS 2017, which includes all the Release Management features that you currently get on Team Services. We're introducing a pricing model based on concurrent pipelines for Release Management in TFS 2017.

We're also announcing general availability of Release Management in Team Services. Also, later this month, we're moving to a pricing model based on concurrent pipelines for both Team Foundation (TFBuild) and Release Management in Team Services. (Previously you paid for agents.)
...
**No charge for private agents:** [Private agents](../../concepts/agents/agents.md) are now free. In Team Services, you used to have to license each private agent after the first. Now you can run deployments concurrently for no additional charge.
...
[Concurrent pipelines for your builds and releases in Visual Studio Team Services](../../concepts/licensing/concurrent-pipelines-ts.md)

<a name="update-oct12-16"></a>
### October 12, 2016 Update (Team Services)
...
Azure Resource Manager service endpoint from Team Services.
...
from Team Services, you can create an Azure Resource Manager
...
### September 21, 2016 Update (Team Services)
...
### September 2, 2016 Update (Team Services)
...
useful when Team Services service hooks, or build and
...
### July 28, 2016 Update (Team Services)
...
* **Simplified Service Principal Authentication configuration**.
  If the Team Services or TFS instance you are using is backed by Azure Active
...
### June 24, 2016 Update (Team Services)
...
in Team Services, without requiring installation of an extension.
...
external service to show environment-specific information. In Team Services,
...
**[VS Team Services Continuous Deployment Plugin](https://wiki.jenkins-ci.org/display/JENKINS/VS+Team+Services+Continuous+Deployment+Plugin)**,
available from the Jenkins website. This plugin triggers a release in
TFS or Team Services when a build completes successfully. Use it to
...
IIS web apps and databases from Team Services and TFS.
...
### May 23, 2016 Update (Team Services)
...
Take advantage of the Team Services cloud based build
...
### Apr 26, 2016 Update (Team Services)
...
(the differences between TFS and Team Services versions are indicated
...
### Apr 8, 2016 Update (Team Services)

**Consume TFS build artifacts in Team Services Release Management**

A new extension makes it easy to deploy on-premises
TFS builds with Team Services Release Management,
even if the TFS machine is not reachable directly
from Team Services. The extension adds a TFS
...
configure this agent in Team Services. The extension
...
### Mar 15, 2016 Update (Team Services)
...
### Feb 24, 2016 Update (Team Services)
...
connect to a VMware vCenter server from Team Services
...
### Feb 11, 2016 Update (Team Services)
...
### December 1, 2015 Update (Team Services)
...
### November 18, 2015 Update (Team Services)
...
### November 03, 2015 Update (Team Services)
...
### October 19, 2015 Update (Team Services)
...
### September 21, 2015 Update (Team Services)
...
* **Integration with TFS on-premises builds**. Now you can start using
  Release Management service in Team Services, even when you have been using
...
### September 4, 2015 Update (Team Services)
