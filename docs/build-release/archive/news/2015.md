...
* [Build your Java project](../java/quick-to-azure.md)
...
* [Build and Deploy your Node.js Application to an Azure web app](../nodejs/nodejs-to-azure.md) (added missing argument)
...
* [Build Apache Cordova apps with Visual Studio Team Services or Team Foundation Services 2015](../mobile/cordova-build.md)

* [The Cordova/Ionic Command Tasks for Visual Studio Team Services and Team Foundation Services 2015](../mobile/cordova-command.md)
