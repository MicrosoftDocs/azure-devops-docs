...
| **GitHub Copilot CLI** | GitHub Copilot CLI installed and authenticated | [GitHub Copilot CLI setup guide](https://github.com/microsoft/azure-devops-mcp/blob/main/README.md#github-copilot-cli) | MCP-enabled Azure DevOps access from GitHub Copilot CLI |
