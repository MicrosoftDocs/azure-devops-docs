...
1. **Get ready to test.** Here are a few things you might need to do before running your tests:  
   ...
   - Install Microsoft Test Manager (MTM) on the machine where you want to run your tests. To get MTM, install [Visual Studio Enterprise](https://www.visualstudio.com/downloads/).  
