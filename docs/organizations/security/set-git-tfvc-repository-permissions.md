...
0. To set the set the permissions for all Git repositories for a project, choose **TFVC Repository** and then choose the security group whose permissions you want to manage. 
