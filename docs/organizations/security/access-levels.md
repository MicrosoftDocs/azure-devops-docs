...
- **Basic**: Provides access to most features. Assign to users with Visual Studio Professional, an Azure DevOps Server CAL, and to users for whom you're paying for Basic access in an organization.
- **Basic + Test Plans**: Provides access to all features included in Basic, as well as Azure Test Plans. Assign to users with Visual Studio Test Professional, MSDN Platforms, and to users for whom you're paying for Basic + Test Plans access in an organization.
