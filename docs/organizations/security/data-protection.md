...
**Encryption at rest** is important to us to protect your data. [Transparent Data Encryption](https://docs.microsoft.com/en-us/sql/relational-databases/security/encryption/transparent-data-encryption) (TDE) in SQL Azure Database is used to encrypt your at rest. For your data stored in Azure Blob storage [Azure Storage Service Encryption (SSE)](https://docs.microsoft.com/azure/storage/storage-service-encryption) protects your data at rest.
