...
> | **Service Account** | Can use the pool to create an agent queue in a team project. If you follow the guidelines for [creating new pools and queues](/azure/devops/pipelines/agents/pools-queues), you typically do not have to add any members to this role. |
