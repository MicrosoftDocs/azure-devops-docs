...
:::row:::
   ...
   :::column-end:::
   :::column span="2":::
      [Manages task group permissions](permissions.md#set-task-group) to edit and delete task groups, and administer task group permissions. To manage through the web portal, see [Pipeline permissions and security roles, Task group permissions](../../pipelines/policies/permissions.md#task-group-permissions). 
      <br/>
