...
Also allow all IP addresses in the "name": "Storage.{region}" section of the following file (updated weekly): [Azure IP ranges and Service Tags - Public Cloud](aka.ms/aax7d4q). {region} is the same Azure Geography as your organization.
...
Also allow **port 22** for IP addresses in the "name": "AzureDevOps" section of [this downloadable file](https://aka.ms/downloadazureipranges) (updated weekly) named: **Azure IP ranges and Service Tags - Public Cloud**
