...
:::row:::
   ...
   ::: moniker range="azure-devops"   
   - [Administer build permissions (Object)](../../pipelines/policies/pipeline-permissions.md)
   - [Administer build resource permissions (Collection)](change-organization-collection-level-permissions.md)
   - [Administer release permissions (Object)](../../pipelines/policies/release-pipeline-permissions.md)
   ...
   - [Administer task group permissions (Object)](../../pipelines/policies/task-group-permissions.md)
   - [Administer shelved changes (Collection)](change-organization-collection-level-permissions.md)
   ...
   - [Agent queues (Project, Role)](../../pipelines/policies/agent-pool-permissions.md)
   - [Agent pools (Collection, Role)](../../pipelines/policies/agent-pool-permissions.md)
   ...
   - [Build pipelines (Object)](../../pipelines/policies/pipeline-permissions.md)
   - [Build quality, manage (Object)](../../pipelines/policies/pipeline-permissions.md)
   - [Build queue, manage (Object)](../../pipelines/policies/pipeline-permissions.md)
   - [Build resources (Collection)](../../pipelines/policies/pipeline-permissions.md)
   - [Build permissions, manage (Object)](../../pipelines/policies/pipeline-permissions.md)
   - [Builds, manage (Object)](../../pipelines/policies/pipeline-permissions.md)
   ...
   - [Create releases (Object)](../../pipelines/policies/release-pipeline-permissions.md)
   ...
   - [Delete build pipeline (Object)](../../pipelines/policies/pipeline-permissions.md)
   - [Delete builds (Object)](../../pipelines/policies/pipeline-permissions.md)
   ...
   - [Delete release pipeline (Object)](../../pipelines/policies/release-pipeline-permissions.md)
   - [Delete release stage (Object)](../../pipelines/policies/release-pipeline-permissions.md)
   - [Delete releases (Object)](../../pipelines/policies/release-pipeline-permissions.md)
   - [Delete tag definition (Project)](permissions.md#work-item-tags) 
   - [Delete task group(Object)](../../pipelines/policies/task-group-permissions.md)
   ...
   - [Deployment groups (Object, Role)](../../pipelines/policies/deployment-group-permissions.md)
   - [Deployment pools (Collection, Role)](../../pipelines/policies/deployment-group-permissions.md)
   - [Destroy builds (Object)](../../pipelines/policies/pipeline-permissions.md)
   ::: moniker-end
   
   
   ### E
   ::: moniker range=">= azure-devops-2019"
   - [Edit build definition (Object)](../../pipelines/policies/pipeline-permissions.md)
   - [Edit build quality (Object)](../../pipelines/policies/pipeline-permissions.md)
   - [Edit collection-level information (Collection)](change-organization-collection-level-permissions.md)
   - [Edit build pipeline (Object)](../../pipelines/policies/pipeline-permissions.md)
   ...
   - [Edit release pipeline (Object)](../../pipelines/policies/release-pipeline-permissions.md)
   - [Edit release state (Object)](../../pipelines/policies/release-pipeline-permissions.md)
   ...
   - [Edit task group (Object)](../../pipelines/policies/task-group-permissions.md)
   ...
   - [Manage build qualities (Object)](../../pipelines/policies/pipeline-permissions.md)
   - [Manage deployments (Object)](../../pipelines/policies/pipeline-permissions.md)
   ...
   - [Manage release approvers (Object)](../../pipelines/policies/release-pipeline-permissions.md)
   - [Manage releases (Object)](../../pipelines/policies/release-pipeline-permissions.md)
   ...
   - [Manage build resources (Collection)](change-organization-collection-level-permissions.md)
   - [Manage build qualities (Object)](../../pipelines/policies/pipeline-permissions.md)
   - [Manage deployments (Object)](../../pipelines/policies/deployment-group-permissions.md)
   - [Manage enterprise policies (Collection)](change-organization-collection-level-permissions.md)
   - [Manage permissions (Git branch, Object)](../../repos/git/branch-permissions.md)
   - [Manage permissions (Query, Object)](set-permissions-access-work-tracking.md#work-item-queries)
   - [Manage project properties (Project)](change-project-level-permissions.md)
   ...
   ### O-P
   ::: moniker range=">= azure-devops-2019"
   - [Override check-in validation by build (Object)](../../pipelines/policies/pipeline-permissions.md)
   ...
   - [Queue builds (Object)](../../pipelines/policies/pipeline-permissions.md)
   ...
   - [Release pipelines (Object)](../../pipelines/policies/release-pipeline-permissions.md)
   ...
   - [Retain (build) indefinitely (Object)](../../pipelines/policies/pipeline-permissions.md)
   
   ### S
   
   - [Secure files (Object, Role)](../../pipelines/policies/library-permissions.md)
   - [Service endpoints (Collection, Role)](../../pipelines/policies/service-connection-permissions.md)
   ...
   - [Stop builds (Object)](../../pipelines/policies/pipeline-permissions.md)
   ...
   - [Task groups (Object)](../../pipelines/policies/task-group-permissions.md)
   ...
   ### U
   ::: moniker range=">= azure-devops-2019"
   - [Update build information (Object)](../../pipelines/policies/pipeline-permissions.md)
   - [Update build queue (Object)](../../pipelines/policies/pipeline-permissions.md)
   ...
   ### V
   ::: moniker range=">= azure-devops-2019"
   - [Variable groups (Object, Role)](../../pipelines/policies/library-permissions.md)
   ...
   - [View builds (Object)](../../pipelines/policies/pipeline-permissions.md)
   - [View release pipeline (Object)](../../pipelines/policies/release-pipeline-permissions.md)
   - [View releases (Object)](../../pipelines/policies/release-pipeline-permissions.md)
