---
title: Security terms used in VSTS & TFS 
description: Key definitions for objects and items used to authenticate and manage users and groups in Visual Studio Team Services and Team Foundation Server
