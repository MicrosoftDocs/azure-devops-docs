...
> * Connect your VSTS organization to your organization directory
...
If your users are being asked to choose between signing in to VSTS with their personal or work or school account, you will benefit from connecting your VSTS organization to your Azure Active Directory.
...
While the steps to connect your VSTS organization to Azure AD are consistent, it's important to understand where you're starting from before connecting your VSTS organization to your target Azure AD tenant.
...
3. Connect your VSTS organization to your Azure Active Directory.
...
1. Sign in to your VSTS organization and go to the **Users** tab.
...
1. Ensure the following about the user performing the connection. This user:
    ...
    * Is a [Project Collection Administrator for the VSTS organization](../security/lookup-organization-owner-admin.md).
   ...
   If the emails are the same, then follow these steps, otherwise continue on to Connect your VSTS organization to your organization directory.
...
3. Sign in to your VSTS organization (as a Project Collection Administrator) and add the new user as a member of the organization.

4. [Sign in to the Azure portal](https://portal.azure.com/) and add the new user as a B2B guest of the target Azure AD tenant and an email invitation sent to the new organization.
...
1. [Sign in to the Azure portal](https://portal.azure.com/) with the Microsoft account chosen in the previous step.
   ...
   * The target tenant is selected in the upper right corner of the Azure portal.
        ...
        ![Confirm target Azure AD tenant](_img/connect-organization-to-aad/confirm-tenant-aad.png)
...
4. Choose **Connect**.
   ...
   > [!div class="mx-imgBorder"]
![Choose Connect in Azure AD to VSTS](_img/connect-organization-to-aad/choose-connect-aad-vsts.png)
...
7. Your organization is now connected to your Azure Active Directory.

8. To confirm that the process has been completed, open your favorite browser in a private session and sign in to your VSTS organization with your Azure AD/work credentials.
...
4. If you don't want to be prompted to choose between organization, [rename your Microsoft organization](https://support.microsoft.com/en-us/help/11545/microsoft-organization-rename-your-personal-organization) to a different email that does not conflict with your Azure AD identity or simply [close your Microsoft account](https://docs.microsoft.com/en-us/vsts/organizations/accounts/connect-organization-to-aad?view=vsts#optional-close-the-temporary-msa-if-you-created-one) if it's no longer needed.
