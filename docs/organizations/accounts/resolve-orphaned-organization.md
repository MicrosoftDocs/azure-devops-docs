...
But, organizations that are connected to Microsoft Entra ID can transfer ownership to an active user.
...
When your Microsoft Entra tenant hasn't assigned an Azure DevOps Administrator, complete the following steps.
...
2. Ask the Microsoft Entra Global Administrator or Privileged Role Administrator to assign the Azure DevOps Administrator role to the appropriate user(s).
...
Complete the following steps when your Azure DevOps Administrator in Microsoft Entra ID *is* a member of the target Azure DevOps organization.
...
Complete the following steps when your Azure DevOps Administrator in Microsoft Entra ID *isn't* a member of the target Azure DevOps organization.
