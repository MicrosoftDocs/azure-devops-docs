...
Some known reasons why PATs might be failing:
* Enabling IIS Basic Authentication invalidates using PATs for Azure DevOps Server: see [Using IIS Basic Authentication with Azure DevOps on-premises](../../integrate/get-started/authentication/iis-basic-auth.md).
