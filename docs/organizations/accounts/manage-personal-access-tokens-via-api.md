...
To use the API, you must authenticate with an Azure AD token, which can be done via [Azure AD OAuth](../../../get-started/authentication/oauth.md). Learn more on how to do this in the following [authentication section](#authenticate-with-azure-active-directory-azure-ad-tokens).
