...
[Need more users with Basic features or Visual Studio subscriptions?](../../organizations/billing/buy-basic-access-add-users.md)
...
- [Change number of paid extension users](../../organizations/billing/change-number-paid-extension-users.md)
