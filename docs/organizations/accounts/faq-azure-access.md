...
1. Go to your VSTS account's control panel.

   ![Go to account control panel](_img/_shared/OrganizationSettings.png)
...
* You don't have [VSTS account owner permissions](faq-change-app-access.md#find-owner) to manage directory connections.
...
* Your VSTS account isn't linked to the Azure subscription that's associated with your directory. Learn [how to link your VSTS account to an Azure subscription](../../billing/set-up-billing-for-your-organization-vs.md).
  ...
  **Important** This link also sets up account billing,
  ...
  If you're the subscription [Account Administrator](/azure/billing/billing-add-change-azure-subscription-administrator),
