...
See [more information and resources](/azure/active-directory/active-directory-conditional-access).
...
See [detailed instructions and requirements](/azure/active-directory/active-directory-conditional-access-azuread-connected-apps).
