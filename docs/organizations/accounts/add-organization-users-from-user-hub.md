...
link to the organization page.
 ...
 > [!NOTE]
 > If have an Azure Active Directory backed VSTS organization, and you need to add users who are external to your Azure Active Directory, first [add external users](https://docs.microsoft.com/en-us/vsts/organizations/accounts/add-external-user?view=vsts) to
 > your Azure Active Directory.  Be sure on the **Tell us about this user page**, under **Type of user**, to choose **User with an
 > existing Microsoft account**.  After completing those steps, follow the steps below to add the external Azure Active Directory
 > user to VSTS.
