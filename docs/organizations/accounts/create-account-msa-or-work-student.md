...
*	To use only Microsoft accounts 
	...
	for an organization with [Azure Active Directory](/azure/active-directory/fundamentals/active-directory-whatis). 
...
[Azure Active Directory administrators](/azure/active-directory/users-groups-roles/directory-assign-admin-roles) 
