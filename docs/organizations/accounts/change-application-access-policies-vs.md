---
title: Change your organization's app access policies in Azure DevOps Services 
description: Change app access policies for Azure DevOps Services, Visual Studio Online, VSO
ms.prod: devops
...
Azure DevOps Services offers the capability for other apps to integrate with its services and resources in your Azure DevOps Services organization. To access your organization without asking for user credentials multiple times, apps can use the following authentication methods:
...
By default, your Azure DevOps Services organization allows access for all authentication methods.
...
To continue, you'll need at least Basic access and Azure DevOps Services organization owner permissions.
