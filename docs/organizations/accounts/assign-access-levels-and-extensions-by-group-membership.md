...
description: Learn how to assign group-based licensing for users in Azure Active Directory and VSTS groups by adding a group rule.
ms.prod: devops
...
VSTS includes group-based licensing for Azure Active Directory groups and VSTS groups.
...
This eliminates the need for automating license management on your own to reflect changes in your enterprise structure on a per-user basis.
