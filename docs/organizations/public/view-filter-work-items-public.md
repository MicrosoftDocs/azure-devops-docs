...
By default, completed work items are hidden. To show them, choose the :::image type="icon" source="../../media/icons/view-options-icon.png" border="false"::: view options icon, and switch the slider to show **Completed Work Items**.
