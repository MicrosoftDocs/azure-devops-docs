...
:::row:::
   ...
   :::column-end:::
   :::column span="2":::
      - [Add a custom work item type](customize-process-backlogs-boards.md) 
      ::: moniker range="azure-devops"
      - [Add an inherited work item type](customize-process-backlogs-boards.md) 
      ::: moniker-end  
      - [Change the default work item type](customize-process-backlogs-boards.md) 
      - [Rename a backlog](customize-process-backlogs-boards.md#edit-product-backlog)  
   :::column-end:::
:::row-end:::
---
:::row:::
   ...
   :::column-end:::
   :::column span="2":::
      - [Add a portfolio backlog which displays custom work item types](customize-process-backlogs-boards.md#portfolio-backlogs) 
