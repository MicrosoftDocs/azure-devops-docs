...
For more information about inherited and custom portfolio backlogs, see the following articles:
...
- You can't directly remove an inherited portfolio level from a product. You can rename the level, or disable WITs to prevent teams from creating new work items of those types.
