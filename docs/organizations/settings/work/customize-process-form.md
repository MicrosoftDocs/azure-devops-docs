...
After you add a custom page or group, you can add [custom fields to those pages or groups](customize-process-field.md). To learn more about what you can customize, see [About process customization and inherited processes](inheritance-process-model.md). 
...
2. Enter a name for the group and choose the column where it should appear. For information about columns, see [About process customization and inherited processes, Layout and resizing](inheritance-process-model.md#resizing).   

	<img src="media/process/cpform-add-group-dialog.png" alt="Add custom group dialog" />

	<a id="edit-group"></a>
3. (Optional) After you add the group, you can drag and drop the group into any column or within the column. You can also select the **Move Up** or **Move Down** options from the group's &hellip; context menu.  
...
Select the ![Delete icon](../../../media/icons/delete_icon.png) Remove option from the custom group &hellip; context menu.
...
In the following example, you remove the Severity inherited field from appearing on the Bug form.   
...
2. Label the page.
	...
	<a id="edit-page"></a>
3. Edit the page to add [fields](customize-process-field.md) or [groups](#groups).  
...
You can reorder custom pages by using drag and drop, or by choosing the move operation from the custom page &hellip; context menu. You can't move the inherited **Details** page.
