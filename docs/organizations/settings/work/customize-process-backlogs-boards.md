...
In your project, you currently have two predefined portfolio backlogs: *Features* and *Epics*. If your project requires more portfolio backlogs, you can create them.
...
:::image type="content" source="media/process/portfolio-backlogs-modified.png" alt-text="Screenshot showing Changes made to the backlog levels.":::
...
> [!NOTE]
> You can't remove the default inherited work item type from any backlog level, but you can disable the corresponding WIT. For example, you can disable the User Story WIT for the Agile Requirement backlog as long as you added another work item type to support that backlog. 
...
1. Select **Organization settings**.
   ...
   :::image type="content" source="../../../media/settings/open-admin-settings-vert.png" alt-text="Screenshot showing Organization settings button highlights.":::
...
:::image type="content" source="media/process/process-portfolio-backlog-context-menu.png" alt-text="Screenshot showing Choose the context menu of a portfolio backlog to edit, rename, or delete it.":::
...
:::image type="content" source="media/process/process-edit-portfolio-backlog-dialog.png" alt-text="Screenshot showing Deleting a backlog level removes the backlog and board associated with the level.":::
...
:::image type="content" source="media/backlogs/add-oob-issue-to-backlog.png" alt-text="Screenshot showing On Edit backlog, Stories, and Tickets is entered in Name, and there's a list of work item types for this backlog level.":::
...
:::image type="content" source="media/process/process-edit-iteration-backlog-dialog-modified.png" alt-text="Screenshot showing Example of adding the Ticket work item.":::
