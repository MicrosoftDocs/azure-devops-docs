...
[Open the Capacity page](../../boards/sprints/set-capacity.md), and then choose :::image type="icon" source="../../media/icons/team-settings-gear-icon.png" border="false"::: to open the settings dialog. 
