...
Set user preferences on the user profile page in Azure DevOps. You can change the user picture, display name, preferred email address, and UI theme. These settings only apply to Azure DevOps.

::: moniker-end

::: moniker range=" < azure-devops"

Update your picture, display name, email address, language, date and time format, time zone, and other interface preferences on your Azure DevOps user profile page.
...
To set your preferences, complete the following steps:
...
1. From the **Profile** page, change the profile picture, display name, contact email address, and region. Select **Save**.
...
1. From the **General** tab, change the following information:
   - Profile picture
   - Display name
...
1. From the **Locale** tab, change the preferred language, date and time pattern, and time zone. 
...
1. To change the UI theme, go back to the profile menu and select **Theme**. Choose between **Dark** and **Light**.
1. Select **Save**.

::: moniker-end

The system updates your user profile settings.
...
To enable this feature, go to the Azure DevOps home page, select :::image type="icon" source="../../media/icons/user-settings-gear.png" border="false"::: **User settings**, and then choose **Profile**.
...
If you experience problems with Microsoft Entra profile information, you can [turn it off](../../project/navigation/preview-features.md) and restore your original profile details. Provide detailed feedback if you do; the product team reviews all feedback to address concerns.
...
Your user profile settings are updated.
...
1. Select the camera icon or **Change Photo**, next to your current profile picture.
1. Upload a new photo from your device and adjust it as needed.
1. **Save** your changes.
