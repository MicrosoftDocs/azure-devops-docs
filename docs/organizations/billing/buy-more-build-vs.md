...
If your pipelines are in a [public project](../public/about-public-projects.md), then you can run up to 10 free parallel jobs with unlimited minutes on Microsoft-hosted agents. If you need more, simply [contact us](https://azure.microsoft.com/support/devops/).
...
If your pipelines are in a [public project](../public/about-public-projects.md), then you can run up to 10 free parallel jobs with self-hosted agents. If you need more, simply [contact us](https://azure.microsoft.com/support/devops/).
