...
![Assignment-based billing is enabled](media/_shared/assignment-based-billing-enabled.png)
...
![Default access](media/_shared/default-access-level-basic.png)
...
![Last access](media/_shared/last-access.png)
...
<img alt="Spending limit" src="_shared/media/spending-limit.png" style="border: 1px solid #CCCCCC" />
...
<img alt="Remove spending limit indefinitely" src="_shared/media/remove-spending-limit.png" style="border: 1px solid #CCCCCC" />
