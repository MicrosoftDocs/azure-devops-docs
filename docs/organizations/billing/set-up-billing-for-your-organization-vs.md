...
ms.custom: freshness-fy22q1, engagement-fy23, sfi-image-nochange, copilot-scenario-highlight
---
...
> [!NOTE]
> Azure DevOps doesn't support the [Azure Free Trial](https://azure.microsoft.com/pricing/offers/ms-azr-0044p?cid=msft_learn).
