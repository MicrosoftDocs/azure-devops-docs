...
To review  stories and short videos on how Microsoft transitioned from waterfall to Agile, see [Scaling Agile Across the Enterprise](http://stories.visualstudio.com/scaling-agile-across-the-enterprise/).
