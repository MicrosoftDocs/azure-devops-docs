...
| Library.ServiceConnectionPropertyChanged | Modify |   One or more properties of Service Connection "{ConnectionName}" of type {ConnectionType} was changed: IsDisabled = {IsDisabled}. |
