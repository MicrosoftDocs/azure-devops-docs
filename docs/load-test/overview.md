...
> See also [Manual and exploratory testing](../manual-test/index.md), [Continuous testing](../pipelines/test/index.md), [Unit testing](https://docs.microsoft.com/en-gb/visualstudio/test/unit-test-your-code).
