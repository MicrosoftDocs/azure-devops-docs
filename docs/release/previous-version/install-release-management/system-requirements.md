---
title: System requirements for Microsoft Release Management server/client for VS 2015 and TFS 2015
...
**[install a new instance](../../../setup-admin/tfs/install/sql-server/install-sql-server.md)**, 
