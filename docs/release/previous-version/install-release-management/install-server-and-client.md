...
1. Specify the SQL Server instance to host the Release Management Server 
   ...
   [Ports required for installation of Team Foundation Server](../../../setup-admin/tfs/architecture/required-ports.md)
   and
   [Accounts required for installation of Team Foundation Server](../../../setup-admin/requirements.md#accounts).
