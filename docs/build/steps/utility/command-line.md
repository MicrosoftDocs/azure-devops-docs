...
<td>Specify the working directory in which you want to run the command. If you leave it empty, the working directory is [$(Build.SourcesDirectory)](../../define/variables.md).</td>
</tr>
<tr>
