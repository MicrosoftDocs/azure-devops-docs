...
description: How to use Xamarin Test Cloud when building code in Visual Studio Team Services
...
| **Team API Key** | Your Xamarin Test Cloud Team API key. To get it, go to your [Xamarin Test Cloud account](https://testcloud.xamarin.com/account), and then to **Teams & Apps**.<br />**Important:** Use a [secret variable](../../define/variables.md) to avoid exposing this value. |
