# [Home](overview.md)
# Overview (none yet)
# Quickstarts (also some How to)
## [CI/CD for newbies](get-started/ci-cd-part-1.md)
## [CI/CD ASP.NET to Azure](apps/aspnet/aspnet4-to-azure.md)
## [CI/CD ASP.NET Core to Azure](apps/aspnet/aspnetcore-to-azure.md)
## [CI/CD Java to Azure](apps/java/maven-to-azure.md)
# Tutorials
...
### Java
#### [Java with Maven](get-started/java-maven.md)
### Mobile
#### [Xamarin](apps/mobile/xamarin.md)
#### [Xcode projects](apps/mobile/xcode-ios.md)
#### [Cordova Build](apps/mobile/cordova-build.md)
#### [Cordova Command](apps/mobile/cordova-command.md)
#### [Simple, secure CI app signing](apps/mobile/secure-certs.md)
### Node.js
...
#### [Deploy from Jenkins](apps/jenkins/build-deploy-jenkins.md)
...
### SCVMM
#### [Configure and manage VMs](apps/cd/scvmm/configure-scvmm.md)
#### [Task actions for managing VMs](apps/cd/scvmm/manage-vms-using-scvmm.md)
### VMWare
