...
**Team Services | TFS 2017 | TFS 2015 | [Previous versions (XAML builds)](https://msdn.microsoft.com/library/dn376353%28v=vs.120%29.aspx)**
...
After you've done that, your script can use to SYSTEM_ACCESSTOKEN environment variable to access the [Visual Studio Team Services REST API](https://www.visualstudio.com/en-us/integrate/api/overview). For example:
