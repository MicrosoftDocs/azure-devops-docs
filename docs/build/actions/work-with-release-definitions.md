...
Create release definitions using the [Release Management REST API](https://visualstudio.com/integrate/api/rm/overview.md).
...
>You can add environments using the [Release Management REST API](https://visualstudio.com/integrate/api/rm/overview.md).
