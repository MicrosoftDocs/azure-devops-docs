...
| **Advanced features** |Select advanced features to include in your chart:<br/>- **Common**:<br/>&nbsp;&nbsp;- **Show total scope**: Shows historical and projected scope increase.<br/>- **Burndown chart options** (apply when chart type = burndown):<br/>&nbsp;&nbsp;- **Show burndown**: When selected, the widget shows historical and projected burndown and plots remaining work.<br/>&nbsp;&nbsp;- **Show remaining work**: When selected, the widget shows remaining work as stacked bars by work item type.<br/>&nbsp;&nbsp;- **Color remaining work by work item type**: Colors remaining work by work item type; the widget stacks colors when multiple work items appear.<br/>- **Burnup chart options** (apply when chart type = burnup):<br/>&nbsp;&nbsp;- **Show burnup**: When selected, the widget shows historical and projected burnup and plots completed work.<br/>&nbsp;&nbsp;- **Show completed work**: When selected, the widget shows completed work as stacked bars by work item type.<br/>&nbsp;&nbsp;- **Color completed work by work item type**: Colors completed work by work item type; the widget stacks colors when multiple work items appear.<br/>- **Show Resolved work items as Completed**: When checked, the widget treats work items in a `Resolved` state—or any state your process maps to the Completed state category—as completed for chart metrics (completed totals, projected completion, and completed-work plots). This setting only changes the widget's interpretation for the chart and doesn't modify your process configuration.|
...
| **Advanced features** |Select advanced features to include in your chart:<br/>- **Common**:<br/>&nbsp;&nbsp;- **Show total scope**: Shows historical and projected scope increase.<br/>- **Burndown chart options** (apply when chart type = burndown):<br/>&nbsp;&nbsp;- **Show burndown**: When selected, the widget shows historical and projected burndown and plots remaining work.<br/>&nbsp;&nbsp;- **Show remaining work**: When selected, the widget shows remaining work as stacked bars by work item type.<br/>&nbsp;&nbsp;- **Color remaining work by work item type**: Colors remaining work by work item type; the widget stacks colors when multiple work items appear.<br/>- **Burnup chart options** (apply when chart type = burnup):<br/>&nbsp;&nbsp;- **Show burnup**: When selected, the widget shows historical and projected burnup and plots completed work.<br/>&nbsp;&nbsp;- **Show completed work**: When selected, the widget shows completed work as stacked bars by work item type.<br/>&nbsp;&nbsp;- **Color completed work by work item type**: Colors completed work by work item type; the widget stacks colors when multiple work items appear.<br/>- **Show Resolved work items as Completed** (checkbox): When checked, the widget treats work items in a `Resolved` state—or any state your process maps to the Completed state category—as completed for chart metrics (completed totals, projected completion, and completed-work plots). This setting only changes the widget's interpretation for the chart and doesn't modify your process configuration.|
