...
2. The **All** page lists all dashboards defined for the team project in alphabetical order. You can filter the list by team or by keyword.   
	...
	> [!TIP]
	> You can't change the sort order of the list or change the column size of the displayed columns. 
	 
3. To favorite a dashboard, hover over the dashboard and click the ![star icon](../../_img/icons/icon-favorite-star.png).  
...
3. Click the name of the dashboard to view it. 
...
Add a new dashboard as needed to support your team's needs. You can also edit and rename an Overview default dashboard. All dashboards are associated with a team. 
...
5.  When you're done making changes, click **Done Editing**. 
...
- To delete a dashboard, open the **All** dashboards page, open the ![actions icon](../../_img/icons/actions-icon.png) actions menu for the dashboard, and click the **Delete** option.  

	> [!div class="mx-imgBorder"]  
	> ![Delete a dashboard](_img/dashboards/delete-dashboard.png)  

- To set permissions for a dashboard, click the Security option. For details, see [Set dashboard permissions](dashboard-permissions.md).
...
Click ![Edit dashboard icon](_img/icons/edit-icon.png) to modify your dashboard. 
