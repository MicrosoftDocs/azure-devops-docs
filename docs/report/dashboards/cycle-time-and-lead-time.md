...
The Configuration dialog is the same for the Cycle Time and Lead Time widgets. You configure these widgets for a team. For more information, see [Add teams](../../organizations/settings/add-teams.md).  
...
2. Select **Save** when you're done. The following image shows an example Lead Time chart showing 60 days of data. 
