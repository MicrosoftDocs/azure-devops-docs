---
title: Create Actionable Dashboards in Azure DevOps
...
| [**Personal**](#personal-dashboard) | Help each team member focus on their backlog and current work. | Project or Team |
...
| [**Sprint**](#sprint-dashboard) | Review status during daily stand-ups to ensure the team is on track to meet sprint goals and address any problems that affect the goals. | Team |
...
- All project members can view all dashboards unless you apply specific restrictions by using a security command-line tool. For more information, see [Security namespace and permission reference - DashboardsPrivileges](../../organizations/security/namespace-reference.md#dashboard-previleges-namespace).

- All project members with **Basic** access can create a dashboard.

- All team members with **Basic** access can create a team dashboard unless you revoke permissions. For details, see [Set default team dashboard permissions](dashboard-permissions.md#set-default-team-dashboard-permissions).

- All team members can edit all team dashboards unless you revoke the **Edit dashboard** permission for a specific dashboard or all team dashboards. For more information, see [Set dashboard permissions](dashboard-permissions.md).
...
You can also extend dashboard visibility by adding boards and dashboards as tabs in your Microsoft Teams channel. For more information, see [Configure Azure DevOps tabs in Microsoft Teams](../../boards/integrations/boards-teams.md#configure-azure-devops-services-tabs-in-microsoft-teams).
...
For the queries used in these examples, see [Example query charts](../../boards/queries/example-query-charts.md).
...
- [Pull Request](widget-catalog.md#pull-request-widget): Show the active pull requests (PRs) requested by team members or requested by or assigned to the signed-in user.

For build and deployment widgets, see [Testing and deployment dashboard](#testing-and-deployment-dashboard).
...
- [FAQs about dashboards, charts, and reports](faqs.yml)
...
- [Configure Azure DevOps tabs in Microsoft Teams](../../boards/integrations/boards-teams.md#configure-azure-devops-services-tabs-in-microsoft-teams)
