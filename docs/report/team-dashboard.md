...
<blockquote style="font-size: 13px"><b>Feature availability: </b> For on-premises TFS, install TFS 2015 Update 1 to get access to [multiple team dashboards](dashboards.md) and [widgets](widget-catalog.md) that you can add to these dashboards.</blockquote>  
