...
**A:** You need to be a member of the local administrators group on the server, the Team Foundation Administrators group in TFS, and the sysadmin group in SQL Server, or have the equivalent permissions. If you don't have them, [get those permissions now](/tfs/server/admin/add-administrator-tfs.md).
...
*  [Supported versions and edition](/tfs/server/requirements.md#sql-server)  
...
###Set permissions
- [Set administrator permissions](/tfs/server/admin/add-administrator-tfs.md)  


###Change the data reader account  
- [Change the service account or password for SQL Server Reporting](/tfs/server/admin/change-service-account-or-password-sql-reporting.md)
