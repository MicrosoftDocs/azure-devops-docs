...
After the team creates test plans and starts to run tests by using the test management tools provided with Team Foundation Server (TFS) which include Test Runner and Azure Test Plans. With the Test Plan Progress report, you can track the team's progress in testing the product.  
