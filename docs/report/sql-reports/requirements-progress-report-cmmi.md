...
For the Requirements Progress report to be useful and correct, the team must carry out the following activities:  
  
-   Define requirements and tasks, create a **Child** link from each task to the requirement that it implements, and create a **Child** link from any subtask to its parent task.  
...
You can review the report to determine how much work the team carried out for the past week or recent period. Specifically, you can find answers to the following questions:  
...
-   **Which requirements did the team not work on**?  
     ...
     Requirements that weren't worked on won't show any light green band within the progress bar.  
...
-   **Is work on any requirement blocked?**  
     ...
     If the team hasn't completed any work on a requirement for several weeks, you might want to determine why and identify any blocking or resource issues.  
...
- Change the time interval that determines what is considered recent.  
   ...
   The amount of **Recently Completed** work is the work that the team carried out or added during the interval specified by **Recent (Calendar) Days**. To determine whether the team did any work in the last week, you set the value to seven days. To determine how much work the team completed in the last month, you set the value to 30 days.  
  
- Change the scale that is used to show progress.  
  
   You can view the report in absolute scale or in 100% scale. Absolute scale shows progress relative to work that the team carried out on all requirements in the report, and 100% scale shows progress specific to the baseline of work for each requirement.  
...
2.  Select **View Report** to refresh the display based on the new filter criteria.  
...
2.  Select **View Report** to refresh the display based on the new interval.  
  
### To change the scale that displays requirement progress  
  
1.  In the **Display Option** list, select one of the following options:  
    ...
    -   **100% Scale**: Displays the progress of hours completed and remaining as a percentage of the baseline for each requirement. It's always 100%.  
  
2.  Select **View Report** to refresh the display based on the new scale.  
