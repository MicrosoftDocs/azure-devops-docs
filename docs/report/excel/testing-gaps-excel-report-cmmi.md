...
|----------------------|-------------------------|  
|-   Requirement Status<br />-   Requirement Status by Config<br />-   Test Status by Area<br />-   Tests Not Executed|-   Define test cases and test plans, and assign test cases to the test plans. For more information, see [Defining a Test Plan](../../test/manual-exploratory-testing/getting-started/create-a-test-plan.md).<br />-   Run tests, and, for manual tests, [mark the results of each validation step in the test case as passed or failed](../../test/manual-exploratory-testing/getting-started/run-manual-tests.md).|  
...
|-   Requirement Status by Config<br />-   Tests Not Executed|-   Define test configurations and assign to test plans or test suites. For more information, see [Test configurations: specifying test platforms](../../test/manual-exploratory-testing/test-different-configurations.md).|  
