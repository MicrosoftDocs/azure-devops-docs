...
> ![Screenshot of Power BI All Pipelines Outcome Summary Report.](media/odatapowerbi-pipelines/allpipelines-report1.png)
...
> [!div class="mx-imgBorder"] 
> ![Screenshot of report that shows the outcome summary for the selected pipeline only.](media/odatapowerbi-pipelines/allpipelines-report2.png)
...
1. Choose the expand button
    ...
    > [!div class="mx-imgBorder"] 
    > ![Screenshot of Power BI transform data, Choose expand button.](media/odatapowerbi-pipelines/allpipelines-expand1.png)
    
1. Select the checkbox "(Select All Columns)" to expand

    > [!div class="mx-imgBorder"] 
    > ![Screenshot of Power BI transform data, Select all columns.](media/odatapowerbi-pipelines/allpipelines-expand2.png)

1. The table now contains the expanded entity **Pipeline.PipelineName**

    > [!div class="mx-imgBorder"] 
    > ![Screenshot of Power BI transform data, Expanded entity.](media/odatapowerbi-pipelines/allpipelines-expand3.png)
...
> [!div class="mx-imgBorder"] 
> ![Screenshot of Power BI Visualizations all Pipelines Fields.](media/odatapowerbi-pipelines/allpipelines-fields.png)
...
> [!div class="mx-imgBorder"] 
> ![[Screenshot of Power BI sample All Pipelines Outcome Summary Report.](media/odatapowerbi-pipelines/allpipelines-report1.png)
