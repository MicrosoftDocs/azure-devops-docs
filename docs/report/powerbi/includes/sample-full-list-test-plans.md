...
- [Requirements tracking - Rollup](/azure/devops/report/powerbi/sample-stories-overview-rollup)  
...
- [Configuration by outcome matrix](/azure/devops/report/powerbi/sample-test-plans-configuration-by-outcome)  