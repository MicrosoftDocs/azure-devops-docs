...
:::image type="content" source="media/editable-views/directory-actions.png" alt-text="Analytics views directory":::

[!INCLUDE [temp](../includes/analytics-image-differences.md)]

To favorite a view, hover over the view and choose the :::image type="icon" source="../../media/icons/icon-favorite-star.png":::. Your favorite views appear on the **Favorites** page.

## Create a custom view

Choose :::image type="icon" source="../media/icons/blue-plus.png"::: **New View** to open the dialog for creating a custom view. Complete the forms provided in each tab to fully define the filter criteria for shaping the data you want to view in Power BI.
...
In the next tab, **Fields**, you can add and remove fields that you use in your report. Choose the :::image type="icon" source="../media/icons/blue-plus.png"::: **Add** to add a field. To start with a fresh list, choose **Remove All**.
...
In the next tab, **History**, you choose the options that determine how much history data is available from the view.
...
:::image type="content" source="media/editable-views/history-example.png" alt-text="History tab, choose history and granularity options":::
...
:::image type="content" source="media/editable-views/verify-success.png" alt-text="successful verification":::

For example, if you try to filter by a field that is no longer defined for the project, you get an error. You can easily remove that field from the filters in the [Work Items filters](#specify-wi-filters) tab and verify again.
...
:::image type="content" source="media/editable-views/summary-panel.png" alt-text="Summary panel":::
