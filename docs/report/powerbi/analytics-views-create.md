...
To favorite a view, hover over the view and choose the ![star icon](../../media/icons/icon-favorite-star.png). Your favorited views appear on the **Favorites** page.


## Create a custom view

Choose ![plus icon](../media/icons/blue-plus.png) **New View** to open the dialog for creating a custom view. Complete the forms provided in each tab to fully define the filter criteria for shaping the data you want to view in Power BI.

Complete the following steps to create a custom view.

1.	[Name the view and choose a sharing option](#1-name-the-view-and-choose-a-sharing-option)
2.	[Specify work item filters](#2-specify-work-item-filters)
3.	[Select the view's fields](#3-select-the-fields-to-appear-in-the-report)
4.	[Choose the amount of historical data contained within the view](#4-select-trend-data-options)
