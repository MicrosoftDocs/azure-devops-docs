...
This article shows you how to get the number of test runs for different test outcome (Passed / Failed / Not executed / Not impacted).
...
> ![Sample - Test Summary - Report](media/odatapowerbi-testanalytics/testsummary-reports1.png)
...
1. Right-click a column header and select **Rename...**
	...
	> [!div class="mx-imgBorder"] 
	> ![Power BI Rename Columns](media/odatapowerbi-testanalytics/testsummary-rename1.png)
