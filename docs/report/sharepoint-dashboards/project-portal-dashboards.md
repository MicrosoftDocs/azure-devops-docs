...
> [!TIP]  
>  See [Dashboards](../dashboards.md) for information about creating dashboards in the web portal. If you work in Visual Studio Team Services (VSTS), you can also [Create Power BI dashboards and reports](https://visualstudio.microsoft.com/en-us/get-started/report/report-on-vso-with-power-bi-vs). This topic discusses SharePoint site dashboards.  
