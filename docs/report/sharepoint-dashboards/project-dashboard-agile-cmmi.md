...
|![Step 3](media/procguid_3.png "ProcGuid_3")|Team Web Access list of active user stories.|[User Story Progress](../excel/user-story-progress-excel-report-agile.md)|  
