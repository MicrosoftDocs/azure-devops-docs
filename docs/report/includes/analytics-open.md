...
> ![Open Analytics view, new navigation](/azure/devops/report/powerbi/media/open-analytics.png)   

If you don't see the team or team project you want, choose the ![ ](/azure/devops/report/powerbi/media/azure-devops.png) Azure DevOps logo to [browse all projects](/azure/devops/project/navigation/work-across-projects).  
