...
<b><i>Git</i></b>
<ul>
<li>[TBR](../git/tutorial/cherry-pick.md)</li>
</ul>
-->
...
<p><b><i>Agile tools</i></b></p>
<ul>
<li>[TBR](../work/customize/add-modify-wit.md)</li>
</ul>
-->
<p><b><i>Dashboards</i></b></p>
<ul>
...
<p><b><i>Release</i></b></p>
<ul>
<li>[TBR](../build/concepts/definitions/release/index.md)</li>
</ul>
...
<p><b><i>Release &#160;(blog posts)</i></b></p>
<ul>
<li>[Deploying an Azure Red Hat Linux VM Running Apache Tomcat ](https://blogs.msdn.microsoft.com/visualstudioalm/2016/08/18/deploying-an-azure-red-hat-linux-vm-running-apache-tomcat-for-use-with-visual-studio-team-services-and-team-foundation-server/) </li>
</ul>
...
<b><i>Engineering stories</i></b>
<ul>
<li>[TBD](http://stories.visualstudio.com/devops/)</li>
</ul>

<b><i>Videos</i></b>
<ul>
<li>[TBD](https://youtu.be/fTGv3BAgCiM)</li>
</ul>
-->
</td>
<td>
...
<ul>
<li>[Copy changes with cherry-pick](../git/tutorial/cherry-pick.md)</li>
</ul>

<b><i>Blog posts</i></b>
<ul>
<li>[Becoming more productive with Git: Tower and Team Services](https://blogs.msdn.microsoft.com/visualstudioalm/2016/08/24/becoming-more-productive-with-git-tower-and-team-services/) </li>
</ul>
-->
</td>
<td>
...
<p><b><i>Test</i></b></p>
<ul>
<li>[TBD](../test/manual-exploratory-testing/getting-started/perform-exploratory-tests.md)</li>

</ul>
<p><b><i>Release</i></b></p>
<ul>
<li>[TBD](../build/concepts/definitions/release/index.md)</li>
</ul>
...
<ul>
<li>[TBD](../git/manage-your-branches.md)</li>
</ul>

<b><i>Blog posts</i></b>
<ul>
<li>[TBD](https://blogs.msdn.microsoft.com/visualstudioalm/2016/07/15/7-ways-to-look-at-the-values-of-variables-while-debugging-in-visual-studio/)</li>
</ul>
-->
</td>
<td>
...
<li>[Understand version control and Git](../git/tutorial/gitworkflow.md)</li>
...
<li>[Consume NuGet packages in Visual Studio](../package/nuget/consume.md)</li>
...
<li>[Team Foundation Server 2015 Update 2](https://www.visualstudio.com/en-us/news/releasenotes/tfs2015-update2-vs)</li>

<li>[Account preferences](../setup-admin/account-preferences.md)  </li>

<br/>
<li>[Permissions overview](../setup-admin/permissions.md)</li>
<li>[Add users](../setup-admin/add-users.md)</li>
<li>[Add administrators](../setup-admin/add-administrator-tfs.md)</li>
<li>[Restrict access](../setup-admin/restrict-access-tfs.md)</li>

</ul>   
<p><b><i>Blog posts </i></b></p>
<ul>
<li>[Team Foundation Server Update 2 "Trial"](https://blogs.msdn.microsoft.com/visualstudioalm/2016/04/06/team-foundation-server-update-2-trial/)</li>
<li>[Merging the concepts of Account and Collection](https://blogs.msdn.microsoft.com/visualstudioalm/2016/04/09/merging-the-concepts-of-account-and-collection/) </li>
<li>[Azure Active Directory (AAD) Authentication Plug-in for SonarQube](https://blogs.msdn.microsoft.com/visualstudioalm/2016/04/05/deploy-artifacts-from-onprem-tfs-server-with-release-management-service/)</li>
<li>[Announcing the newest release of our Eclipse Plugin: Team Explorer Everywhere (TEE) 14.0.3](https://blogs.msdn.microsoft.com/visualstudioalm/2016/03/29/visual-studio-team-services-announces-the-newest-release-of-our-eclipse-plugin-team-explorer-everywhere-tee-14-0-3/)</li>
</ul>
...
<li>[Feature index](../alm-devops-features.md)</li>
<li>[Change access levels](../work/connect/change-access-levels.md)</li>
...
<td>
<ul>
<li>[Git Experience Futures (April 2016)](https://blogs.msdn.microsoft.com/visualstudioalm/2016/04/14/git-experience-futures-april-2016/) (blog post)</li>
<br/>
<li>[Package immutability](../package/feeds/immutability.md)</li>
</ul>
</td>

<td>
<ul>
<li>[What is Packaging?](../package/what-is-packaging.md)</li>
<li>[Overview of Package Management](../package/overview.md)</li>
<li>[Create a feed](../package/feeds/create-feed.md)</li>
<li>[Use Team Build to restore and publish packages](../package/build/team-build.md)</li>
<li>[Remove a NuGet package from a feed](../package/nuget/remove.md)</li>
<li>[Publish a NuGet package from the command prompt](../package/nuget/publish.md)</li>
<li>[Move your packages to the cloud](../package/nuget/move-from-fileshares.md)</li>
</ul>
</td>
</tr>
...
<td>
<ul>
<li>[Change, move, and delete work items](../Work/backlogs/remove-delete-work-items.md)</li>
<li>[Follow a work item](../collaborate/follow-work-items.md)</li>
</ul>

<p><i>For a small subset of Team Services accounts that have imported and customized work item types:</i></p>
<ul>
<li>[New web form layout](../work/process/new-work-item-experience.md)</li>
<li>[Manage roll out of the new web form](../Work/customize/manage-new-form-rollout.md)</li>
<li>[Customize the new work tracking form](../Work/customize/customize-wit-form.md)</li>
<li>[WebLayout XML elements reference](../Work/reference/weblayout-xml-elements.md)</li>
</ul>
</td>
<td>
<ul>
...
<li>[Bulk modify work items](../Work/backlogs/bulk-modify-work-items.md)</li>
<li>[Customize process](../Work/process/customize-process.md)</li>
<li>[Customize a process field](../Work/process/customize-process-field.md)</li>
...
<ul>
<li>[Build your Xamarin app](../build/apps/mobile/xamarin.md)</li>
<li>[Xamarin.Android](../build/steps/build/xamarin-android.md)</li>
<li>[Xamarin.iOS](../build/steps/build/xamarin-ios.md)</li>
<li>[Xamarin License](../build/steps/utility/xamarin-license.md)</li>
<li>[Xamarin Test Cloud](../build/steps/test/xamarin-test-cloud.md)</li>
<li>[Build: CMake](../build/steps/build/cmake.md)</li>
</ul>

<p><b><i>Test (blog posts)</i></b></p>
<ul>
<li>[Test execution improvements&mdash;Apr 2016](https://blogs.msdn.microsoft.com/visualstudioalm/2016/04/11/test-execution-improvements-apr-2016/) </li>
<li>[Execute automated tests in Build vNext using test plans and test suites](https://blogs.msdn.microsoft.com/visualstudioalm/2016/03/31/executing-automated-tests-in-build-vnext-using-test-plan-test-suites/)  </li>
<li>[Performance testing with App Service Continuous Deployment](https://blogs.msdn.microsoft.com/visualstudioalm/2016/03/25/performance-testing-with-app-service-continuous-deployment/) </li>

</ul>

<p><b><i>Release</i></b></p>
<ul>
<li>[Track a release: View test results](../build/actions/view-manage-releases.md#test-results)</li>

<li>[Using parallel environments and release promotion in test automation](https://blogs.msdn.microsoft.com/visualstudioalm/2016/03/23/using-parallel-environments-and-release-promotion-in-test-automation/) (blog post)</li>

<li>[Release Management in TFS 2015 Update 2](https://blogs.msdn.microsoft.com/visualstudioalm/2016/03/31/release-management-in-tfs-2015-update-2/) (blog post)</li>
<li>[Deploy artifacts from OnPrem TFS server with Release Management Service](https://blogs.msdn.microsoft.com/visualstudioalm/2016/04/05/deploy-artifacts-from-onprem-tfs-server-with-release-management-service/) (blog post)</li>
...
<ul>
<li>[Release notes](../build/news/2016.md)</li>
<li>[Build: Gulp](../build/steps/build/gulp.md)</li>
</ul>


<p><b><i>Test</i></b></p>
<ul>
<li>[Test apps early and often](../test/index.md)</li>
</ul>
<br/>
</td>
</tr>
...
<p><b><i>Blog posts </i></b></p>
<ul>
<li>[Team Foundation Server Extensions](https://blogs.msdn.microsoft.com/visualstudioalm/2016/03/31/team-foundation-server-extensions-2/)</li>
<li>[New Build 2016 Partner Extensions](https://blogs.msdn.microsoft.com/visualstudioalm/2016/03/30/new-build-2016-partner-extensions-in-the-visual-studio-team-services-marketplace/)</li>
<li>[New and updated DevLabs extensions in the Visual Studio Team Services Marketplace](https://blogs.msdn.microsoft.com/visualstudioalm/2016/04/06/new-and-updated-devlabs-extensions-in-the-visual-studio-team-services-marketplace/)</li>
<li>[Announcing the release of the Visual Studio Team Services extension for Visual Studio Code](https://blogs.msdn.microsoft.com/visualstudioalm/2016/03/25/announcing-the-release-of-the-visual-studio-team-services-extension-for-visual-studio-code/)</li>
...
<tr valign="top">
<td><i><b>Technical Articles</b></i></td>
<td>
<ul>
<li>[Branching strategies with TFVC](https://www.visualstudio.com/articles/branching-strategies-with-tfvc)</li>
<li>[Migration and integration solutions](https://www.visualstudio.com/articles/migration-integration-solutions)</li>
</ul>
</td>
<td>
<p>   </p>
...
<li>[Set up Visual Studio with Team Services](../setup-admin/team-services/set-up-vs.md)</li>
<li>[Sign up for Team Services](../setup-admin/team-services/sign-up-for-visual-studio-team-services.md)</li><br/>
<li>[Try more Team Services features](../setup-admin/team-services/try-additional-features-vs.md)</li>
<li>[Set up billing for Team Services](../setup-admin/team-services/set-up-billing-for-your-account-vs.md)</li>
<li>[Pay for more users](../setup-admin/team-services/buy-basic-access-add-team-services-users.md)</li>
<li>[Productivity tips](../work/productivity/productivity-tips.md)</li>
</ul>
...
<td>
<ul>
<li>[Squash: A whole new way to merge pull requests](https://blogs.msdn.microsoft.com/visualstudioalm/2016/03/15/squash-a-whole-new-way-to-merge-pull-requests/) (blog-post)</li>
<li>[Link work items to git branches, commits, and pull requests](https://blogs.msdn.microsoft.com/visualstudioalm/2016/03/02/linking-work-items-to-git-branches-commits-and-pull-requests/) (blog post)</li>  
<li>[Remove NuGet packages from feeds](../package/nuget/remove.md)</li>
</ul>
</td>
<td>
<p>  </p>
...
<td>
<ul>
<li>[Dashboards and reports overview](../report/overview.md)<br/></li>
<li>[Customize process](../Work/process/customize-process.md)</li>
</ul>
</td>
</tr>
...
<p><b><i>Test</i></b></p>
<ul>
<li>[Get started for test](https://msdn.microsoft.com/en-us/library/vs/alm/test/overview)</li>
<li>[Cloud-based load test](../build/steps/test/cloud-based-load-test.md)</li>
<li>[Cloud-based web performance test](../build/steps/test/cloud-based-web-performance-test.md)</li>
<li>[Run functional tests](../build/steps/test/run-functional-tests.md)</li>
<li>[Visual Studio test](../build/steps/test/visual-studio-test.md)</li>
<li>[Visual Studio test agent deployment](../build/steps/test/visual-studio-test-agent-deployment.md)</li>
<br/>
<li>[Cloud-load testing: rich reports in the web](https://blogs.msdn.microsoft.com/visualstudioalm/2016/03/18/cloud-load-testing-rich-reports-in-the-web/) (blog post) </li>
<li>[Team Services&mdash;testing tools roadmap](https://blogs.msdn.microsoft.com/visualstudioalm/2016/03/10/visual-studio-team-services-testing-tools-roadmap/) (blog post)</li>
<li>[Team Services Manual testing tips: charts, iterations and runs](https://blogs.msdn.microsoft.com/visualstudioalm/2016/03/10/visual-studio-team-services-manual-testing-tips-charts-iterations-and-runs/) (blog post)</li>
</ul>
<br/>
<p><b><i>Release</i></b></p>
<ul>
<li>[Azure File Copy](../build/steps/deploy/azure-file-copy.md)</li>
</ul>
</td>
<td>
<p><b><i>Build</i></b></p>
<ul>
<li>[Release notes](../build/news/2016.md)</li>
<li>[Ant](../build/steps/build/ant.md)</li>
<li>[Deploy a Windows build agent](../build/actions/agents/v1-windows.md)</li>
<li>Scale out and administer your build and deployment system</li>
<li>[Use variables](../build/define/variables.md)</li>
</ul>
</td>
</tr>
...
<ul>
<li>[Extension samples](../../integrate/extensions/develop/samples-overview.md)<br/></li>
<li>[Get extensions for TFS](https://www.visualstudio.com/get-started/marketplace/get-tfs-extensions)<br/></li>
</ul>
<br/>
<p><b><i>Blog posts </i></b></p>
<ul>
<li>[Marketplace Search now available for Visual Studio](https://blogs.msdn.microsoft.com/visualstudioalm/2016/03/04/marketplace-search-now-available-for-visual-studio/) </li>
<li>[Microsoft Open-sources the Team Explorer Everywhere Eclipse Plugin for Visual Studio Team Services and Team Foundation Server](https://blogs.msdn.microsoft.com/visualstudioalm/2016/03/08/microsoft-open-sources-the-team-explorer-everywhere-eclipse-plugin-for-visual-studio-team-services-and-team-foundation-server/) </li>
<li>[SonarQube: SDK to build plugins for Roslyn Analyzers released](https://blogs.msdn.microsoft.com/visualstudioalm/2016/03/17/sonarqube-sdk-to-build-plugins-for-roslyn-analyzers-released/) </li>
<li>[Bind a Visual Studio solution to a SonarQube project provisions and configures Roslyn analyzers](https://blogs.msdn.microsoft.com/visualstudioalm/2016/03/17/bind-a-visual-studio-solution-to-a-sonarqube-project-provisions-and-configures-roslyn-analyzers/) </li>
</ul>
</td>
<td>
<ul>
<li>[Get extensions for Team Services](https://www.visualstudio.com/get-started/marketplace/get-vsts-extensions)</li>
</ul>
</td>
</tr>
...
<td>
<ul>
<li>[Better exploratory testing, test results for release environments, squash merge, and more&mdash;Mar 3](https://www.visualstudio.com/en-us/articles/news/2016/mar-03-team-services)</li>  
<li>[Search extensions on Marketplace, flexible build policy for Git, SCVMM Support and more&mdash;Feb 16](https://www.visualstudio.com/articles/news/2016/feb-16-team-services)</li>  
</ul>
</td>
<td>
<ul>
<li>[Sign up for VS Team Services](https://www.visualstudio.com/docs/setup-admin/team-services/sign-up-for-visual-studio-team-services)</li>
<li>[Set up Visual Studio for Team Services](https://www.visualstudio.com/docs/setup-admin/team-services/set-up-vs)</li>
...
<li>[Manage TFS server configuration with TFSConfig](../setup-admin/tfs/command-line/tfsconfig-cmd.md)</li>
<li>[Delete a team project with TFSDeleteProject](../setup-admin/tfs/command-line/tfsdeleteproject-cmd.md)</li>
<li>[Change groups and permissions with TFSSecurity](../setup-admin/tfs/command-line/tfssecurity-cmd.md)</li>
<li>[TFSServiceControl Command](../setup-admin/tfs/command-line/tfsservicecontrol-cmd.md)</li>   
</ul>
</td>
</tr>
...
<td>
<ul>
<li>[Get Started with Git in Team Services](https://www.visualstudio.com/en-us/get-started/code/gitquickstart)</li>
<li>[Git Workflow - Get work done with Git](https://www.visualstudio.com/en-us/get-started/code/git/gitworkflow)</li>
<li>[Create Git repositories with Team Services](https://www.visualstudio.com/en-us/get-started/code/git/creatingrepo)</li>
<li>[Save your work with Git Commit](https://www.visualstudio.com/en-us/get-started/code/git/commits)</li>
<li>[Create work in Git Branches](https://www.visualstudio.com/get-started/code/git/branches)</li>
<li>[Share your code with Git Push](https://www.visualstudio.com/en-us/get-started/code/git/pulling)<br/></li>  
<li>[Update code with Git Fetch, Merge and Pull](https://www.visualstudio.com/en-us/get-started/code/git/pulling)</li>
<li>[Review and publish code using pull requests](https://www.visualstudio.com/en-us/get-started/code/git/pullrequest)</li>
<li>[Resolve Git merge conflicts ](https://www.visualstudio.com/en-us/get-started/code/git/merging)</li>
<li>[Undo changes in Git with Reset and Revert](https://www.visualstudio.com/en-us/get-started/code/git/undo)</li>
<li>[Manage history and merging changes with Git Rebase](https://www.visualstudio.com/en-us/get-started/code/git/rebase)</li>
<li>[Frequently Asked Git Questions](https://www.visualstudio.com/en-us/get-started/code/git/howto)</li>
</ul>
</td>
<td>
<p>  </p>
...
<td>
<ul>
<li>[Kanban board features and epics](../Work/kanban/kanban-epics-features-stories.md)</li>
<li>[Cumulative flow](../report/guidance/cumulative-flow.md)</li>
<li>[Connect to Git development operations](../Work/backlogs/connect-work-items-to-git-dev-ops.md)</li>
<li>[Getting started with widgets (blog)](https://blogs.msdn.microsoft.com/visualstudioalmrangers/2016/02/01/getting-started-with-widgets/)</li>
</ul>
</td>
<td>
<ul>
<li>[Kanban board features and epics](../work/kanban/kanban-basics.md)</li>
<li>[Add tags - Bulk add or remove](../work/track/add-tags-to-work-items.md#bulk-modify)</li>
<li>[Dashboards](../report/dashboards.md)</li>
<li>[Widget catalog](../report/widget-catalog.md)</li>   

<li>[Agile process](../Work/guidance/agile-process.md)</li>
<li>[Agile process work item types and workflow](../Work/guidance/agile-process-workflow.md)</li>
<li>[Scrum process](../Work/guidance/scrum-process.md) </li>
<li>[Scrum process work item types and workflow](../Work/guidance/scrum-process-workflow.md)</li>
<li>[CMMI process](../Work/guidance/cmmi-process.md) </li>
<li>[CMMI process work item types and workflow](../Work/guidance/cmmi-process-workflow.md)</li>
<li>[Work item field index](../Work/guidance/work-item-field.md)</li>
</ul>
</td>
</tr>
...
<ul>
<li>[Team Foundation Build release notes](../build/news/2016.md)</li>
<li>[Run Git commands in your build scripts](../build/scripts/git-commands.md)</li>
<li>[Build: Android build](../build/steps/build/android-build.md)</li>
<li>[Build: Android signing](../build/steps/build/android-signing.md)</li>     

<li>[Package: NuGet Installer](../build/steps/package/nuget-installer.md)</li>
<li>[Package: NuGet Packager](../build/steps/package/nuget-packager.md)</li>
<li>[Package: NuGet Publisher](../build/steps/package/nuget-publisher.md)</li>   

<li>[Delete Files](../build/steps/utility/delete-files.md)</li>
<li>Create a build definition (replaced in April 2017 with [CI/CD for newbies](../build/get-started/ci-cd-part-1.md))</li>
<li>[Specify build options](../build/define/options.md)</li>
<li>[Specify the repository](../build/define/repository.md)</li>
<li>[Set build triggers](../build/define/triggers.md)</li>    
<li>[Specify general build definition settings](../build/define/options.md)</li>
<li>[Specify build retention policies](../build/concepts/policies/retention.md)</li>
<li>[View the change history of your build definition](../build/define/history.md)</li>   
<li>[Utility: Copy Files](../build/steps/utility/copy-files.md)</li>
<li>[Utility: Publish Build Artifacts](../build/steps/utility/publish-build-artifacts.md)</li>
<li>[Utility: Copy and Publish Build Artifacts](../build/steps/utility/copy-and-publish-build-artifacts.md)</li>     
...
<ul>
<li>[Test apps early and often](../test/index.md)</li>
<li>[Record and play back manual tests](../test/manual-exploratory-testing/getting-started/record-play-back-manual-tests.md)</li>
...
<td>
<ul>
<li>[Get HockeyApp: Bring DevOps to mobile app development](https://www.visualstudio.com/get-started/marketplace/get-hockeyapp)</li>
<li>[Add a dashboard widget](https://www.visualstudio.com/integrate/extensions/develop/add-dashboard-widget)</li>
<li>[Discover menu group identifiers](https://www.visualstudio.com/integrate/extensions/test/discover-menu-group-ids)</li>
<li>[Print cards v2 extension (blog)](https://blogs.msdn.microsoft.com/visualstudioalmrangers/2016/02/19/print-cards-v2-extension/)</li>
<li>[Show area path dependencies extension (blog)](https://blogs.msdn.microsoft.com/visualstudioalmrangers/2016/02/17/show-area-path-dependencies-extension/)</li>
</ul>
</td>
<td>
<ul>
<li>[Marketplace Overview ](http://visualstudio.com/get-started/marketplace/overview)</li>
</ul>
</td>
</tr>
...
<td>
<ul>
<li>[DevOps and Visual Studio devops articles home](https://www.visualstudio.com/en-us/articles/overview)</li>
<li>[Migrate from Team Foundation Server to Visual Studio Team Services](https://www.visualstudio.com/articles/adopting-vsts)</li>
<li>[Map TFVC actions to Git](https://www.visualstudio.com/en-us/articles/mapping-my-tfvc-actions-to-git)</li>
<li>[Move Git repositories between team projects](https://www.visualstudio.com/en-us/articles/move-git-repos-between-team-projects)</li>
</ul>
</td>
<td>
<p>   </p>
