...
For information on connecting to a VSTS Git repo from Eclipse with TEE, read [Share your code with Eclipse and VSTS Git](/vsts/repos/git/share-your-code-in-git-eclipse).
