...
> ![The Azure DevOps Services VS Code extension in action](media/vscode.png)
...
> [!div class="mx-imgBorder"]
> ![Azure DevOps Services VS Code extension login indicator](media/team-error.png)
...
> [!div class="mx-imgBorder"]
> ![Team Project name status indicator](media/project-indicator.png)
...
> 
> [!div class="mx-imgBorder"]
> ![Pull request status indicator](media/pullrequest-indicator.png)
...
> 
> [!div class="mx-imgBorder"]
> ![Build status indicator](media/buildstatus-indicator.png)
...
> 
> [!div class="mx-imgBorder"]
> ![Work item count status indicator](media/pinnedquery-indicator.png)
