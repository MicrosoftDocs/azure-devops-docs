...
## Prerequisites
 ...
 - You have a VSTS Team Foundation  team project available. If you don't, check out our [Azure DevOps Project for Java topic](/azure/devops-project/azure-devops-project-java). (Note: This will also create a VSTS Git repo, which you do not need to use. We will use the VSTS or TFS Team)
