...
>
> Support for importing from Azure DevOps Server 2019.0.1 will be removed on Monday, January 6th, 2020. If you're currently on Azure DevOps Server 2019.0.1, you will need to complete your migration before this date or upgrade your on-premises server to a newer version.
