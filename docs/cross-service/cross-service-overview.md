...
SQL Server reports provide additional monitoring capabilities. To learn more, see [Reporting Services reports](/previous-versions/azure/devops/report/report/sql-reports/reporting-services-reports). 
