...
> ```  
 ...
 To customize the FileMapping.xml file, see [Map Microsoft Project fields](/previous-versions/azure/devops/reference/xml/map-microsoft-project-fields-to-tf-fields.md).  
