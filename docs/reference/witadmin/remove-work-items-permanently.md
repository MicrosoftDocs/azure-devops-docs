...
> [!NOTE]
> This command has been deprecated for TFS 2018.2 and later versions. Instead, you can use the [Recycle bin](../../work/backlogs/remove-delete-work-items.md#restore-or-permanently-delete-work-items) to permanently delete work items, or use [REST API `DELETE`](https://docs.microsoft.com/rest/api/vsts/wit/work%20items/delete).
::: moniker-end
...
## Related articles  
- [Move, change, or delete work items](../../work/backlogs/remove-delete-work-items.md)  
