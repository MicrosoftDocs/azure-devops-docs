...
Also, you can use `tcm` command options to [copy and clone test suites and test cases](https://docs.microsoft.com/previous-versions/azure/devops/docs/test/mtm/copying-and-cloning-test-suites-and-test-cases).  
