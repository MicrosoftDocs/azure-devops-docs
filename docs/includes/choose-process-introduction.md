...
When you create a project, you choose a *process* or *process template* based on the *process model* that you selected for your organization or collection. When choosing a process for your project, it's important to understand the following terms: 
