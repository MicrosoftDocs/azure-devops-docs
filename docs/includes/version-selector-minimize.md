...
> [!IMPORTANT]  
> :::image type="content" source="/azure/devops/media/version-selector-minimize.png" alt-text="Select a version from Azure DevOps Services Version.":::
...
> To learn which on-premises version you are using, see  <a href="/azure/devops/user-guide/provide-feedback#platform-version">What platform/version am I using?</a>
