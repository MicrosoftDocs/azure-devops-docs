...
When you sign up with GitHub, the **External guest access** policy is enabled by default, which lets you invite GitHub users to your organization. For existing organizations, an administrator can enable this policy from **Organization settings** > **Policies**.
