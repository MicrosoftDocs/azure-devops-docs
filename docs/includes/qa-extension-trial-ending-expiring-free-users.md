### What should I do when the trial is almost expired or has ended for extensions that include free users?

To keep or restore access to an extension that includes free users, 
