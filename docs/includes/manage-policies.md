...
3. Select **Policies**,  and then next to your policy, move the toggle to *on* or *off*.
   ...
   ![Select policy, and then turn On or Off](media/change-policies-preview-page.png)
...
3. Select **Policies** and then from the dropdown next to the policy, select **On** or **Off**.
   ...
   ![Select policy, and then from the dropdown, turn On or Off](media/change-policies-current-view-page.png)
