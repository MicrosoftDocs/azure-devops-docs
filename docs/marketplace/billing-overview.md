...
If you work in the cloud and use both Team Services and Azure services, your pricing model includes: 

- Monthly subscription fee per user (Stakeholders and active Visual Studio subscribers don’t count as they can be added to your Team Services account for free) 
...
> let team members join multiple Team Services accounts 
> or on-premises TFS deployments without counting as free or paid users. 
> Buying Visual Studio subscriptions might be good 
> alternatives to paying for more users to get Basic features. 
...
Some features are available through extensions like 
	[Code Search](https://marketplace.visualstudio.com/items?itemName=ms.vss-code-search). 
	Learn about [Basic features](https://www.visualstudio.com/team-services/compare-features/).


Some subscriptions also include features available through extensions, 
like [Test Manager](https://marketplace.visualstudio.com/items?itemName=ms.vss-testmanager-web) 
and [Package Management](https://marketplace.visualstudio.com/items?itemName=ms.feed). 
Learn about [Visual Studio subscriptions](https://www.visualstudio.com/subscriptions/).
