...
4. Select the extension and select **Get** or **Get it free**.
   Or, for some third-party extensions, select **Get Started** to show pricing information
