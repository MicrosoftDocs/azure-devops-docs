...
--------------------|--------------------------------------------|---------------------------------|-----------------------------          
Repos                | `ms.vss-code-web.code-hub-group`           | Project/team                    | ![sources hub](./vss/code/web/_img/hubs-source.png)
Boards                | `ms.vss-work-web.work-hub-group`           | Project/team                    | ![work hub](./vss/work/web/_img/hubs-workitems.png)
