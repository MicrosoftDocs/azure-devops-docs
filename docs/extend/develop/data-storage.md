...
There are two methods to engage with the data storage service: through REST APIs or through a client service provided by Microsoft, which is part of the VSS SDK. We advise extension developers to use the provided client service APIs, as they offer a user-friendly encapsulation of the REST APIs.
