---
title: Authentication Schemas for Service Connections | Extensions for VSTS
description: Find the different ways to authenticate with external services using service connections in VSTS extensions.
...
# Service connection authentication schemes
...
that can be utilized by a custom service connection type. This set is closed so that VSTS would be able to interpret the authentication scheme used 
