...
| Print Cards | [GitHub](https://github.com/ALM-Rangers/Azure DevOps Services-Extension-PrintCards) | Toolbar action (Kanban board) | Print cards from your Kanban board for use on a physical board |
