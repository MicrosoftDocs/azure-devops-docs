...
title: Add a chart | Extensions for Azure DevOps
description: Add a chart to your extension in Azure DevOps or Team Foundation Server (TFS)
...
This article demonstrates how you can add charts to your extensions. Charts can be added to any Azure DevOps or TFS extension. 

[!INCLUDE [extension-docs-new-sdk](../../_shared/extension-docs-new-sdk.md)]

Charts are easy to create, resizable, interactive, and consistent with the Azure DevOps look and feel. 
