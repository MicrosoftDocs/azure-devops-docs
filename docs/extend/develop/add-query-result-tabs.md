...
![Tab location on the Azure DevOps Services Query Results](https://docs.microsoft.com/previous-versions/azure/devops/docs/extend/reference/targets/vss/work/web/media/queryResultsPivotTab.png)
