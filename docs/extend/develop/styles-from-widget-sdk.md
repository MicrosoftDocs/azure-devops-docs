...
![Widget with title and description](../_shared/procedures/media/styles-from-widget-sdk/title-description.png)
...
![Widget with title and subtitle](../_shared/procedures/media/styles-from-widget-sdk/title-subtitle.png)
...
![Widget that has link with icon and text](../_shared/procedures/media/styles-from-widget-sdk/link-with-icon-text.png)
...
![Counter Widget](../_shared/procedures/media/styles-from-widget-sdk/counter.png)
...
![Example for Widget Configuration](../_shared/procedures/media/styles-from-widget-sdk/widget-configuration.png)
...
![Example for Widget Configuration Error](../_shared/procedures/media/styles-from-widget-sdk/widget-configuration-error.png)
