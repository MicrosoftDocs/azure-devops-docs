...
Learn about all of the places where you can add actions in the [contributions reference](https://docs.microsoft.com/previous-versions/azure/devops/docs/extend/reference/targets/overview).
