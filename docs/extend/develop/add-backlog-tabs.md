...
![Tab location on the Azure DevOps Services Product backlog page](../_shared/procedures/media/backlog-tab/product-backlog-tab.png)

![Tab location on the Azure DevOps Services Product backlog page](../_shared/procedures/media/backlog-tab/iteration-backlog-tab.png)
