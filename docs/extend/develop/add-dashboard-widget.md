...
Widgets can call any of the [REST APIs](https://docs.microsoft.com/en-us/rest/api/vsts/?view=vsts) in Azure DevOps Services to interact with Azure DevOps Services resources.
