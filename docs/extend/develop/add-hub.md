...
* Check out the targetable hub groups in the [extension points reference](https://docs.microsoft.com/previous-versions/azure/devops/docs/extend/reference/targets/overview#hubs)
...
- the contribution target, the work hub group (check out all of the [targetable hub groups](https://docs.microsoft.com/previous-versions/azure/devops/docs/extend/reference/targets/overview#targetable-hub-groups)),
