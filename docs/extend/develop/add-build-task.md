...
* [Step 6: Create Build and Release Pipeline for Automated Deployment](#createbuildrelease)
...
## Step 6: Create Build and Release Pipeline for Automated Deployment

With your extension in the marketplace, you will likely need to update it as you make updates and new features. To make this process easier, create a build and release pipeline to continuously publish your changes to the marketplace.
...
- Add the 'npm' task. Make sure to use the install command, and to target the folder with your package.json. Inputs:
    - Command: install
    - Working folder that contains package.json: /yourTaskDirectory
...
- This will require the 'npm' task again. Make sure to select 'custom' command, target the folder with your tests, and input testScript as the command. Inputs:
    - Command: custom
    - Working folder that contains package.json: /yourTestsDirectory
