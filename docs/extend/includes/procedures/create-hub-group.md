1. Add a hub group to your app's manifest file in contributions, like this.
	...
	Look at the contribution targets reference to see the [available hub groups that can be contributed to](https://docs.microsoft.com/previous-versions/azure/devops/docs/extend/reference/targets/overview#targets).
