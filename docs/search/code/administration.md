...
> Users with at least a **Basic** access can use Code Search. **Stakeholders** do not have access to code, and therefore no access to Code Search. All users have access to Work Item Search.
