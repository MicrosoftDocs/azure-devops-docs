...
![Image of VSTS Demo Generator template selection screen](_img/choose_template.png)
    ...
    >
    > All four templates provide fictional VSTS users and pre-populated Agile planning and tracking work items and data, along with source code in VSTS Git as well as Build and Release definitions.
