...
#  Authorize other services to access your Azure DevOps Services organization
...
in any Azure DevOps Services organization that you have access to.
...
so the service requests authorization from Azure DevOps Services.
...
3. After you've signed in, you get the Azure DevOps Services authorization approval page.
...
- Remember that other services do not ask for your credentials directly. They let you provide them to Azure DevOps Services through the Azure DevOps Services authorization approval page.
