...
ms.topic: conceptual
title: Azure Service Bus with Azure DevOps
description: Use Azure Service Bus with your Azure DevOps organization
...
# Microsoft Azure service bus with Azure DevOps

The Microsoft Azure service bus provides messaging between services and applications.
You can choose the type of service bus you want to send Azure DevOps messages to:
...
2. Create or modify your app's code to receive Azure DevOps
...
5. Pick and configure the Azure DevOps event.
...
Azure DevOps messages using a Azure Service Bus topic.
...
3. Open the admin page for the project in Azure DevOps.
...
Push Azure DevOps messages to your application using a notification hub.
...
2. Create or modify an app to receive messages from Azure DevOps through the notification hub. 
...
#### Q: When using Azure DevOps service hooks connected to a Azure notification hub, how do I pass parameters in a push notification template?
