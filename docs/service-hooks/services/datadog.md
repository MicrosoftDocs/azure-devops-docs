...
A: Yes. For details, see [Create a service hooks subscription programmatically](../create-subscription.md). Submit to any one of the following Datadog endpoints: 
