...
ms.topic: conceptual
title: Zapier with Azure DevOps
description: Use Zapier with your Azure DevOps organization
...
# Zapier with Azure DevOps

Use Zapier to connect Azure DevOps to other apps for development,
...
between Azure DevOps and those other apps.
...
to a Git repository in our Azure DevOps organization to show how that works.
...
4. Connect to your Azure DevOps organization.
   ...
   <img alt="Connect and test your Azure DevOps organization" src="./_img/zapier/select-visual-studio-online.png" style="border: 1px solid #CCCCCC" />
...
7. You can filter the events coming from Azure DevOps for this zap. For example, this zap will only act on code pushes in the master branch of the default repository for this project. Pushes in other projects, other repositories, or other branches of this repository will be ignored by this zap.
...
10. Name the zap and turn it on.
   ...
   Now the zap is set up, you'll get new notes in OneNote each time code is pushed in Azure DevOps.
...
#### Q: Can Azure DevOps take actions based on events from other apps, too.

A: Yes, you can create a zap to post a message to a team room, queue a build, or add a link to a work item in Azure DevOps. Just choose Azure DevOps as the app that's taking the action instead of raising the event. 

<img alt="Choose Azure DevOps as the action app" src="./_img/zapier/to-vso.png" style="border: 1px solid #CCCCCC" />

#### Q: Why can't I create a zap?

A: If you are not able to create a zap, make sure that:

- Service hooks are enabled on the Azure DevOps organization you are trying to create the zap in.
- You are a project administrator (or have the appropriate service hook management permissions) on the project.

#### Q: Why can't I connect to the Azure DevOps service?

A: Verify that you are a project administrator for the Azure DevOps project you are attempting to create zaps against.
...
A: At [Zapier for Azure DevOps](https://zapier.com/zapbook/visual-studio-online/).
