...
ms.topic: conceptual
title: HipChat with Azure DevOps
description: Use HipChat with your Azure DevOps organization
...
# HipChat with Azure DevOps

Post messages to a room in HipChat in response to events from Azure DevOps.
...
3. Configure the Azure DevOps event that you want to post a message in HipChat.
