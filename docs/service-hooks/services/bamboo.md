...
ms.topic: conceptual
title: Bamboo with Azure DevOps
description: Use Atlassian Bamboo with your Azure DevOps organization
...
# Bamboo with Azure DevOps

If you use Bamboo to build your apps, you can store your code in Azure DevOps
...
## Enable Azure DevOps basic authentication
1. If you haven't already, enable [alternate credentials](../../repos/git/auth-overview.md#alternate-credentials) in your Azure DevOps profile.
Be sure to set a secondary user name because you won't be able to use your email address
to connect Azure DevOps to Bamboo.
...
## Trigger Bamboo from Azure DevOps 
...
4. Pick the event from Azure DevOps that you want to trigger a build in Bamboo.
...
Now, when that event occurs in Azure DevOps, your Bamboo build will be triggered.
...
#### Q: Can I build part of my app in Azure DevOps and part in Bamboo?

A: Yes. You can trigger a Bamboo build when your Azure DevOps build is completed so that you use both systems to build your app.
