...
ms.topic: conceptual
title: UserVoice with Azure DevOps
description: Use UserVoice with your Azure DevOps organization
...
Use User Voice to get feedback from your customers and push that feedback directly into your backlog in Azure DevOps.
When your team updates the item in the backlog, the User Voice item is updated, too. 

Link your Azure DevOps organization to your UserVoice account.
...
4. Sync to Azure DevOps.
	...
	<img alt="Uservoice settings dialog box, integrations tab, Azure DevOps link" src="./_img/uservoice/sync-visual-studio-online.png" style="border: 1px solid #CCCCCC" />

5. Link your Azure DevOps organization to your UserVoice account. 
...
6. Authorize UserVoice to access your Azure DevOps organization. 

	<img alt="Azure DevOps authorization dialog box" src="./_img/uservoice/authorize.png" style="border: 1px solid #CCCCCC" />

## Add an item to your backlog from a UserVoice idea

You can create a work item in Azure DevOps form an idea in UserVoice.
...
2. Create the backlog item in Azure DevOps.
The description you type here will be the description of the item in Azure DevOps.
...
3. Submit the idea. A link to the item in Azure DevOps shows up on the UserVoice idea.

	<img alt="Uservoice idea with work item" src="./_img/uservoice/idea-with-work-item.png" style="border: 1px solid #CCCCCC" />

4. Follow that link to open the backlog item in Azure DevOps.

	<img alt="Work item in Azure DevOps" src="./_img/uservoice/work-item.png" style="border: 1px solid #CCCCCC" />

## Update a your backlog

When you update your backlog in Azure DevOps, the UserVoice idea is updated, too.

1. Approve the backlog item.

	<img alt="Approved backlog item in Azure DevOps" src="./_img/uservoice/approved-backlog-item.png" style="border: 1px solid #CCCCCC" />
...
## Add comments to items in Azure DevOps from UserVoice

1. In UserVoice, add a note to the linked Azure DevOps item.

	<img alt="Uservoice add note dialog box" src="./_img/uservoice/add-note.png" style="border: 1px solid #CCCCCC" />

2. In Azure DevOps, refresh the work item to see the note in the discussion tab.
...
A: At UserVoice for [Azure DevOps](https://www.uservoice.com/for/visual-studio-online/).
