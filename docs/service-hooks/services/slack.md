...
ms.topic: conceptual
title: Slack with Azure DevOps
description: Use Slack with your Azure DevOps organization
...
1. Search for and click the Azure DevOps integration:
<img alt="Azure DevOps link" src="./_img/slack/vso.png" style="border: 1px solid #CCCCCC; width:65%; height:auto; display:block;margin-right:auto;margin-left:auto;margin-top:10px" />

1. On the Azure DevOps integration page, click **Install**.
1. Choose a channel to have notifications posted to from the dropdown and click **Add Visual Studio Integration**. 
1. Scroll down the page and copy the web hook URL to use when you create the service hook subscription in your Azure DevOps organization.
...
## Create a service hook subscription in your Azure DevOps organization
