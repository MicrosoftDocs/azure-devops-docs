...
ms.topic: conceptual
title: Flowdock with Azure DevOps
description: Use Flowdock with your Azure DevOps organization
...
Azure DevOps can post messages to your flow in Flowdock
...
1. Configure the Azure DevOps event that will push a message to Flowdock. 
