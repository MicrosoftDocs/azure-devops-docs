...
ms.topic: conceptual
title: Campfire with Azure DevOps
description: Use Campfire with your Azure DevOps organization
...
Post messages to a room in Campfire in response to events from Azure DevOps.
...
3. Configure the Azure DevOps event that will post a message in a Campfire room.
