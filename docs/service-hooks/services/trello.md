...
ms.topic: conceptual
title: Trello with Azure DevOps
...
2. Go to the [Authorize Azure DevOps for Trello page](https://trello.com/1/authorize?key=7d6630fd03ac2b6fc9fde2f2ef0c4096&name=Visual%20Studio%20Online&expiration=never&response_type=token&scope=read%2cwrite), and sign in with your Trello credentials.

3. Allow Azure DevOps to use your Trello account.

   <img alt="Allow Azure DevOps" src="./_img/trello/allow.png" style="border: 1px solid #CCCCCC" />
...
```
    " fields": {
                ...
                " Microsoft.Azure DevOps.Common.BacklogPriority": 999999999, 
...
As a shortcut, you can reference any fields in the System or Microsoft.Azure DevOps.Common namespaces
