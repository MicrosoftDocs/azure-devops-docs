...
- [Upgrading Team Foundation Server (2010)](../../setup-admin/requirements.md)
- [Upgrade your deployment to the latest version of TFS (2015)](../../setup-admin/account-administration.md)
