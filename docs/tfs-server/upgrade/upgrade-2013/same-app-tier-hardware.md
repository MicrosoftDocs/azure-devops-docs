...
For more information, see: [System requirements for Team Foundation Server](../../../accounts/requirements.md), or [Accounts required for installation of Team Foundation Server](../../../accounts/requirements.md#accounts).
