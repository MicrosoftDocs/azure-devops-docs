...
![Single collection-project-team conceptual image](../work/connect/_img/web-portal-account-project-team-concept.png)  
</td>

<td width="60%">
**Multiple team projects and teams defined within an account/collection**   
![Scaled collection-project-team conceptual image](../work/connect/_img/web-portal-account-project-team-scale-concept.png)  
