...
* Users with **Stakeholder** access for a private project can't add work items nor update fields displayed on cards. They can add tasks and change task status. 
