...
### Mention someone, a group, work item, or pull request (:::image type="icon" source="../../media/icons/at-mention.png" border="false":::, :::image type="icon" source="../../media/icons/work-id.png" border="false":::, or ![pull-request id icon](../../media/icons/pr-id.png))
