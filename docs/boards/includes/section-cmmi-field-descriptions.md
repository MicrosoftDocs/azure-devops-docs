...
:::row:::
   :::column span="":::
      [Impact Assessment](/azure/devops/boards/work-items/guidance/cmmi/guidance-requirements-field-reference-cmmi.md)
   :::column-end:::
   :::column span="3":::
...
:::row:::
   :::column span="":::
      [Requirement Type](/azure/devops/boards/work-items/guidance/cmmi/guidance-requirements-field-reference-cmmi.md)(Required)  
   :::column-end:::
   :::column span="3":::
...
:::row:::
   :::column span="":::
      [Start Date/Finish Date](/azure/devops/boards/queries/query-by-date-or-current-iteration.md)  
   :::column-end:::
   :::column span="3":::
      The target dates for when the work will start or finish. These fields are filled in by [Microsoft Project](/azure/devops/boards/backlogs/office/create-your-backlog-tasks-using-project.md) when you use it for scheduling.  
...
:::row:::
   :::column span="":::
      [Triage](/azure/devops/boards/queries/planning-ranking-priorities.md) (Required) </p>
   :::column-end:::
   :::column span="3":::
...
:::row:::
   :::column span="":::
      [Blocked](/azure/devops/boards/queries/planning-ranking-priorities.md)  
   :::column-end:::
   :::column span="3":::
...
:::row:::
   :::column span="":::
      [Committed](/azure/devops/boards/queries/planning-ranking-priorities.md) (Required)  
   :::column-end:::
   :::column span="3":::
...
:::row:::
   :::column span="":::
      [Integrated In](/azure/devops/boards/queries/build-test-integration.md)
   :::column-end:::
   :::column span="3":::
...
:::row:::
   :::column span="":::
      [User Acceptance Test](/azure/devops/boards/work-items/guidance/cmmi/guidance-requirements-field-reference-cmmi.md) (Required)  
   :::column-end:::
   :::column span="3":::
...
:::row:::
   :::column span="":::
      [Subject Matter Experts](/azure/devops/boards/work-items/guidance/cmmi/guidance-requirements-field-reference-cmmi.md)
   :::column-end:::
   :::column span="3":::
