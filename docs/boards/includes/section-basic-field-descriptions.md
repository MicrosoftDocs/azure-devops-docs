...
:::row:::
   :::column span="":::
      [Title](/azure/devops/boards/queries/titles-ids-descriptions.md)
   :::column-end:::
   :::column span="3":::
...
:::row:::
   :::column span="":::
      [Assigned To](/azure/devops/boards/queries/query-by-workflow-changes.md)
   :::column-end:::
   :::column span="3":::
...
:::row:::
   :::column span="":::
      [State](/azure/devops/boards/queries/query-by-workflow-changes.md)
   :::column-end:::
   :::column span="3":::
...
:::row:::
   :::column span="":::
      [Reason](/azure/devops/boards/queries/query-by-workflow-changes.md)
   :::column-end:::
   :::column span="3":::
...
:::row:::
   :::column span="":::
      [Area (Path)](/azure/devops/boards/queries/query-by-area-iteration-path.md)
   :::column-end:::
   :::column span="3":::
      Choose the area path associated with the product or team, or leave blank until assigned during a planning meeting. To change the dropdown list of areas, see [Define area paths and assign to a team](/azure/devops/organizations/settings/set-area-paths.md).
   :::column-end:::
:::row-end:::
---
:::row:::
   :::column span="":::
      [Iteration (Path)](/azure/devops/boards/queries/query-by-workflow-changes.md)
   :::column-end:::
   :::column span="3":::
      Choose the sprint or iteration in which the work is to be completed, or leave it blank and assign it later during a planning meeting. To change the drop-down list of iterations, see [Define iteration paths and configure team iterations](/azure/devops/organizations/settings/set-iteration-paths-sprints.md).
   :::column-end:::
:::row-end:::
---
:::row:::
   :::column span="":::
      [Description](/azure/devops/boards/queries/titles-ids-descriptions.md)
   :::column-end:::
   :::column span="3":::
...
:::row:::
   :::column span="":::
      [Acceptance Criteria](/azure/devops/boards/queries/titles-ids-descriptions.md)
   :::column-end:::
   :::column span="3":::
...
:::row:::
   :::column span="":::
      [Value Area](/azure/devops/boards/queries/planning-ranking-priorities.md)
   :::column-end:::
   :::column span="3":::
      A subjective rating of the issue or task it relates to the business. You can specify the following values:  
...
:::row:::
   :::column span="":::
      [Effort, Story Points, Size](/azure/devops/boards/queries/query-numeric.md)
   :::column-end:::
   :::column span="3":::
      ...
      The estimates you set are used to calculate [team velocity](/azure/devops/report/dashboards/team-velocity.md) and [forecast sprints](/azure/devops/boards/sprints/forecast.md).
   :::column-end:::
:::row-end:::
---