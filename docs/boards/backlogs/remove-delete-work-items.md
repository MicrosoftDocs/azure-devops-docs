...
2. Confirm you want to delete the item(s).  
	...
	> [!div class="mx-imgBorder"]
	> ![Screensot of the Confirm delete dialog.](media/move-change-delete/delete-work-items-dialog.png)  
...
- Causes the work item to become nonqueryable and, as such, don't appear in any work tracking experience, query result, or report  
