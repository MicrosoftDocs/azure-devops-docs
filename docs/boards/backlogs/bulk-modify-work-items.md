...
For large scale, organizational moves, use the REST API calls for [Work item batch operations](https://docs.microsoft.com/rest/api/azure/devops/wit/work%20items#operations). 
