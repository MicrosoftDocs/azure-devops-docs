...
| Defined iterations | To use the **Planning** pane, your team administrator must [define iteration (sprint) paths and configure team iteratios](../../organizations/settings/set-iteration-paths-sprints.md). |
::: moniker-end
