...
> [!NOTE]
> For authentication issues, such as `TF31003` and `TF30063`, please refer to [User account does not have permission](https://social.msdn.microsoft.com/Forums/azure/5d332307-f373-418e-b2ab-0e7111b02adc/tf31003-your-user-account-does-not-have-permission-to-connect).
