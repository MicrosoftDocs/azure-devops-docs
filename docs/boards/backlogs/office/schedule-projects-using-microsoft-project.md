...
- [Add or modify work item fields to support reporting](https://docs.microsoft.com/azure/devops/reference/xml/add-or-modify-work-item-fields-to-support-reporting)
