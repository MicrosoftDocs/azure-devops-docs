...
Once you set the filter options for a specific view, your settings persist until you change them. There is no save button or other action you need to take. The following notes apply to specific views. 
