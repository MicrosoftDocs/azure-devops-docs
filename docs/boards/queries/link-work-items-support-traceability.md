...
For example, when you add Shared Steps to a Test Case, they are automatically linked using the **Test Case/Shared Steps** link types. See [Share steps between test cases](https://docs.microsoft.com/en-us/previous-versions/azure/devops/docs/test/mtm/share-steps-between-test-cases). 
