---
title: Import, update, and export bulk work items with CSV files in Azure DevOps
titleSuffix: Azure Boards
description: Learn how to import, update, and export work items in bulk from a CSV formatted file in Azure DevOps. 
...
# Import, update, and export bulk work items with CSV files in Azure DevOps

[!INCLUDE [version-gt-eq-2019](../../includes/version-gt-eq-2019.md)]

::: moniker range="> azure-devops-2019"
Import and export work items in bulk using CSV formatted files in Azure DevOps. While you can continue to use Excel for bulk import and updates, you can use the native import/export feature that doesn't require Excel. For more information, see [Bulk add or modify work items with Excel](../backlogs/office/bulk-add-modify-work-items-excel.md).
::: moniker-end 
