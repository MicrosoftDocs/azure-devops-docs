...
Link category: Process-defined</p></td>
<td>
<p>Use to link test cases with shared steps. You <a href="https://docs.microsoft.com/previous-versions/azure/devops/test/mtm/share-steps-between-test-cases?view=azure-devops" data-raw-source="[share steps between test cases](https://docs.microsoft.com/previous-versions/azure/devops/test/mtm/share-steps-between-test-cases?view=azure-devops)">share steps between test cases</a> to avoid having to create multiple entries of the same sequence of steps. To learn more, see <a href="https://docs.microsoft.com/previous-versions/azure/devops/test/mtm/share-steps-between-test-cases?view=azure-devops" data-raw-source="[Share steps between test cases](https://docs.microsoft.com/previous-versions/azure/devops/test/mtm/share-steps-between-test-cases?view=azure-devops)">Share steps between test cases</a>.</p>
</td>
</tr>
</tbody>
</table>
