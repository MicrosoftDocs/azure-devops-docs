...
- [Link type topologies and restrictions](/previous-versions/azure/devops/reference/xml/link-type-element-reference?view=tfs-2017#link-type-topologies-and-restrictions)
