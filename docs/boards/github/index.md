...
| **Mention GitHub pull requests** | Use `!` mentions to reference and discuss GitHub pull requests from any work item text field or comment. | [Mention GitHub pull requests](link-to-from-github.md#mention-github-pull-requests-with-) |
