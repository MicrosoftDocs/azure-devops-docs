...
Once you've selected the work item you want to update, you can make changes to the work item form.

# [Visual Studio 2019](#tab/visual-studio)

From the Team Explorer, you can select a work item.  The work item form will open in the web portal where you can make changes to the work item form and save your changes.
...
For more information, see [View and add work items](view-add-work-items.md).
...
> ![Screenshot showing Work item form, Follow icon control.](media/follow-work/follow-work-item.png) 
...
- **Not Subscribed**: Only receive notifications from this work item when you have been @mentioned.
...
Once you have added an attachment you can hover over the work item to access the **more actions** :::image type="icon" source="../media/icons/more-actions.png" border="false":::  menu. The more actions menu allows you to:
...
Once you have added an attachment you can hover over the work item to access the **more actions** :::image type="icon" source="../media/icons/more-actions-horizontal.png" border="false":::  menu. The more actions menu allows you to:
...
For more information, see [Copy or clone work items](../backlogs/copy-clone-work-items.md).
...
For more information, see [Move work items from one team to another](../backlogs/move-work-items-between-teams.md).
...
1. **Work Item Template**: Create custom work item templates used by your team based on existing work items. Custom work item templates allow you to pre-populate values in your team's commonly used fields.  For more information see, [Use work item templates](../backlogs/work-item-template.md).
...
For more infomration see, [Remove, delete, or restore work items](../backlogs/remove-delete-restore-work-items.md).
...
- [Agile](guidance/agile-process-workflow.md)
- [Scrum](guidance/scrum-process-workflow.md)
- [Capability Maturity Model Integration (CMMI)](guidance/cmmi-process-workflow.md)

For more information, see [Best practices for work item tracking](../guidance/work-item-tracking-best-practices.md).
