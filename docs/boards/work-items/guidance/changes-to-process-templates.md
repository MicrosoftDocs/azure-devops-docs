...
:::row:::
   ...
   :::column span="3":::
      ...
      - Agile - Bug: Added the **Story Points** field; User Story: Removed the **Stack Rank** field from the form 
      - CMMI: Added the **Size** field to the Bug definition. Removed the **Stack Rank** field from the Requirement form. 
   :::column-end:::
:::row-end:::
---
:::row:::
...
:::row:::
   ...
   :::column span="3":::
      ...
      - Visual Studio Scrum 2.1: Bug, Product Backlog Item, Task</li>
      - MSF Agile 6.1: Bug, Task, User Story</li>
      - MSF Scrum 6.1: Bug, Task, Requirement</li>
...
:::row:::
   ...
   :::column span="3":::
      ...
      - Added the **Storyboards** tab to the User Story work item type.</p>
