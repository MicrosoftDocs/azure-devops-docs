...
::: moniker range=">= azure-devops-2019"
1. From the board settings page (product backlog only), choose **Annotations**. [Make sure that **Test** annotation is enabled](#enable-or-disable-an-annotations), a requirement to configure inline tests.
