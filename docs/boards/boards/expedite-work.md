...
8. Choose **Swimlanes**, and then choose the ![](../_img/icons/add_icon.png) plus icon, and enter the name of the swimlane you want to add.       
...
11. When done with your changes, choose **Save**.  
