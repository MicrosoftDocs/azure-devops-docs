...
Each [work item type](/vsts/boards/backlogs/add-work-items) is associated with 31 system fields and several more type-specific fields. You use work items to plan and track your project.  
...
For descriptions and usage of each field defined for the core system processes&mdash;[Scrum, Agile, and CMMI system processes](/vsts/boards/work-items/guidance/choose-process)&mdash;see [Work item field index](/vsts/boards/work-items/guidance/work-item-field).  
