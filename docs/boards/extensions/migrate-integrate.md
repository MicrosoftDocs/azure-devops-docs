...
- [Follow best practices for migrating work items](../backlogs/migration-best-practices.md)
- [Migrate build and release pipelines](../../pipelines/migrate-microsoft-azure-devops-pipelines.md)
