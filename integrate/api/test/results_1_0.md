...
| Query
| version                 | string   |         | [Version](../../get-started/rest/basics.md#versions) of the API to use.
| id                      | int      |         | ID of a specific iteration, used to get just that iteration. If not specifed, all iterations in the result are returned.
...
| Query
| version                 | string   |         | [Version](../../get-started/rest/basics.md#versions) of the API to use.
| paramName               | string   |         | Name of the paramater.
