...
#### [Use wait control](extensions/develop/ui-controls/waitcontrolo.md)
...
### [Deploy web content to Azure](extensions/publish/publish-azure.md)
# Package and publish
## [Package and publish extensions](extensions/publish/overview.md)
## [Package and publish integrations](extensions/publish/integration.md)
## [Make your listing public](extensions/publish/publicize.md)
## [Publish via command line](extensions/publish/command-line.md)
# Test and debug
## [Debug a web extension](extensions/test/debug-in-browser.md)
## [Menu group IDs](extensions/test/discover-menu-group-ids.md)
# Reporting
## [Extension Reporting](/docs/marketplace/extension-report)
## [Extension Statistics Power BI content pack](/docs/marketplace/extension-statistics-powerbi-contentpack)
# REST APIs
## [Overview](api/overview.md)
## [Get started](get-started/rest/basics.md)
...
### [Annotated Tags](api/git/annotatedTags.md)
...
### [Contracts](api/tfs/contracts.md)
## Queues
...
# Authentication
## [Authentication guidance](get-started/authentication/authentication_guidance.md)
## [Using personal access tokens](get-started/authentication/pats.md)
## [Using OAuth 2.0](get-started/authentication/oauth.md)
# Client libraries
