...
[Authorizing with OAuth](/azure/devops/integrate/get-started/authentication/oauth?view=azdevops)
...
[Supported events](/azure/devops/service-hooks/events?view=azdevops)
