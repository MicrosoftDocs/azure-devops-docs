...
To learn more about Visual Studio Online authorization for third-party apps and services, see [Authorize access with OAuth 2.0](/vsts/integrate/get-started/authentication/oauth?view=vsts).
