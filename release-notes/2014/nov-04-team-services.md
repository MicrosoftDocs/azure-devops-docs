...
![Viewing test results](media/11_04_04.png)
...
![Previewing a markdown file](media/11_04_05.png)
...
![Browse link dialog](media/11_04_06.png)
...
![Authorize application dialog](media/11_04_07.png)

To learn more about Visual Studio Online authorization for third-party apps and services, see [Authorize access with OAuth 2.0](/azure/devops/integrate/get-started/authentication/oauth?view=azure-devops&preserve-view=true).
