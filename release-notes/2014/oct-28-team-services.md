...
description: Visual Studio Team Services release notes for October 28 2014
...
To learn more about how to use the APIs, check out [Get started with the REST APIs](https://www.visualstudio.com/integrate/get-started/get-started-rest-basics-vsi).
...
To learn more about service hooks and the services with which you can integrate out of the box, visit [Integrate with other services](https://www.visualstudio.com/get-started/integrating-with-service-hooks-vs).
