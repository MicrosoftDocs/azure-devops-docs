...
In the next few weeks, we will update the Node.js version on the Mac OS 10.14 (Mojave) image from 6 to 8. If you still need to use node.js version 6, please consider using the node.js tool installer task - [here](https://docs.microsoft.com/azure/devops/pipelines/tasks/tool/node-js?view=azure-devops). 
