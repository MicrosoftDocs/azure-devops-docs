...
[Policy Configurations - Get - REST API (Azure DevOps Git) | Microsoft Learn](https://learn.microsoft.com/en-us/rest/api/azure/devops/git/policy-configurations/get?view=azure-devops-rest-7.2)