...
- [CodeQL default setup now in private preview](#codeql-default-setup-now-in-private-preview)
- [CodeQL build task updated to Node.js v24](#codeql-build-task-updated-to-node-js-v24)
