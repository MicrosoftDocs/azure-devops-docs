...
For more information, see [Copilot Autofix for code scanning](/azure/devops/repos/security/github-advanced-security-code-scanning-autofix?view=azure-devops&preserve-view=true) (preview).
...
To get started, see [Configure code scanning](/azure/devops/repos/security/configure-github-advanced-security-features?view=azure-devops&pivots=standalone-ghazdo#set-up-code-scanning&preserve-view=true).
