...
![Wiki](media/08_04_26.png)

Some of the key features of the new Wiki include:
- Simplified editing experience using [markdown syntax](/azure/devops/project/wiki/markdown-guidance).
...
Variable groups have been available to use in release definitions, and now they are ready to be used in build definitions too. Learn more about [creating a variable group](/azure/devops/pipelines/library/variable-groups). This has been developed and prioritized based on related suggestions for project-level build/release variables and variable groups in build definitions.
