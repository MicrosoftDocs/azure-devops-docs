...
![pr filtered](media/03_29_16.png)
...
![create tag details](media/03_29_02.png)
...
![create tag history](media/03_29_03.png)

![tag branch](media/03_29_04.png)
...
![import repo](media/03_29_07.png)
...
![import repo complete](media/03_29_08.png)
...
![run this task menu](media/03_29_19.png)
...
See [Specify conditions for running a task](/azure/devops/pipelines/process/conditions).
...
After some additional tuning and some bug fixes, we’ve made the [updated __Package Management__ experience](./feb-15-team-services.md#updated-package-management-experience) available to all accounts. Learn more about the update [here](/azure/devops/package/preview/updated-experience), or turn it on using the toggle in the __Packages__ hub.
...
![Azure RD parameters](media/03_29_10.png)
...
![parallel deployments](media/03_29_11.png)
