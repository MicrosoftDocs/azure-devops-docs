...
> ![work item hub](media/08_28_04.png)

Creating a work item from within the hub is just one click away:

> [!div class="mx-imgBorder"]
> ![new item menu](media/08_28_05.png)
...
See the [documentation for the Work Items hub](/azure/devops/boards/work-items/view-add-work-items) for more information.
...
> [!div class="mx-imgBorder"]
> ![custom rules](media/08_28_01.png)

To get started with rules, simply follow these steps:

> [!div class="mx-imgBorder"]
> ![customize menu action](media/08_28_02.png)
...
Check out the [documentation for custom rules](/azure/devops/organizations/settings/work/custom-rules) for more information.
...
> [!div class="mx-imgBorder"]
> ![mentioned work](media/08_28_07.png)
...
> [!div class="mx-imgBorder"]
> ![custom work item notification settings](media/08_28_03.png)
...
> [!div class="mx-imgBorder"]
> ![inline add on delivery plans](media/08_28_26.png)
...
> [!div class="mx-imgBorder"]
> ![create fork](media/08_28_27.png)
...
Read the [documentation for forks](/azure/devops/repos/git/forks) for more information.
...
> [!div class="mx-imgBorder"]
> ![file minimap](media/08_28_08.png)
...
> [!div class="mx-imgBorder"]
> ![bracket matching](media/08_28_09.png)
...
> [!div class="mx-imgBorder"]
> ![toggle white space](media/08_28_10.png)
...
> [!div class="mx-imgBorder"]
> ![push template](media/08_28_11.png)
...
> [!div class="mx-imgBorder"]
> ![force push](media/08_28_12.png)

Clicking on the force push tag takes you to the removed commit.

> [!div class="mx-imgBorder"]
> ![removed commits](media/08_28_13.png)
...
> [!div class="mx-imgBorder"]
> ![get sources bitbucket repo](media/08_28_25.png)
...
> [!div class="mx-imgBorder"]
> ![delete custom templates](media/08_28_14.png)

#### Visually handle permissions on the editor

The new release definition editor now has specific in context messages to handle the various [permissions](/azure/devops/pipelines/policies/permissions#release-permissions).
...
Similar to [conditional build tasks](/azure/devops/pipelines/process/conditions), you can now run a task or phase only if specific conditions are met. This will help you in modeling rollback scenarios.
...
> [!div class="mx-imgBorder"]
> ![conditional release phases](media/08_28_16.png)
...
> [!div class="mx-imgBorder"]
> ![approve multiple environments](media/08_28_22.png)
...
> [!div class="mx-imgBorder"]
> ![Endpoint requests history](media/08_28_23.png)
...
> [!div class="mx-imgBorder"]
> ![Test batching](media/08_28_28.png)
...
Effective user management helps administrators ensure they are paying for the right resources and enabling the right access in their projects. We’ve repeatedly heard in support calls, and from our customers that they want capabilities to simplify this process in VSTS. This sprint, we are releasing an experience to general availability, which begins to address these issues. See the [documentation for the User hub](/azure/devops/organizations/accounts/add-organization-users) for more information. Here are some of the changes that you’ll see light up:
...
> [!div class="mx-imgBorder"]
> ![new account invitation](media/08_28_17.png)
...
> [!div class="mx-imgBorder"]
> ![new user page](media/08_28_18.png)
...
> [!div class="mx-imgBorder"]
> ![new detailed user view](media/08_28_19.png)
...
> [!div class="mx-imgBorder"]
> ![project invite](media/08_28_20.png)
