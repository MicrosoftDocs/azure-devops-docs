...
Work item form custom controls, groups, and pages can now [block work item save](https://visualstudio.microsoft.com/en-us/docs/integrate/extensions/reference/client/api/tfs/workitemtracking/services/workitemformservice#seterror) to validate data and ensure the user fills out any required information before saving the work item form. 
...
After you have created a variable group mapped to Azure Key Vault, you can link it to your release definitions, as documented in [Variable groups](https://visualstudio.microsoft.com/en-us/docs/build/concepts/library/variable-groups).
