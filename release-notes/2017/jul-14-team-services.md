...
You can now get the pull request ID, source branch, and target branch from  [build variables](https://docs.microsoft.com/en-us/vsts/pipelines/build/variables?view=vsts&tabs=batch).
...
> **Preview feature**
>
> To use this capability, enable [**New Release Definition Editor**](/vsts/pipelines/archive/preview/release-definition-editor) for yourself or your account. See [Enable preview features](/vsts/project/navigation/preview-features) for more details.
...
* The badges provided in the manifest can not be SVGs unless they are from [approved badge providers](https://docs.microsoft.com/en-us/vsts/extend/develop/manifest?view=vsts#approvedbadges).
