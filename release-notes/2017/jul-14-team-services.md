...
> **Preview feature**
>
> To use this capability, enable [**New Release Definition Editor**](https://visualstudio.microsoft.com/docs/build/preview/release-definition-editor) for yourself or your account. See [Enable preview features](/vsts/project/navigation/preview-features) for more details.
