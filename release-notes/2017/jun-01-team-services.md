...
We’ve added a general-purpose [secure files library](https://visualstudio.microsoft.com/en-us/docs/build/concepts/library/secure-files).
...
* [Utility: Install Apple Certificate](https://visualstudio.microsoft.com/en-us/docs/build/steps/utility/install-apple-certificate)

* [Utility: Install Apple Provisioning Profile](https://visualstudio.microsoft.com/en-us/docs/build/steps/utility/install-apple-provisioning-profile)
