---
title: Support Pipelines App with GitHub Enterprise Server
...
description: Support Pipelines App with GitHub Enterprise Server
hide_comments: true
---

# Support Pipelines App with GitHub Enterprise Server
...
However, this app does not work when using Azure Pipelines with GitHub Enterprise Server. The goal of this work is to fix that.
