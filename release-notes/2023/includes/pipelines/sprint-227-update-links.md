...
- [Pipeline agents can be registered using Microsoft Entra ID instead of a PAT](#pipeline-agents-can-be-registered-using-microsoft-entra-id-instead-of-a-pat)
