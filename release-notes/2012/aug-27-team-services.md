...
![old source viewer](media/8_27_01.png)
...
A couple of weeks ago we [announced](https://blogs.msdn.com/b/bharry/archive/2012/08/13/announcing-git-integration-with-tfs.aspx) support for bridging between local Git repositories and TFS servers. At the time I explained it didn’t work for Team Foundation Service but support would be coming soon. It’s here now! It’s worth noting that, in the short term Git-tf has been available, this rose to the 2nd top voted suggestion. This makes it so that both of the top two suggestions have now been addressed.
...
![My profile on the team project home page](media/8_27_05.png)
