...
description: Visual Studio Team Services release notes for August 27 2012
...
Then enter a password and save the changes. You now have a username and password you can use with the cross platform TEE command line and with the Git-tf command line. See the [learn content](https://www.visualstudio.com/en-us/get-started/share-your-code-in-GIT-vs) for more info on how to use this.
