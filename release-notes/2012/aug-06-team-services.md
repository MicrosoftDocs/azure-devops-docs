...
We’ve also made a variety of updates to the welcome site content – a new [article on Code Review](https://docs.microsoft.com/vsts/tfvc/get-code-reviewed-vs?view=vsts) and updates to all the screen shots to reflect some of the styling changes we’ve made in the past couple of months.
