...
If you’re using Xcode in your environment, we published a [new article](/vsts/git/share-your-code-in-git-xcode?view=vsts) describing how to use Git and Xcode with Team Foundation Service.
