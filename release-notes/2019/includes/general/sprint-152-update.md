...
For more details on the commands and its syntax, see the documentation [here](/cli/azure/ext/azure-devops/devops/extension?view=azure-cli-latest&preserve-view=true).
...
For more details on the command and its syntax, see the documentation [here](/cli/azure/ext/azure-devops/devops?view=azure-cli-latest&preserve-view=true#ext-azure-devops-az-devops-invoke).
...
For more details on the commands and the syntax, see the documentation [here](/cli/azure/ext/azure-devops/devops/user?view=azure-cli-latest&preserve-view=true).