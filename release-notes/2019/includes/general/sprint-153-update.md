...
For more details, see the [command and its syntax](/cli/azure/ext/azure-devops/devops/security/permission?view=azure-cli-latest&preserve-view=true) and [help](/azure/devops/cli/permissions?view=azure-devops&preserve-view=true) documentation.