...
For more details, see the [command and its syntax](/cli/azure/devops/security/permission) and [help](/azure/devops/cli/permissions?view=azure-devops) documentation.
