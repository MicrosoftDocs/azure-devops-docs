...
For more details about the command see the documentation [here](/cli/azure/pipelines).
...
For more details on the commands and its syntax, see the documentation [here](/cli/azure/pipelines/build/tag).
