...
For more details about the command see the documentation [here](/cli/azure/pipelines?view=azure-cli-latest&preserve-view=true).
...
For more details on the commands and its syntax, see the documentation [here](/cli/azure/pipelines/build/tag?view=azure-cli-latest&preserve-view=true).
