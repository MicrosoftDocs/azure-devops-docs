...
We are excited to announce the availability of the [Azure Pipeline app for Jira](https://github.com/msfe/azure-pipelines-jira). The integration enables bi-directional linking between releases in Azure Pipelines and issues in Jira software cloud. It simplifies the generation of release notes by tracking Jira issues mentioned in GitHub commits deployed with releases. 
