...
For more details on the command and its syntax, see the documentation [here](https://docs.microsoft.com/cli/azure/ext/azure-devops/pipelines/runs/artifact?view=azure-cli-latest&preserve-view=true).
