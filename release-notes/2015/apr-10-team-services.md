...
Finally, we enabled last week [support for up to 100 cores](https://devblogs.microsoft.com/devops/announcing-100-core-support-for-vso-cloud-load-testing-and-more/) (from the earlier limit of 20 cores) for the Cloud Load Testing service. This means that customers can now simulate five times the user load they were able to simulate earlier.
