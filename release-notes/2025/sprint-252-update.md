...
We're excited to announce that GitHub Enterprise users now have access to Azure DevOps Basic usage rights at no extra cost. Simply signing in using your Entra ID to get started.
