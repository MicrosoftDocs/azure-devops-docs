...
![Viewing agent queues](media/7_29_05.png)
...
-Prerequisites:
-The VSTS account should be backed by an Azure Active Directory. For more info, see the Visual Studio article [Team Services: Access with Azure Active Directory (Azure AD)](/azure/devops/organizations/accounts/manage-azure-active-directory-groups).
...
![Setting retention policies in different environments](media/7_29_10.png)
