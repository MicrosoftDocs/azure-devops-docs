...
![Creating a new branch from a work item](media/1_25_01.png)

You will also be able to create a branch directly from the Kanban board.

![Creating a branch directly from the Kanban board](media/1_25_02.png)
...
![Related work items section in pull request details view](media/1_25_03.png)

## Build widgets in the catalog

As I wrote about in the [dashboards futures blog](https://devblogs.microsoft.com/devops/dashboards-futures-january-2016/), one area we’re focusing on is improving the discoverability and ease in bringing different charts to your dashboard. With this update, you’ll see a new option to add a build history chart from the dashboard catalog, and you’ll be able to configure the build definition displayed directly from the dashboard.

![Adding a build history chart from the dashboard catalog](media/1_25_04.png)
...
![Displaying a markdown file in a dashboard](media/1_25_06.png)
...
![Auto-refresh options](media/1_25_07.png)
...
![Code coverage charts](media/1_25_08.png)
...
![Test failures and test duration charts on build summary](media/1_25_09.png)

Clicking each chart will open up a detailed information view, and you can also add them to your dashboard.

![Test failures and test duration on the dashboard](media/1_25_10.png)
...
![Passed and failed tests together in test results](media/1_25_11.png)
...
![Adding and removing tags in bulk edit](media/1_25_12.png)
...
![The latest keyboard shortcuts for Code hub](media/1_25_13.png)
...
![Filtering test plans](media/1_25_14.png)
...
![Showing tests from child suites](media/1_25_15.png)
...
![Search for your team directly](media/1_25_16.png)
![Search across projects](media/1_25_17.png)
...
![Search for a work item within exploratory testing](media/1_25_18.png)
...
![Create bugs or tasks from exploratory testing](media/1_25_19.png)
...
![Trigger an automated deployment conditionally](media/1_25_20.png)
...
![Queuing policy options](media/1_25_21.png)
...
![Deferring a deployment](media/1_25_22.png)
...
![Configuring approval options](media/1_25_23.png)
...
![Setting a retention policy](media/1_25_24.png)
...
![Selecting a search scope](media/1_25_25.png)
...
![Searching across Git and TFVC projects](media/1_25_26.png)
