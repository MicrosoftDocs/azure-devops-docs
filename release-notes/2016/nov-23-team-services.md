...
For more information, see [Concurrent build and release pipelines in Team Services](/vsts/pipelines/licensing/concurrent-jobs-vsts) and [Concurrent release pipelines in TFS](https://www.visualstudio.com/en-us/docs/release/getting-started/concurrent-pipelines-tfs).
