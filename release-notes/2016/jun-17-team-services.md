...
![Ahead/behind](media/6_17_01.png)
...
![Branch picker featuring Mine](media/6_17_02.png)
...
![Path control in Explorer](media/6_17_03.png)
...
![New file type icons](media/6_17_04.png)
...
![Improved work item header](media/6_17_05.png)
...
![Insights in exploratory testing](media/6_17_06.png)
...
![automatically stop and attach a screen recording](media/6_17_07.png)
...
![Tests tab showing failing tests](media/6_17_09.png)
...
![OAuth token option](media/6_17_12.png)
...
![Enabling path filters for Git CI triggers](media/6_17_13.png)
...
As always, if you have comments or questions, please reach out on [Twitter](https://twitter.com/AzureDevOps). If you have ideas on things you’d like to see us prioritize, head over to [Azure DevOps Developer Community](https://developercommunity.visualstudio.com/spaces/21/index.html) to add your idea or vote for an existing one.
