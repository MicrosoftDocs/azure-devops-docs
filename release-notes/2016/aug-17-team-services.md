...
These changes will be rolled out slowly to avoid having unexpected impacts on large numbers of users. As such, the Usage page may not be available in all accounts for some time. For more information, see [https://www.visualstudio.com/en-us/docs/reference/rate-limits](https://www.visualstudio.com/en-us/docs/reference/rate-limits).
