...
On the package list, you can now see the view(s) of each package version to quickly determine their quality. See the [release views](/vsts/artifacts/concepts/views) documentation for more information.
