...
> ![New default views](media/129_19.png)
...
> [!div class="mx-imgBorder"]
> ![View pull request merge commit](media/129_17.png)
...
> [!div class="mx-imgBorder"]
> ![PR request labels](media/129_16.png)
...
> [!div class="mx-imgBorder"]
> ![PR auto-complete lists](media/129_15.png)
...
> [!div class="mx-imgBorder"]
> ![PR markdown comment with math](media/129_14.png)
...
> [!div class="mx-imgBorder"]
> ![Area drop down list](media/129_11.png)
...
> [!div class="mx-imgBorder"]
> ![Iteration drop down list](media/129_12.png)
...
> [!div class="mx-imgBorder"]
> ![Configuration for pull request validation of public fork PR builds](media/129_08.png)
...
> [!div class="mx-imgBorder"]
> ![GitHub Enterprise build source option](media/129_09.png)
...
> [!div class="mx-imgBorder"]
> ![Default hosted agent option in Build](media/129_10.png)
...
> [!div class="mx-imgBorder"]
> ![Application button in Test & Feedback](media/129_18.png)
...
> [!div class="mx-imgBorder"]
> ![Filter test by test name](media/129_13.png)
...
> [!div class="mx-imgBorder"]
> ![Visual Studio Test task](media/129_20.png)
...
* [Visual Studio Test Platform Installer](/previous-versions/azure/devops/release-notes/2017/nov-28-vsts#test) allows VSTest task to run without needing Visual Studio pre-installed
* Both Build and Release definitions can be created with [multiple phases and have the ability to use different agent queues](/previous-versions/azure/devops/release-notes/2017/dec-11-vsts#enhancements-to-multi-phase-builds) for each phase
...
> [!div class="mx-imgBorder"]
> ![Wiki menu print page option](media/129_04.png)
...
> [!div class="mx-imgBorder"]
> ![Wiki view keyboard shortcuts popup](media/129_05.png)

While editing a page, you can quickly save, save and close, or just close.

> [!div class="mx-imgBorder"]
> ![Wiki edit keyboard shortcuts popup](media/129_06.png)
...
> [!div class="mx-imgBorder"]
> ![Marketplace price calculator](media/129_07.png)
...
> [!div class="mx-imgBorder"]
> ![Account warning for single admin](media/129_01.png)
