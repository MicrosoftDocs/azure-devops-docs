...
View test analytics for [builds](https://docs.microsoft.com/azure/devops/pipelines/test/test-analytics?view=azdevops#view-test-analytics-for-builds) and [release](https://docs.microsoft.com/azure/devops/pipelines/test/test-analytics?view=azdevops#view-test-analytics-for-releases), preview below:

> [!div class="mx-imgBorder"]
![Test analytics](_img/141_08.png)

For more information, see our [documentation](https://docs.microsoft.com/azure/devops/pipelines/test/test-analytics?view=azdevops).
