...
See the [Clone a Hosted XML process to Inheritance](/azure/devops/organizations/settings/work/upgrade-hosted-to-inherited?view=azdevops&tabs=new-nav) documentation for more information.
