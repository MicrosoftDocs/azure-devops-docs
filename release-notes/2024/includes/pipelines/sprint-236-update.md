...
You can now see whether an Azure service connection has an expired secret. If your tasks emit a message indicating a secret has expired (e.g. including _AADSTS7000222_) visit the service connection details page. If you see the following message, the service connection's secret has expired:
