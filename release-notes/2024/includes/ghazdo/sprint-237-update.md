...
We're expanding the set of partner patterns that can be detected with Secret Scanning. This expansion brings in a number of high confidence patterns for new token types. These new patterns include a large number of Azure resource providers, and other SaaS providers through the GHAS Secret Scanning partner program. 
...
Secret scanning will now detect many non-provider patterns, including:
